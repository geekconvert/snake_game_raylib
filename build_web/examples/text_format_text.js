...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpq8fptohf.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_format_text.data';
      var REMOTE_PACKAGE_BASE = 'text_format_text.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_format_text.data');

      };
      Module['addRunDependency']('datafile_text_format_text.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpq8fptohf.js
...
function findWasmBinary() {
    return locateFile('text_format_text.wasm');
}
...
var ASM_CONSTS = {
  26320: () => { if (document.fullscreenElement) return 1; },  
 26366: () => { return Module.canvas.width; },  
 26398: () => { return parseInt(Module.canvas.style.width); },  
 26446: () => { document.exitFullscreen(); },  
 26473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26546: () => { if (document.fullscreenElement) return 1; },  
 26592: () => { return Module.canvas.width; },  
 26624: () => { return screen.width; },  
 26649: () => { document.exitFullscreen(); },  
 26676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26809: () => { return window.innerWidth; },  
 26835: () => { return window.innerHeight; },  
 26862: () => { if (document.fullscreenElement) return 1; },  
 26908: () => { return Module.canvas.width; },  
 26940: () => { return parseInt(Module.canvas.style.width); },  
 26988: () => { if (document.fullscreenElement) return 1; },  
 27034: () => { return Module.canvas.width; },  
 27066: () => { return screen.width; },  
 27091: () => { return window.innerWidth; },  
 27117: () => { return window.innerHeight; },  
 27144: () => { if (document.fullscreenElement) return 1; },  
 27190: () => { return Module.canvas.width; },  
 27222: () => { return screen.width; },  
 27247: () => { document.exitFullscreen(); },  
 27274: () => { if (document.fullscreenElement) return 1; },  
 27320: () => { return Module.canvas.width; },  
 27352: () => { return parseInt(Module.canvas.style.width); },  
 27400: () => { document.exitFullscreen(); },  
 27427: ($0) => { Module.canvas.style.opacity = $0; },  
 27465: () => { return screen.width; },  
 27490: () => { return screen.height; },  
 27516: () => { return window.screenX; },  
 27543: () => { return window.screenY; },  
 27570: () => { return window.devicePixelRatio; },  
 27606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27710: () => { Module.canvas.style.cursor = 'none'; },  
 27747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28003: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28054: () => { if (document.fullscreenElement) return 1; },  
 28100: () => { return window.innerWidth; },  
 28126: () => { return window.innerHeight; },  
 28153: () => { if (document.pointerLockElement) return 1; }
};
