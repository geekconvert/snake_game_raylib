...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl7qz8e86.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_top_down_lights.data';
      var REMOTE_PACKAGE_BASE = 'shapes_top_down_lights.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_top_down_lights.data');

      };
      Module['addRunDependency']('datafile_shapes_top_down_lights.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl7qz8e86.js
...
function findWasmBinary() {
    return locateFile('shapes_top_down_lights.wasm');
}
...
var ASM_CONSTS = {
  26832: () => { if (document.fullscreenElement) return 1; },  
 26878: () => { return Module.canvas.width; },  
 26910: () => { return parseInt(Module.canvas.style.width); },  
 26958: () => { document.exitFullscreen(); },  
 26985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27058: () => { if (document.fullscreenElement) return 1; },  
 27104: () => { return Module.canvas.width; },  
 27136: () => { return screen.width; },  
 27161: () => { document.exitFullscreen(); },  
 27188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27321: () => { return window.innerWidth; },  
 27347: () => { return window.innerHeight; },  
 27374: () => { if (document.fullscreenElement) return 1; },  
 27420: () => { return Module.canvas.width; },  
 27452: () => { return parseInt(Module.canvas.style.width); },  
 27500: () => { if (document.fullscreenElement) return 1; },  
 27546: () => { return Module.canvas.width; },  
 27578: () => { return screen.width; },  
 27603: () => { return window.innerWidth; },  
 27629: () => { return window.innerHeight; },  
 27656: () => { if (document.fullscreenElement) return 1; },  
 27702: () => { return Module.canvas.width; },  
 27734: () => { return screen.width; },  
 27759: () => { document.exitFullscreen(); },  
 27786: () => { if (document.fullscreenElement) return 1; },  
 27832: () => { return Module.canvas.width; },  
 27864: () => { return parseInt(Module.canvas.style.width); },  
 27912: () => { document.exitFullscreen(); },  
 27939: ($0) => { Module.canvas.style.opacity = $0; },  
 27977: () => { return screen.width; },  
 28002: () => { return screen.height; },  
 28028: () => { return window.screenX; },  
 28055: () => { return window.screenY; },  
 28082: () => { return window.devicePixelRatio; },  
 28118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28222: () => { Module.canvas.style.cursor = 'none'; },  
 28259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28515: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28566: () => { if (document.fullscreenElement) return 1; },  
 28612: () => { return window.innerWidth; },  
 28638: () => { return window.innerHeight; },  
 28665: () => { if (document.pointerLockElement) return 1; }
};
