...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_28ciklo.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_animation.data';
      var REMOTE_PACKAGE_BASE = 'models_animation.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_animation.data');

      };
      Module['addRunDependency']('datafile_models_animation.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_28ciklo.js
...
function findWasmBinary() {
    return locateFile('models_animation.wasm');
}
...
var ASM_CONSTS = {
  41240: () => { if (document.fullscreenElement) return 1; },  
 41286: () => { return Module.canvas.width; },  
 41318: () => { return parseInt(Module.canvas.style.width); },  
 41366: () => { document.exitFullscreen(); },  
 41393: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41466: () => { if (document.fullscreenElement) return 1; },  
 41512: () => { return Module.canvas.width; },  
 41544: () => { return screen.width; },  
 41569: () => { document.exitFullscreen(); },  
 41596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41729: () => { return window.innerWidth; },  
 41755: () => { return window.innerHeight; },  
 41782: () => { if (document.fullscreenElement) return 1; },  
 41828: () => { return Module.canvas.width; },  
 41860: () => { return parseInt(Module.canvas.style.width); },  
 41908: () => { if (document.fullscreenElement) return 1; },  
 41954: () => { return Module.canvas.width; },  
 41986: () => { return screen.width; },  
 42011: () => { return window.innerWidth; },  
 42037: () => { return window.innerHeight; },  
 42064: () => { if (document.fullscreenElement) return 1; },  
 42110: () => { return Module.canvas.width; },  
 42142: () => { return screen.width; },  
 42167: () => { document.exitFullscreen(); },  
 42194: () => { if (document.fullscreenElement) return 1; },  
 42240: () => { return Module.canvas.width; },  
 42272: () => { return parseInt(Module.canvas.style.width); },  
 42320: () => { document.exitFullscreen(); },  
 42347: ($0) => { Module.canvas.style.opacity = $0; },  
 42385: () => { return screen.width; },  
 42410: () => { return screen.height; },  
 42436: () => { return window.screenX; },  
 42463: () => { return window.screenY; },  
 42490: () => { return window.devicePixelRatio; },  
 42526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42579: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42630: () => { Module.canvas.style.cursor = 'none'; },  
 42667: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42923: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42974: () => { if (document.fullscreenElement) return 1; },  
 43020: () => { return window.innerWidth; },  
 43046: () => { return window.innerHeight; },  
 43073: () => { if (document.pointerLockElement) return 1; }
};
