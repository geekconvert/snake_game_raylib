...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp034ozqg9.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_fog.data';
      var REMOTE_PACKAGE_BASE = 'shaders_fog.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_fog.data');

      };
      Module['addRunDependency']('datafile_shaders_fog.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp034ozqg9.js
...
function findWasmBinary() {
    return locateFile('shaders_fog.wasm');
}
...
var ASM_CONSTS = {
  32536: () => { if (document.fullscreenElement) return 1; },  
 32582: () => { return Module.canvas.width; },  
 32614: () => { return parseInt(Module.canvas.style.width); },  
 32662: () => { document.exitFullscreen(); },  
 32689: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 32762: () => { if (document.fullscreenElement) return 1; },  
 32808: () => { return Module.canvas.width; },  
 32840: () => { return screen.width; },  
 32865: () => { document.exitFullscreen(); },  
 32892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 33025: () => { return window.innerWidth; },  
 33051: () => { return window.innerHeight; },  
 33078: () => { if (document.fullscreenElement) return 1; },  
 33124: () => { return Module.canvas.width; },  
 33156: () => { return parseInt(Module.canvas.style.width); },  
 33204: () => { if (document.fullscreenElement) return 1; },  
 33250: () => { return Module.canvas.width; },  
 33282: () => { return screen.width; },  
 33307: () => { return window.innerWidth; },  
 33333: () => { return window.innerHeight; },  
 33360: () => { if (document.fullscreenElement) return 1; },  
 33406: () => { return Module.canvas.width; },  
 33438: () => { return screen.width; },  
 33463: () => { document.exitFullscreen(); },  
 33490: () => { if (document.fullscreenElement) return 1; },  
 33536: () => { return Module.canvas.width; },  
 33568: () => { return parseInt(Module.canvas.style.width); },  
 33616: () => { document.exitFullscreen(); },  
 33643: ($0) => { Module.canvas.style.opacity = $0; },  
 33681: () => { return screen.width; },  
 33706: () => { return screen.height; },  
 33732: () => { return window.screenX; },  
 33759: () => { return window.screenY; },  
 33786: () => { return window.devicePixelRatio; },  
 33822: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 33875: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 33926: () => { Module.canvas.style.cursor = 'none'; },  
 33963: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 34219: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 34270: () => { if (document.fullscreenElement) return 1; },  
 34316: () => { return window.innerWidth; },  
 34342: () => { return window.innerHeight; },  
 34369: () => { if (document.pointerLockElement) return 1; }
};
