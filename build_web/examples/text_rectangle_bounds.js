...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpca8ix2bh.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_rectangle_bounds.data';
      var REMOTE_PACKAGE_BASE = 'text_rectangle_bounds.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_rectangle_bounds.data');

      };
      Module['addRunDependency']('datafile_text_rectangle_bounds.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpca8ix2bh.js
...
function findWasmBinary() {
    return locateFile('text_rectangle_bounds.wasm');
}
...
var ASM_CONSTS = {
  26704: () => { if (document.fullscreenElement) return 1; },  
 26750: () => { return Module.canvas.width; },  
 26782: () => { return parseInt(Module.canvas.style.width); },  
 26830: () => { document.exitFullscreen(); },  
 26857: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26930: () => { if (document.fullscreenElement) return 1; },  
 26976: () => { return Module.canvas.width; },  
 27008: () => { return screen.width; },  
 27033: () => { document.exitFullscreen(); },  
 27060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27193: () => { return window.innerWidth; },  
 27219: () => { return window.innerHeight; },  
 27246: () => { if (document.fullscreenElement) return 1; },  
 27292: () => { return Module.canvas.width; },  
 27324: () => { return parseInt(Module.canvas.style.width); },  
 27372: () => { if (document.fullscreenElement) return 1; },  
 27418: () => { return Module.canvas.width; },  
 27450: () => { return screen.width; },  
 27475: () => { return window.innerWidth; },  
 27501: () => { return window.innerHeight; },  
 27528: () => { if (document.fullscreenElement) return 1; },  
 27574: () => { return Module.canvas.width; },  
 27606: () => { return screen.width; },  
 27631: () => { document.exitFullscreen(); },  
 27658: () => { if (document.fullscreenElement) return 1; },  
 27704: () => { return Module.canvas.width; },  
 27736: () => { return parseInt(Module.canvas.style.width); },  
 27784: () => { document.exitFullscreen(); },  
 27811: ($0) => { Module.canvas.style.opacity = $0; },  
 27849: () => { return screen.width; },  
 27874: () => { return screen.height; },  
 27900: () => { return window.screenX; },  
 27927: () => { return window.screenY; },  
 27954: () => { return window.devicePixelRatio; },  
 27990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28043: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28094: () => { Module.canvas.style.cursor = 'none'; },  
 28131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28387: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28438: () => { if (document.fullscreenElement) return 1; },  
 28484: () => { return window.innerWidth; },  
 28510: () => { return window.innerHeight; },  
 28537: () => { if (document.pointerLockElement) return 1; }
};
