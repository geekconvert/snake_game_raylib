...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpa85_3nye.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_2d_camera_mouse_zoom.data';
      var REMOTE_PACKAGE_BASE = 'core_2d_camera_mouse_zoom.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_2d_camera_mouse_zoom.data');

      };
      Module['addRunDependency']('datafile_core_2d_camera_mouse_zoom.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpa85_3nye.js
...
function findWasmBinary() {
    return locateFile('core_2d_camera_mouse_zoom.wasm');
}
...
var ASM_CONSTS = {
  26936: () => { if (document.fullscreenElement) return 1; },  
 26982: () => { return Module.canvas.width; },  
 27014: () => { return parseInt(Module.canvas.style.width); },  
 27062: () => { document.exitFullscreen(); },  
 27089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27162: () => { if (document.fullscreenElement) return 1; },  
 27208: () => { return Module.canvas.width; },  
 27240: () => { return screen.width; },  
 27265: () => { document.exitFullscreen(); },  
 27292: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27425: () => { return window.innerWidth; },  
 27451: () => { return window.innerHeight; },  
 27478: () => { if (document.fullscreenElement) return 1; },  
 27524: () => { return Module.canvas.width; },  
 27556: () => { return parseInt(Module.canvas.style.width); },  
 27604: () => { if (document.fullscreenElement) return 1; },  
 27650: () => { return Module.canvas.width; },  
 27682: () => { return screen.width; },  
 27707: () => { return window.innerWidth; },  
 27733: () => { return window.innerHeight; },  
 27760: () => { if (document.fullscreenElement) return 1; },  
 27806: () => { return Module.canvas.width; },  
 27838: () => { return screen.width; },  
 27863: () => { document.exitFullscreen(); },  
 27890: () => { if (document.fullscreenElement) return 1; },  
 27936: () => { return Module.canvas.width; },  
 27968: () => { return parseInt(Module.canvas.style.width); },  
 28016: () => { document.exitFullscreen(); },  
 28043: ($0) => { Module.canvas.style.opacity = $0; },  
 28081: () => { return screen.width; },  
 28106: () => { return screen.height; },  
 28132: () => { return window.screenX; },  
 28159: () => { return window.screenY; },  
 28186: () => { return window.devicePixelRatio; },  
 28222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28275: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28326: () => { Module.canvas.style.cursor = 'none'; },  
 28363: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28619: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28670: () => { if (document.fullscreenElement) return 1; },  
 28716: () => { return window.innerWidth; },  
 28742: () => { return window.innerHeight; },  
 28769: () => { if (document.pointerLockElement) return 1; }
};
