...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpipiq476i.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_lines_bezier.data';
      var REMOTE_PACKAGE_BASE = 'shapes_lines_bezier.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_lines_bezier.data');

      };
      Module['addRunDependency']('datafile_shapes_lines_bezier.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpipiq476i.js
...
function findWasmBinary() {
    return locateFile('shapes_lines_bezier.wasm');
}
...
var ASM_CONSTS = {
  26400: () => { if (document.fullscreenElement) return 1; },  
 26446: () => { return Module.canvas.width; },  
 26478: () => { return parseInt(Module.canvas.style.width); },  
 26526: () => { document.exitFullscreen(); },  
 26553: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26626: () => { if (document.fullscreenElement) return 1; },  
 26672: () => { return Module.canvas.width; },  
 26704: () => { return screen.width; },  
 26729: () => { document.exitFullscreen(); },  
 26756: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26889: () => { return window.innerWidth; },  
 26915: () => { return window.innerHeight; },  
 26942: () => { if (document.fullscreenElement) return 1; },  
 26988: () => { return Module.canvas.width; },  
 27020: () => { return parseInt(Module.canvas.style.width); },  
 27068: () => { if (document.fullscreenElement) return 1; },  
 27114: () => { return Module.canvas.width; },  
 27146: () => { return screen.width; },  
 27171: () => { return window.innerWidth; },  
 27197: () => { return window.innerHeight; },  
 27224: () => { if (document.fullscreenElement) return 1; },  
 27270: () => { return Module.canvas.width; },  
 27302: () => { return screen.width; },  
 27327: () => { document.exitFullscreen(); },  
 27354: () => { if (document.fullscreenElement) return 1; },  
 27400: () => { return Module.canvas.width; },  
 27432: () => { return parseInt(Module.canvas.style.width); },  
 27480: () => { document.exitFullscreen(); },  
 27507: ($0) => { Module.canvas.style.opacity = $0; },  
 27545: () => { return screen.width; },  
 27570: () => { return screen.height; },  
 27596: () => { return window.screenX; },  
 27623: () => { return window.screenY; },  
 27650: () => { return window.devicePixelRatio; },  
 27686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27739: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27790: () => { Module.canvas.style.cursor = 'none'; },  
 27827: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28083: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28134: () => { if (document.fullscreenElement) return 1; },  
 28180: () => { return window.innerWidth; },  
 28206: () => { return window.innerHeight; },  
 28233: () => { if (document.pointerLockElement) return 1; }
};
