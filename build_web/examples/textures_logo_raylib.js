...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp1txwg9zs.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_logo_raylib.data';
      var REMOTE_PACKAGE_BASE = 'textures_logo_raylib.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_logo_raylib.data');

      };
      Module['addRunDependency']('datafile_textures_logo_raylib.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp1txwg9zs.js
...
function findWasmBinary() {
    return locateFile('textures_logo_raylib.wasm');
}
...
var ASM_CONSTS = {
  30208: () => { if (document.fullscreenElement) return 1; },  
 30254: () => { return Module.canvas.width; },  
 30286: () => { return parseInt(Module.canvas.style.width); },  
 30334: () => { document.exitFullscreen(); },  
 30361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30434: () => { if (document.fullscreenElement) return 1; },  
 30480: () => { return Module.canvas.width; },  
 30512: () => { return screen.width; },  
 30537: () => { document.exitFullscreen(); },  
 30564: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30697: () => { return window.innerWidth; },  
 30723: () => { return window.innerHeight; },  
 30750: () => { if (document.fullscreenElement) return 1; },  
 30796: () => { return Module.canvas.width; },  
 30828: () => { return parseInt(Module.canvas.style.width); },  
 30876: () => { if (document.fullscreenElement) return 1; },  
 30922: () => { return Module.canvas.width; },  
 30954: () => { return screen.width; },  
 30979: () => { return window.innerWidth; },  
 31005: () => { return window.innerHeight; },  
 31032: () => { if (document.fullscreenElement) return 1; },  
 31078: () => { return Module.canvas.width; },  
 31110: () => { return screen.width; },  
 31135: () => { document.exitFullscreen(); },  
 31162: () => { if (document.fullscreenElement) return 1; },  
 31208: () => { return Module.canvas.width; },  
 31240: () => { return parseInt(Module.canvas.style.width); },  
 31288: () => { document.exitFullscreen(); },  
 31315: ($0) => { Module.canvas.style.opacity = $0; },  
 31353: () => { return screen.width; },  
 31378: () => { return screen.height; },  
 31404: () => { return window.screenX; },  
 31431: () => { return window.screenY; },  
 31458: () => { return window.devicePixelRatio; },  
 31494: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31547: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31598: () => { Module.canvas.style.cursor = 'none'; },  
 31635: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31891: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31942: () => { if (document.fullscreenElement) return 1; },  
 31988: () => { return window.innerWidth; },  
 32014: () => { return window.innerHeight; },  
 32041: () => { if (document.pointerLockElement) return 1; }
};
