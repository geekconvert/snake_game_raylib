...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp0ca18x18.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_basic_lighting.data';
      var REMOTE_PACKAGE_BASE = 'shaders_basic_lighting.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_basic_lighting.data');

      };
      Module['addRunDependency']('datafile_shaders_basic_lighting.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp0ca18x18.js
...
function findWasmBinary() {
    return locateFile('shaders_basic_lighting.wasm');
}
...
var ASM_CONSTS = {
  27320: () => { if (document.fullscreenElement) return 1; },  
 27366: () => { return Module.canvas.width; },  
 27398: () => { return parseInt(Module.canvas.style.width); },  
 27446: () => { document.exitFullscreen(); },  
 27473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27546: () => { if (document.fullscreenElement) return 1; },  
 27592: () => { return Module.canvas.width; },  
 27624: () => { return screen.width; },  
 27649: () => { document.exitFullscreen(); },  
 27676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27809: () => { return window.innerWidth; },  
 27835: () => { return window.innerHeight; },  
 27862: () => { if (document.fullscreenElement) return 1; },  
 27908: () => { return Module.canvas.width; },  
 27940: () => { return parseInt(Module.canvas.style.width); },  
 27988: () => { if (document.fullscreenElement) return 1; },  
 28034: () => { return Module.canvas.width; },  
 28066: () => { return screen.width; },  
 28091: () => { return window.innerWidth; },  
 28117: () => { return window.innerHeight; },  
 28144: () => { if (document.fullscreenElement) return 1; },  
 28190: () => { return Module.canvas.width; },  
 28222: () => { return screen.width; },  
 28247: () => { document.exitFullscreen(); },  
 28274: () => { if (document.fullscreenElement) return 1; },  
 28320: () => { return Module.canvas.width; },  
 28352: () => { return parseInt(Module.canvas.style.width); },  
 28400: () => { document.exitFullscreen(); },  
 28427: ($0) => { Module.canvas.style.opacity = $0; },  
 28465: () => { return screen.width; },  
 28490: () => { return screen.height; },  
 28516: () => { return window.screenX; },  
 28543: () => { return window.screenY; },  
 28570: () => { return window.devicePixelRatio; },  
 28606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28710: () => { Module.canvas.style.cursor = 'none'; },  
 28747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29003: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29054: () => { if (document.fullscreenElement) return 1; },  
 29100: () => { return window.innerWidth; },  
 29126: () => { return window.innerHeight; },  
 29153: () => { if (document.pointerLockElement) return 1; }
};
