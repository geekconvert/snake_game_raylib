...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpk5lanfwc.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_loading.data';
      var REMOTE_PACKAGE_BASE = 'models_loading.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_loading.data');

      };
      Module['addRunDependency']('datafile_models_loading.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpk5lanfwc.js
...
function findWasmBinary() {
    return locateFile('models_loading.wasm');
}
...
var ASM_CONSTS = {
  40552: () => { if (document.fullscreenElement) return 1; },  
 40598: () => { return Module.canvas.width; },  
 40630: () => { return parseInt(Module.canvas.style.width); },  
 40678: () => { document.exitFullscreen(); },  
 40705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 40778: () => { if (document.fullscreenElement) return 1; },  
 40824: () => { return Module.canvas.width; },  
 40856: () => { return screen.width; },  
 40881: () => { document.exitFullscreen(); },  
 40908: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41041: () => { return window.innerWidth; },  
 41067: () => { return window.innerHeight; },  
 41094: () => { if (document.fullscreenElement) return 1; },  
 41140: () => { return Module.canvas.width; },  
 41172: () => { return parseInt(Module.canvas.style.width); },  
 41220: () => { if (document.fullscreenElement) return 1; },  
 41266: () => { return Module.canvas.width; },  
 41298: () => { return screen.width; },  
 41323: () => { return window.innerWidth; },  
 41349: () => { return window.innerHeight; },  
 41376: () => { if (document.fullscreenElement) return 1; },  
 41422: () => { return Module.canvas.width; },  
 41454: () => { return screen.width; },  
 41479: () => { document.exitFullscreen(); },  
 41506: () => { if (document.fullscreenElement) return 1; },  
 41552: () => { return Module.canvas.width; },  
 41584: () => { return parseInt(Module.canvas.style.width); },  
 41632: () => { document.exitFullscreen(); },  
 41659: ($0) => { Module.canvas.style.opacity = $0; },  
 41697: () => { return screen.width; },  
 41722: () => { return screen.height; },  
 41748: () => { return window.screenX; },  
 41775: () => { return window.screenY; },  
 41802: () => { return window.devicePixelRatio; },  
 41838: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 41891: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 41942: () => { Module.canvas.style.cursor = 'none'; },  
 41979: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42235: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42286: () => { if (document.fullscreenElement) return 1; },  
 42332: () => { return window.innerWidth; },  
 42358: () => { return window.innerHeight; },  
 42385: () => { if (document.pointerLockElement) return 1; }
};
