...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp806gaohp.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_waving_cubes.data';
      var REMOTE_PACKAGE_BASE = 'models_waving_cubes.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_waving_cubes.data');

      };
      Module['addRunDependency']('datafile_models_waving_cubes.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp806gaohp.js
...
function findWasmBinary() {
    return locateFile('models_waving_cubes.wasm');
}
...
var ASM_CONSTS = {
  26520: () => { if (document.fullscreenElement) return 1; },  
 26566: () => { return Module.canvas.width; },  
 26598: () => { return parseInt(Module.canvas.style.width); },  
 26646: () => { document.exitFullscreen(); },  
 26673: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26746: () => { if (document.fullscreenElement) return 1; },  
 26792: () => { return Module.canvas.width; },  
 26824: () => { return screen.width; },  
 26849: () => { document.exitFullscreen(); },  
 26876: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27009: () => { return window.innerWidth; },  
 27035: () => { return window.innerHeight; },  
 27062: () => { if (document.fullscreenElement) return 1; },  
 27108: () => { return Module.canvas.width; },  
 27140: () => { return parseInt(Module.canvas.style.width); },  
 27188: () => { if (document.fullscreenElement) return 1; },  
 27234: () => { return Module.canvas.width; },  
 27266: () => { return screen.width; },  
 27291: () => { return window.innerWidth; },  
 27317: () => { return window.innerHeight; },  
 27344: () => { if (document.fullscreenElement) return 1; },  
 27390: () => { return Module.canvas.width; },  
 27422: () => { return screen.width; },  
 27447: () => { document.exitFullscreen(); },  
 27474: () => { if (document.fullscreenElement) return 1; },  
 27520: () => { return Module.canvas.width; },  
 27552: () => { return parseInt(Module.canvas.style.width); },  
 27600: () => { document.exitFullscreen(); },  
 27627: ($0) => { Module.canvas.style.opacity = $0; },  
 27665: () => { return screen.width; },  
 27690: () => { return screen.height; },  
 27716: () => { return window.screenX; },  
 27743: () => { return window.screenY; },  
 27770: () => { return window.devicePixelRatio; },  
 27806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27859: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27910: () => { Module.canvas.style.cursor = 'none'; },  
 27947: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28203: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28254: () => { if (document.fullscreenElement) return 1; },  
 28300: () => { return window.innerWidth; },  
 28326: () => { return window.innerHeight; },  
 28353: () => { if (document.pointerLockElement) return 1; }
};
