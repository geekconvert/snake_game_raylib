...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5x9rypuw.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_shapes_textures.data';
      var REMOTE_PACKAGE_BASE = 'shaders_shapes_textures.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_shapes_textures.data');

      };
      Module['addRunDependency']('datafile_shaders_shapes_textures.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5x9rypuw.js
...
function findWasmBinary() {
    return locateFile('shaders_shapes_textures.wasm');
}
...
var ASM_CONSTS = {
 ...
 30734: () => { return Module.canvas.width; },  
 30766: () => { return parseInt(Module.canvas.style.width); },  
 30814: () => { document.exitFullscreen(); },  
 30841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30914: () => { if (document.fullscreenElement) return 1; },  
 30960: () => { return Module.canvas.width; },  
 30992: () => { return screen.width; },  
 31017: () => { document.exitFullscreen(); },  
 31044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31177: () => { return window.innerWidth; },  
 31203: () => { return window.innerHeight; },  
 31230: () => { if (document.fullscreenElement) return 1; },  
 31276: () => { return Module.canvas.width; },  
 31308: () => { return parseInt(Module.canvas.style.width); },  
 31356: () => { if (document.fullscreenElement) return 1; },  
 31402: () => { return Module.canvas.width; },  
 31434: () => { return screen.width; },  
 31459: () => { return window.innerWidth; },  
 31485: () => { return window.innerHeight; },  
 31512: () => { if (document.fullscreenElement) return 1; },  
 31558: () => { return Module.canvas.width; },  
 31590: () => { return screen.width; },  
 31615: () => { document.exitFullscreen(); },  
 31642: () => { if (document.fullscreenElement) return 1; },  
 31688: () => { return Module.canvas.width; },  
 31720: () => { return parseInt(Module.canvas.style.width); },  
 31768: () => { document.exitFullscreen(); },  
 31795: ($0) => { Module.canvas.style.opacity = $0; },  
 31833: () => { return screen.width; },  
 31858: () => { return screen.height; },  
 31884: () => { return window.screenX; },  
 31911: () => { return window.screenY; },  
 31938: () => { return window.devicePixelRatio; },  
 31974: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32027: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32078: () => { Module.canvas.style.cursor = 'none'; },  
 32115: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32371: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
