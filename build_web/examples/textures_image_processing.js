...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp7t7t8mjn.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_processing.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_processing.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_processing.data');

      };
      Module['addRunDependency']('datafile_textures_image_processing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp7t7t8mjn.js
...
function findWasmBinary() {
    return locateFile('textures_image_processing.wasm');
}
...
var ASM_CONSTS = {
  36288: () => { if (document.fullscreenElement) return 1; },  
 36334: () => { return Module.canvas.width; },  
 36366: () => { return parseInt(Module.canvas.style.width); },  
 36414: () => { document.exitFullscreen(); },  
 36441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36514: () => { if (document.fullscreenElement) return 1; },  
 36560: () => { return Module.canvas.width; },  
 36592: () => { return screen.width; },  
 36617: () => { document.exitFullscreen(); },  
 36644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36777: () => { return window.innerWidth; },  
 36803: () => { return window.innerHeight; },  
 36830: () => { if (document.fullscreenElement) return 1; },  
 36876: () => { return Module.canvas.width; },  
 36908: () => { return parseInt(Module.canvas.style.width); },  
 36956: () => { if (document.fullscreenElement) return 1; },  
 37002: () => { return Module.canvas.width; },  
 37034: () => { return screen.width; },  
 37059: () => { return window.innerWidth; },  
 37085: () => { return window.innerHeight; },  
 37112: () => { if (document.fullscreenElement) return 1; },  
 37158: () => { return Module.canvas.width; },  
 37190: () => { return screen.width; },  
 37215: () => { document.exitFullscreen(); },  
 37242: () => { if (document.fullscreenElement) return 1; },  
 37288: () => { return Module.canvas.width; },  
 37320: () => { return parseInt(Module.canvas.style.width); },  
 37368: () => { document.exitFullscreen(); },  
 37395: ($0) => { Module.canvas.style.opacity = $0; },  
 37433: () => { return screen.width; },  
 37458: () => { return screen.height; },  
 37484: () => { return window.screenX; },  
 37511: () => { return window.screenY; },  
 37538: () => { return window.devicePixelRatio; },  
 37574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37627: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37678: () => { Module.canvas.style.cursor = 'none'; },  
 37715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37971: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 38022: () => { if (document.fullscreenElement) return 1; },  
 38068: () => { return window.innerWidth; },  
 38094: () => { return window.innerHeight; },  
 38121: () => { if (document.pointerLockElement) return 1; }
};
