...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpr3377in6.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_draw_circle_sector.data';
      var REMOTE_PACKAGE_BASE = 'shapes_draw_circle_sector.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_draw_circle_sector.data');

      };
      Module['addRunDependency']('datafile_shapes_draw_circle_sector.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpr3377in6.js
...
function findWasmBinary() {
    return locateFile('shapes_draw_circle_sector.wasm');
}
...
var ASM_CONSTS = {
  34544: () => { if (document.fullscreenElement) return 1; },  
 34590: () => { return Module.canvas.width; },  
 34622: () => { return parseInt(Module.canvas.style.width); },  
 34670: () => { document.exitFullscreen(); },  
 34697: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34770: () => { if (document.fullscreenElement) return 1; },  
 34816: () => { return Module.canvas.width; },  
 34848: () => { return screen.width; },  
 34873: () => { document.exitFullscreen(); },  
 34900: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35033: () => { return window.innerWidth; },  
 35059: () => { return window.innerHeight; },  
 35086: () => { if (document.fullscreenElement) return 1; },  
 35132: () => { return Module.canvas.width; },  
 35164: () => { return parseInt(Module.canvas.style.width); },  
 35212: () => { if (document.fullscreenElement) return 1; },  
 35258: () => { return Module.canvas.width; },  
 ...
 35414: () => { return Module.canvas.width; },  
 35446: () => { return screen.width; },  
 35471: () => { document.exitFullscreen(); },  
 35498: () => { if (document.fullscreenElement) return 1; },  
 35544: () => { return Module.canvas.width; },  
 35576: () => { return parseInt(Module.canvas.style.width); },  
 35624: () => { document.exitFullscreen(); },  
 35651: ($0) => { Module.canvas.style.opacity = $0; },  
 35689: () => { return screen.width; },  
 35714: () => { return screen.height; },  
 35740: () => { return window.screenX; },  
 35767: () => { return window.screenY; },  
 35794: () => { return window.devicePixelRatio; },  
 35830: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 35883: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 35934: () => { Module.canvas.style.cursor = 'none'; },  
 35971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36227: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36278: () => { if (document.fullscreenElement) return 1; },  
 36324: () => { return window.innerWidth; },  
 36350: () => { return window.innerHeight; },  
 36377: () => { if (document.pointerLockElement) return 1; }
};
