...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpibx24f5r.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_draw_cube_texture.data';
      var REMOTE_PACKAGE_BASE = 'models_draw_cube_texture.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_draw_cube_texture.data');

      };
      Module['addRunDependency']('datafile_models_draw_cube_texture.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpibx24f5r.js
...
function findWasmBinary() {
    return locateFile('models_draw_cube_texture.wasm');
}
...
var ASM_CONSTS = {
  30424: () => { if (document.fullscreenElement) return 1; },  
 30470: () => { return Module.canvas.width; },  
 30502: () => { return parseInt(Module.canvas.style.width); },  
 30550: () => { document.exitFullscreen(); },  
 30577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30650: () => { if (document.fullscreenElement) return 1; },  
 30696: () => { return Module.canvas.width; },  
 30728: () => { return screen.width; },  
 30753: () => { document.exitFullscreen(); },  
 30780: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30913: () => { return window.innerWidth; },  
 30939: () => { return window.innerHeight; },  
 30966: () => { if (document.fullscreenElement) return 1; },  
 31012: () => { return Module.canvas.width; },  
 31044: () => { return parseInt(Module.canvas.style.width); },  
 31092: () => { if (document.fullscreenElement) return 1; },  
 31138: () => { return Module.canvas.width; },  
 31170: () => { return screen.width; },  
 31195: () => { return window.innerWidth; },  
 31221: () => { return window.innerHeight; },  
 31248: () => { if (document.fullscreenElement) return 1; },  
 31294: () => { return Module.canvas.width; },  
 31326: () => { return screen.width; },  
 31351: () => { document.exitFullscreen(); },  
 31378: () => { if (document.fullscreenElement) return 1; },  
 31424: () => { return Module.canvas.width; },  
 31456: () => { return parseInt(Module.canvas.style.width); },  
 31504: () => { document.exitFullscreen(); },  
 31531: ($0) => { Module.canvas.style.opacity = $0; },  
 31569: () => { return screen.width; },  
 31594: () => { return screen.height; },  
 31620: () => { return window.screenX; },  
 31647: () => { return window.screenY; },  
 31674: () => { return window.devicePixelRatio; },  
 31710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31763: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31814: () => { Module.canvas.style.cursor = 'none'; },  
 31851: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32107: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32158: () => { if (document.fullscreenElement) return 1; },  
 32204: () => { return window.innerWidth; },  
 32230: () => { return window.innerHeight; },  
 32257: () => { if (document.pointerLockElement) return 1; }
};
