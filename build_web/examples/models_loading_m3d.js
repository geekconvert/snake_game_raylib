...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpko0h9lvy.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_loading_m3d.data';
      var REMOTE_PACKAGE_BASE = 'models_loading_m3d.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_loading_m3d.data');

      };
      Module['addRunDependency']('datafile_models_loading_m3d.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpko0h9lvy.js
...
function findWasmBinary() {
    return locateFile('models_loading_m3d.wasm');
}
...
var ASM_CONSTS = {
  41416: () => { if (document.fullscreenElement) return 1; },  
 41462: () => { return Module.canvas.width; },  
 41494: () => { return parseInt(Module.canvas.style.width); },  
 41542: () => { document.exitFullscreen(); },  
 41569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41642: () => { if (document.fullscreenElement) return 1; },  
 41688: () => { return Module.canvas.width; },  
 41720: () => { return screen.width; },  
 41745: () => { document.exitFullscreen(); },  
 41772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41905: () => { return window.innerWidth; },  
 41931: () => { return window.innerHeight; },  
 41958: () => { if (document.fullscreenElement) return 1; },  
 42004: () => { return Module.canvas.width; },  
 42036: () => { return parseInt(Module.canvas.style.width); },  
 42084: () => { if (document.fullscreenElement) return 1; },  
 42130: () => { return Module.canvas.width; },  
 42162: () => { return screen.width; },  
 42187: () => { return window.innerWidth; },  
 42213: () => { return window.innerHeight; },  
 42240: () => { if (document.fullscreenElement) return 1; },  
 42286: () => { return Module.canvas.width; },  
 42318: () => { return screen.width; },  
 42343: () => { document.exitFullscreen(); },  
 42370: () => { if (document.fullscreenElement) return 1; },  
 42416: () => { return Module.canvas.width; },  
 42448: () => { return parseInt(Module.canvas.style.width); },  
 42496: () => { document.exitFullscreen(); },  
 42523: ($0) => { Module.canvas.style.opacity = $0; },  
 42561: () => { return screen.width; },  
 42586: () => { return screen.height; },  
 42612: () => { return window.screenX; },  
 42639: () => { return window.screenY; },  
 42666: () => { return window.devicePixelRatio; },  
 42702: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42755: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42806: () => { Module.canvas.style.cursor = 'none'; },  
 42843: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 43099: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43150: () => { if (document.fullscreenElement) return 1; },  
 43196: () => { return window.innerWidth; },  
 43222: () => { return window.innerHeight; },  
 43249: () => { if (document.pointerLockElement) return 1; }
};
