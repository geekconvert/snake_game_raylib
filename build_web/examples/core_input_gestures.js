...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjkzidb75.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_input_gestures.data';
      var REMOTE_PACKAGE_BASE = 'core_input_gestures.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_input_gestures.data');

      };
      Module['addRunDependency']('datafile_core_input_gestures.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjkzidb75.js
...
function findWasmBinary() {
    return locateFile('core_input_gestures.wasm');
}
...
var ASM_CONSTS = {
  26560: () => { if (document.fullscreenElement) return 1; },  
 26606: () => { return Module.canvas.width; },  
 26638: () => { return parseInt(Module.canvas.style.width); },  
 26686: () => { document.exitFullscreen(); },  
 26713: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26786: () => { if (document.fullscreenElement) return 1; },  
 26832: () => { return Module.canvas.width; },  
 26864: () => { return screen.width; },  
 26889: () => { document.exitFullscreen(); },  
 26916: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27049: () => { return window.innerWidth; },  
 27075: () => { return window.innerHeight; },  
 27102: () => { if (document.fullscreenElement) return 1; },  
 27148: () => { return Module.canvas.width; },  
 27180: () => { return parseInt(Module.canvas.style.width); },  
 27228: () => { if (document.fullscreenElement) return 1; },  
 27274: () => { return Module.canvas.width; },  
 27306: () => { return screen.width; },  
 27331: () => { return window.innerWidth; },  
 27357: () => { return window.innerHeight; },  
 27384: () => { if (document.fullscreenElement) return 1; },  
 27430: () => { return Module.canvas.width; },  
 27462: () => { return screen.width; },  
 27487: () => { document.exitFullscreen(); },  
 27514: () => { if (document.fullscreenElement) return 1; },  
 27560: () => { return Module.canvas.width; },  
 27592: () => { return parseInt(Module.canvas.style.width); },  
 27640: () => { document.exitFullscreen(); },  
 27667: ($0) => { Module.canvas.style.opacity = $0; },  
 27705: () => { return screen.width; },  
 27730: () => { return screen.height; },  
 27756: () => { return window.screenX; },  
 27783: () => { return window.screenY; },  
 27810: () => { return window.devicePixelRatio; },  
 27846: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27899: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27950: () => { Module.canvas.style.cursor = 'none'; },  
 27987: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28243: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28294: () => { if (document.fullscreenElement) return 1; },  
 28340: () => { return window.innerWidth; },  
 28366: () => { return window.innerHeight; },  
 28393: () => { if (document.pointerLockElement) return 1; }
};
