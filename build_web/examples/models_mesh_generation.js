...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpw78dlp1j.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_mesh_generation.data';
      var REMOTE_PACKAGE_BASE = 'models_mesh_generation.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_mesh_generation.data');

      };
      Module['addRunDependency']('datafile_models_mesh_generation.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpw78dlp1j.js
...
function findWasmBinary() {
    return locateFile('models_mesh_generation.wasm');
}
...
var ASM_CONSTS = {
  28312: () => { if (document.fullscreenElement) return 1; },  
 28358: () => { return Module.canvas.width; },  
 28390: () => { return parseInt(Module.canvas.style.width); },  
 28438: () => { document.exitFullscreen(); },  
 28465: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 28538: () => { if (document.fullscreenElement) return 1; },  
 28584: () => { return Module.canvas.width; },  
 28616: () => { return screen.width; },  
 28641: () => { document.exitFullscreen(); },  
 28668: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28801: () => { return window.innerWidth; },  
 28827: () => { return window.innerHeight; },  
 28854: () => { if (document.fullscreenElement) return 1; },  
 28900: () => { return Module.canvas.width; },  
 28932: () => { return parseInt(Module.canvas.style.width); },  
 28980: () => { if (document.fullscreenElement) return 1; },  
 29026: () => { return Module.canvas.width; },  
 29058: () => { return screen.width; },  
 29083: () => { return window.innerWidth; },  
 29109: () => { return window.innerHeight; },  
 29136: () => { if (document.fullscreenElement) return 1; },  
 29182: () => { return Module.canvas.width; },  
 29214: () => { return screen.width; },  
 29239: () => { document.exitFullscreen(); },  
 29266: () => { if (document.fullscreenElement) return 1; },  
 29312: () => { return Module.canvas.width; },  
 29344: () => { return parseInt(Module.canvas.style.width); },  
 29392: () => { document.exitFullscreen(); },  
 29419: ($0) => { Module.canvas.style.opacity = $0; },  
 29457: () => { return screen.width; },  
 29482: () => { return screen.height; },  
 29508: () => { return window.screenX; },  
 29535: () => { return window.screenY; },  
 29562: () => { return window.devicePixelRatio; },  
 29598: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 29651: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29702: () => { Module.canvas.style.cursor = 'none'; },  
 29739: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29995: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30046: () => { if (document.fullscreenElement) return 1; },  
 30092: () => { return window.innerWidth; },  
 30118: () => { return window.innerHeight; },  
 30145: () => { if (document.pointerLockElement) return 1; }
};
