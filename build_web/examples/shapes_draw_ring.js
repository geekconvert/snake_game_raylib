...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpruo002x6.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_draw_ring.data';
      var REMOTE_PACKAGE_BASE = 'shapes_draw_ring.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_draw_ring.data');

      };
      Module['addRunDependency']('datafile_shapes_draw_ring.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpruo002x6.js
...
function findWasmBinary() {
    return locateFile('shapes_draw_ring.wasm');
}
...
var ASM_CONSTS = {
  34608: () => { if (document.fullscreenElement) return 1; },  
 34654: () => { return Module.canvas.width; },  
 34686: () => { return parseInt(Module.canvas.style.width); },  
 34734: () => { document.exitFullscreen(); },  
 34761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34834: () => { if (document.fullscreenElement) return 1; },  
 34880: () => { return Module.canvas.width; },  
 34912: () => { return screen.width; },  
 34937: () => { document.exitFullscreen(); },  
 34964: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35097: () => { return window.innerWidth; },  
 35123: () => { return window.innerHeight; },  
 35150: () => { if (document.fullscreenElement) return 1; },  
 35196: () => { return Module.canvas.width; },  
 35228: () => { return parseInt(Module.canvas.style.width); },  
 35276: () => { if (document.fullscreenElement) return 1; },  
 35322: () => { return Module.canvas.width; },  
 ...
 35478: () => { return Module.canvas.width; },  
 35510: () => { return screen.width; },  
 35535: () => { document.exitFullscreen(); },  
 35562: () => { if (document.fullscreenElement) return 1; },  
 35608: () => { return Module.canvas.width; },  
 35640: () => { return parseInt(Module.canvas.style.width); },  
 35688: () => { document.exitFullscreen(); },  
 35715: ($0) => { Module.canvas.style.opacity = $0; },  
 35753: () => { return screen.width; },  
 35778: () => { return screen.height; },  
 35804: () => { return window.screenX; },  
 35831: () => { return window.screenY; },  
 35858: () => { return window.devicePixelRatio; },  
 35894: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 35947: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 35998: () => { Module.canvas.style.cursor = 'none'; },  
 36035: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36291: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36342: () => { if (document.fullscreenElement) return 1; },  
 36388: () => { return window.innerWidth; },  
 36414: () => { return window.innerHeight; },  
 36441: () => { if (document.pointerLockElement) return 1; }
};
