...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp9cdbbsjk.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_blend_modes.data';
      var REMOTE_PACKAGE_BASE = 'textures_blend_modes.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_blend_modes.data');

      };
      Module['addRunDependency']('datafile_textures_blend_modes.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp9cdbbsjk.js
...
function findWasmBinary() {
    return locateFile('textures_blend_modes.wasm');
}
...
var ASM_CONSTS = {
  30432: () => { if (document.fullscreenElement) return 1; },  
 30478: () => { return Module.canvas.width; },  
 30510: () => { return parseInt(Module.canvas.style.width); },  
 30558: () => { document.exitFullscreen(); },  
 30585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30658: () => { if (document.fullscreenElement) return 1; },  
 30704: () => { return Module.canvas.width; },  
 30736: () => { return screen.width; },  
 30761: () => { document.exitFullscreen(); },  
 30788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30921: () => { return window.innerWidth; },  
 30947: () => { return window.innerHeight; },  
 30974: () => { if (document.fullscreenElement) return 1; },  
 31020: () => { return Module.canvas.width; },  
 31052: () => { return parseInt(Module.canvas.style.width); },  
 31100: () => { if (document.fullscreenElement) return 1; },  
 31146: () => { return Module.canvas.width; },  
 31178: () => { return screen.width; },  
 31203: () => { return window.innerWidth; },  
 31229: () => { return window.innerHeight; },  
 31256: () => { if (document.fullscreenElement) return 1; },  
 31302: () => { return Module.canvas.width; },  
 31334: () => { return screen.width; },  
 31359: () => { document.exitFullscreen(); },  
 31386: () => { if (document.fullscreenElement) return 1; },  
 31432: () => { return Module.canvas.width; },  
 31464: () => { return parseInt(Module.canvas.style.width); },  
 31512: () => { document.exitFullscreen(); },  
 31539: ($0) => { Module.canvas.style.opacity = $0; },  
 31577: () => { return screen.width; },  
 31602: () => { return screen.height; },  
 31628: () => { return window.screenX; },  
 31655: () => { return window.screenY; },  
 31682: () => { return window.devicePixelRatio; },  
 31718: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31771: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31822: () => { Module.canvas.style.cursor = 'none'; },  
 31859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32115: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32166: () => { if (document.fullscreenElement) return 1; },  
 32212: () => { return window.innerWidth; },  
 32238: () => { return window.innerHeight; },  
 32265: () => { if (document.pointerLockElement) return 1; }
};
