...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpiajzt81g.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_heightmap.data';
      var REMOTE_PACKAGE_BASE = 'models_heightmap.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_heightmap.data');

      };
      Module['addRunDependency']('datafile_models_heightmap.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpiajzt81g.js
...
function findWasmBinary() {
    return locateFile('models_heightmap.wasm');
}
...
var ASM_CONSTS = {
  30888: () => { if (document.fullscreenElement) return 1; },  
 30934: () => { return Module.canvas.width; },  
 30966: () => { return parseInt(Module.canvas.style.width); },  
 31014: () => { document.exitFullscreen(); },  
 31041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31114: () => { if (document.fullscreenElement) return 1; },  
 31160: () => { return Module.canvas.width; },  
 31192: () => { return screen.width; },  
 31217: () => { document.exitFullscreen(); },  
 31244: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31377: () => { return window.innerWidth; },  
 31403: () => { return window.innerHeight; },  
 31430: () => { if (document.fullscreenElement) return 1; },  
 31476: () => { return Module.canvas.width; },  
 31508: () => { return parseInt(Module.canvas.style.width); },  
 31556: () => { if (document.fullscreenElement) return 1; },  
 31602: () => { return Module.canvas.width; },  
 31634: () => { return screen.width; },  
 31659: () => { return window.innerWidth; },  
 31685: () => { return window.innerHeight; },  
 31712: () => { if (document.fullscreenElement) return 1; },  
 31758: () => { return Module.canvas.width; },  
 31790: () => { return screen.width; },  
 31815: () => { document.exitFullscreen(); },  
 31842: () => { if (document.fullscreenElement) return 1; },  
 31888: () => { return Module.canvas.width; },  
 31920: () => { return parseInt(Module.canvas.style.width); },  
 31968: () => { document.exitFullscreen(); },  
 31995: ($0) => { Module.canvas.style.opacity = $0; },  
 32033: () => { return screen.width; },  
 32058: () => { return screen.height; },  
 32084: () => { return window.screenX; },  
 32111: () => { return window.screenY; },  
 32138: () => { return window.devicePixelRatio; },  
 32174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32227: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32278: () => { Module.canvas.style.cursor = 'none'; },  
 32315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32571: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32622: () => { if (document.fullscreenElement) return 1; },  
 32668: () => { return window.innerWidth; },  
 32694: () => { return window.innerHeight; },  
 32721: () => { if (document.pointerLockElement) return 1; }
};
