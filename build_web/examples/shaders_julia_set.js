...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_1cd_45t.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_julia_set.data';
      var REMOTE_PACKAGE_BASE = 'shaders_julia_set.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_julia_set.data');

      };
      Module['addRunDependency']('datafile_shaders_julia_set.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_1cd_45t.js
...
function findWasmBinary() {
    return locateFile('shaders_julia_set.wasm');
}
...
var ASM_CONSTS = {
  27520: () => { if (document.fullscreenElement) return 1; },  
 27566: () => { return Module.canvas.width; },  
 27598: () => { return parseInt(Module.canvas.style.width); },  
 27646: () => { document.exitFullscreen(); },  
 27673: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27746: () => { if (document.fullscreenElement) return 1; },  
 27792: () => { return Module.canvas.width; },  
 27824: () => { return screen.width; },  
 27849: () => { document.exitFullscreen(); },  
 27876: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28009: () => { return window.innerWidth; },  
 28035: () => { return window.innerHeight; },  
 28062: () => { if (document.fullscreenElement) return 1; },  
 28108: () => { return Module.canvas.width; },  
 28140: () => { return parseInt(Module.canvas.style.width); },  
 28188: () => { if (document.fullscreenElement) return 1; },  
 28234: () => { return Module.canvas.width; },  
 28266: () => { return screen.width; },  
 28291: () => { return window.innerWidth; },  
 28317: () => { return window.innerHeight; },  
 28344: () => { if (document.fullscreenElement) return 1; },  
 28390: () => { return Module.canvas.width; },  
 28422: () => { return screen.width; },  
 28447: () => { document.exitFullscreen(); },  
 28474: () => { if (document.fullscreenElement) return 1; },  
 28520: () => { return Module.canvas.width; },  
 28552: () => { return parseInt(Module.canvas.style.width); },  
 28600: () => { document.exitFullscreen(); },  
 28627: ($0) => { Module.canvas.style.opacity = $0; },  
 28665: () => { return screen.width; },  
 28690: () => { return screen.height; },  
 28716: () => { return window.screenX; },  
 28743: () => { return window.screenY; },  
 28770: () => { return window.devicePixelRatio; },  
 28806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28859: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28910: () => { Module.canvas.style.cursor = 'none'; },  
 28947: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29203: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29254: () => { if (document.fullscreenElement) return 1; },  
 29300: () => { return window.innerWidth; },  
 29326: () => { return window.innerHeight; },  
 29353: () => { if (document.pointerLockElement) return 1; }
};
