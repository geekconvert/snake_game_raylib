...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpkf3dnpai.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_mesh_picking.data';
      var REMOTE_PACKAGE_BASE = 'models_mesh_picking.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_mesh_picking.data');

      };
      Module['addRunDependency']('datafile_models_mesh_picking.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpkf3dnpai.js
...
function findWasmBinary() {
    return locateFile('models_mesh_picking.wasm');
}
...
var ASM_CONSTS = {
  40792: () => { if (document.fullscreenElement) return 1; },  
 40838: () => { return Module.canvas.width; },  
 40870: () => { return parseInt(Module.canvas.style.width); },  
 40918: () => { document.exitFullscreen(); },  
 40945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41018: () => { if (document.fullscreenElement) return 1; },  
 41064: () => { return Module.canvas.width; },  
 41096: () => { return screen.width; },  
 41121: () => { document.exitFullscreen(); },  
 41148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41281: () => { return window.innerWidth; },  
 41307: () => { return window.innerHeight; },  
 41334: () => { if (document.fullscreenElement) return 1; },  
 41380: () => { return Module.canvas.width; },  
 41412: () => { return parseInt(Module.canvas.style.width); },  
 41460: () => { if (document.fullscreenElement) return 1; },  
 41506: () => { return Module.canvas.width; },  
 41538: () => { return screen.width; },  
 41563: () => { return window.innerWidth; },  
 41589: () => { return window.innerHeight; },  
 41616: () => { if (document.fullscreenElement) return 1; },  
 41662: () => { return Module.canvas.width; },  
 41694: () => { return screen.width; },  
 41719: () => { document.exitFullscreen(); },  
 41746: () => { if (document.fullscreenElement) return 1; },  
 41792: () => { return Module.canvas.width; },  
 41824: () => { return parseInt(Module.canvas.style.width); },  
 41872: () => { document.exitFullscreen(); },  
 41899: ($0) => { Module.canvas.style.opacity = $0; },  
 41937: () => { return screen.width; },  
 41962: () => { return screen.height; },  
 41988: () => { return window.screenX; },  
 42015: () => { return window.screenY; },  
 42042: () => { return window.devicePixelRatio; },  
 42078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42131: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42182: () => { Module.canvas.style.cursor = 'none'; },  
 42219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42475: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42526: () => { if (document.fullscreenElement) return 1; },  
 42572: () => { return window.innerWidth; },  
 42598: () => { return window.innerHeight; },  
 42625: () => { if (document.pointerLockElement) return 1; }
};
