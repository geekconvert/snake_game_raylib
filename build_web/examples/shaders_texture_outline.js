...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgytxqdbq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_texture_outline.data';
      var REMOTE_PACKAGE_BASE = 'shaders_texture_outline.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_texture_outline.data');

      };
      Module['addRunDependency']('datafile_shaders_texture_outline.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgytxqdbq.js
...
function findWasmBinary() {
    return locateFile('shaders_texture_outline.wasm');
}
...
var ASM_CONSTS = {
  30832: () => { if (document.fullscreenElement) return 1; },  
 30878: () => { return Module.canvas.width; },  
 30910: () => { return parseInt(Module.canvas.style.width); },  
 30958: () => { document.exitFullscreen(); },  
 30985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31058: () => { if (document.fullscreenElement) return 1; },  
 31104: () => { return Module.canvas.width; },  
 31136: () => { return screen.width; },  
 31161: () => { document.exitFullscreen(); },  
 31188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31321: () => { return window.innerWidth; },  
 31347: () => { return window.innerHeight; },  
 31374: () => { if (document.fullscreenElement) return 1; },  
 31420: () => { return Module.canvas.width; },  
 31452: () => { return parseInt(Module.canvas.style.width); },  
 31500: () => { if (document.fullscreenElement) return 1; },  
 31546: () => { return Module.canvas.width; },  
 31578: () => { return screen.width; },  
 31603: () => { return window.innerWidth; },  
 31629: () => { return window.innerHeight; },  
 31656: () => { if (document.fullscreenElement) return 1; },  
 31702: () => { return Module.canvas.width; },  
 31734: () => { return screen.width; },  
 31759: () => { document.exitFullscreen(); },  
 31786: () => { if (document.fullscreenElement) return 1; },  
 31832: () => { return Module.canvas.width; },  
 31864: () => { return parseInt(Module.canvas.style.width); },  
 31912: () => { document.exitFullscreen(); },  
 31939: ($0) => { Module.canvas.style.opacity = $0; },  
 31977: () => { return screen.width; },  
 32002: () => { return screen.height; },  
 32028: () => { return window.screenX; },  
 32055: () => { return window.screenY; },  
 32082: () => { return window.devicePixelRatio; },  
 32118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32222: () => { Module.canvas.style.cursor = 'none'; },  
 32259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32515: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
