...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpvz7qt7tc.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_window_flags.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_window_flags.data');

      };
      Module['addRunDependency']('datafile_core_window_flags.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpvz7qt7tc.js
...
function findWasmBinary() {
    return locateFile('core_window_flags.wasm');
}
...
var ASM_CONSTS = {
  29088: () => { if (document.fullscreenElement) return 1; },  
 29134: () => { return Module.canvas.width; },  
 29166: () => { return parseInt(Module.canvas.style.width); },  
 29214: () => { document.exitFullscreen(); },  
 29241: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 29314: () => { if (document.fullscreenElement) return 1; },  
 29360: () => { return Module.canvas.width; },  
 29392: () => { return screen.width; },  
 29417: () => { document.exitFullscreen(); },  
 29444: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 29577: () => { return window.innerWidth; },  
 29603: () => { return window.innerHeight; },  
 29630: () => { if (document.fullscreenElement) return 1; },  
 29676: () => { return Module.canvas.width; },  
 29708: () => { return parseInt(Module.canvas.style.width); },  
 29756: () => { if (document.fullscreenElement) return 1; },  
 29802: () => { return Module.canvas.width; },  
 29834: () => { return screen.width; },  
 29859: () => { return window.innerWidth; },  
 29885: () => { return window.innerHeight; },  
 29912: () => { if (document.fullscreenElement) return 1; },  
 29958: () => { return Module.canvas.width; },  
 29990: () => { return screen.width; },  
 30015: () => { document.exitFullscreen(); },  
 30042: () => { if (document.fullscreenElement) return 1; },  
 30088: () => { return Module.canvas.width; },  
 30120: () => { return parseInt(Module.canvas.style.width); },  
 30168: () => { document.exitFullscreen(); },  
 30195: ($0) => { Module.canvas.style.opacity = $0; },  
 30233: () => { return screen.width; },  
 30258: () => { return screen.height; },  
 30284: () => { return window.screenX; },  
 30311: () => { return window.screenY; },  
 30338: () => { return window.devicePixelRatio; },  
 30374: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 30427: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30478: () => { Module.canvas.style.cursor = 'none'; },  
 30515: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 30771: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30822: () => { if (document.fullscreenElement) return 1; },  
 30868: () => { return window.innerWidth; },  
 30894: () => { return window.innerHeight; },  
 30921: () => { if (document.pointerLockElement) return 1; }
};
