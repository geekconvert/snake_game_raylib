...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpddgf_ycu.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_input_box.data';
      var REMOTE_PACKAGE_BASE = 'text_input_box.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_input_box.data');

      };
      Module['addRunDependency']('datafile_text_input_box.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpddgf_ycu.js
...
function findWasmBinary() {
    return locateFile('text_input_box.wasm');
}
...
var ASM_CONSTS = {
  26480: () => { if (document.fullscreenElement) return 1; },  
 26526: () => { return Module.canvas.width; },  
 26558: () => { return parseInt(Module.canvas.style.width); },  
 26606: () => { document.exitFullscreen(); },  
 26633: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26706: () => { if (document.fullscreenElement) return 1; },  
 26752: () => { return Module.canvas.width; },  
 26784: () => { return screen.width; },  
 26809: () => { document.exitFullscreen(); },  
 26836: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26969: () => { return window.innerWidth; },  
 26995: () => { return window.innerHeight; },  
 27022: () => { if (document.fullscreenElement) return 1; },  
 27068: () => { return Module.canvas.width; },  
 27100: () => { return parseInt(Module.canvas.style.width); },  
 27148: () => { if (document.fullscreenElement) return 1; },  
 27194: () => { return Module.canvas.width; },  
 27226: () => { return screen.width; },  
 27251: () => { return window.innerWidth; },  
 27277: () => { return window.innerHeight; },  
 27304: () => { if (document.fullscreenElement) return 1; },  
 27350: () => { return Module.canvas.width; },  
 27382: () => { return screen.width; },  
 27407: () => { document.exitFullscreen(); },  
 27434: () => { if (document.fullscreenElement) return 1; },  
 27480: () => { return Module.canvas.width; },  
 27512: () => { return parseInt(Module.canvas.style.width); },  
 27560: () => { document.exitFullscreen(); },  
 27587: ($0) => { Module.canvas.style.opacity = $0; },  
 27625: () => { return screen.width; },  
 27650: () => { return screen.height; },  
 27676: () => { return window.screenX; },  
 27703: () => { return window.screenY; },  
 27730: () => { return window.devicePixelRatio; },  
 27766: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27819: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27870: () => { Module.canvas.style.cursor = 'none'; },  
 27907: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28163: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28214: () => { if (document.fullscreenElement) return 1; },  
 28260: () => { return window.innerWidth; },  
 28286: () => { return window.innerHeight; },  
 28313: () => { if (document.pointerLockElement) return 1; }
};
