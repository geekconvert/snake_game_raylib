...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjcfcnvnk.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_kernel.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_kernel.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_kernel.data');

      };
      Module['addRunDependency']('datafile_textures_image_kernel.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjcfcnvnk.js
...
function findWasmBinary() {
    return locateFile('textures_image_kernel.wasm');
}
...
var ASM_CONSTS = {
 ...
 36238: () => { return Module.canvas.width; },  
 36270: () => { return parseInt(Module.canvas.style.width); },  
 36318: () => { document.exitFullscreen(); },  
 36345: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36418: () => { if (document.fullscreenElement) return 1; },  
 36464: () => { return Module.canvas.width; },  
 36496: () => { return screen.width; },  
 36521: () => { document.exitFullscreen(); },  
 36548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36681: () => { return window.innerWidth; },  
 36707: () => { return window.innerHeight; },  
 36734: () => { if (document.fullscreenElement) return 1; },  
 36780: () => { return Module.canvas.width; },  
 36812: () => { return parseInt(Module.canvas.style.width); },  
 36860: () => { if (document.fullscreenElement) return 1; },  
 36906: () => { return Module.canvas.width; },  
 ...
 37062: () => { return Module.canvas.width; },  
 37094: () => { return screen.width; },  
 37119: () => { document.exitFullscreen(); },  
 37146: () => { if (document.fullscreenElement) return 1; },  
 37192: () => { return Module.canvas.width; },  
 37224: () => { return parseInt(Module.canvas.style.width); },  
 37272: () => { document.exitFullscreen(); },  
 37299: ($0) => { Module.canvas.style.opacity = $0; },  
 37337: () => { return screen.width; },  
 37362: () => { return screen.height; },  
 37388: () => { return window.screenX; },  
 37415: () => { return window.screenY; },  
 37442: () => { return window.devicePixelRatio; },  
 37478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37531: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37582: () => { Module.canvas.style.cursor = 'none'; },  
 37619: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37875: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37926: () => { if (document.fullscreenElement) return 1; },  
 37972: () => { return window.innerWidth; },  
 37998: () => { return window.innerHeight; },  
 38025: () => { if (document.pointerLockElement) return 1; }
};
