...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpyox2oai8.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_texture_drawing.data';
      var REMOTE_PACKAGE_BASE = 'shaders_texture_drawing.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_texture_drawing.data');

      };
      Module['addRunDependency']('datafile_shaders_texture_drawing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpyox2oai8.js
...
function findWasmBinary() {
    return locateFile('shaders_texture_drawing.wasm');
}
...
var ASM_CONSTS = {
  26864: () => { if (document.fullscreenElement) return 1; },  
 26910: () => { return Module.canvas.width; },  
 26942: () => { return parseInt(Module.canvas.style.width); },  
 26990: () => { document.exitFullscreen(); },  
 27017: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27090: () => { if (document.fullscreenElement) return 1; },  
 27136: () => { return Module.canvas.width; },  
 27168: () => { return screen.width; },  
 27193: () => { document.exitFullscreen(); },  
 27220: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27353: () => { return window.innerWidth; },  
 27379: () => { return window.innerHeight; },  
 27406: () => { if (document.fullscreenElement) return 1; },  
 27452: () => { return Module.canvas.width; },  
 27484: () => { return parseInt(Module.canvas.style.width); },  
 27532: () => { if (document.fullscreenElement) return 1; },  
 27578: () => { return Module.canvas.width; },  
 27610: () => { return screen.width; },  
 27635: () => { return window.innerWidth; },  
 27661: () => { return window.innerHeight; },  
 27688: () => { if (document.fullscreenElement) return 1; },  
 27734: () => { return Module.canvas.width; },  
 27766: () => { return screen.width; },  
 27791: () => { document.exitFullscreen(); },  
 27818: () => { if (document.fullscreenElement) return 1; },  
 27864: () => { return Module.canvas.width; },  
 27896: () => { return parseInt(Module.canvas.style.width); },  
 27944: () => { document.exitFullscreen(); },  
 27971: ($0) => { Module.canvas.style.opacity = $0; },  
 28009: () => { return screen.width; },  
 28034: () => { return screen.height; },  
 28060: () => { return window.screenX; },  
 28087: () => { return window.screenY; },  
 28114: () => { return window.devicePixelRatio; },  
 28150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28203: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28254: () => { Module.canvas.style.cursor = 'none'; },  
 28291: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28547: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28598: () => { if (document.fullscreenElement) return 1; },  
 28644: () => { return window.innerWidth; },  
 28670: () => { return window.innerHeight; },  
 28697: () => { if (document.pointerLockElement) return 1; }
};
