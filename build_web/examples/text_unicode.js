...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp3c44dswr.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_unicode.data';
      var REMOTE_PACKAGE_BASE = 'text_unicode.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_unicode.data');

      };
      Module['addRunDependency']('datafile_text_unicode.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp3c44dswr.js
...
function findWasmBinary() {
    return locateFile('text_unicode.wasm');
}
...
var ASM_CONSTS = {
  49712: () => { if (document.fullscreenElement) return 1; },  
 49758: () => { return Module.canvas.width; },  
 49790: () => { return parseInt(Module.canvas.style.width); },  
 49838: () => { document.exitFullscreen(); },  
 49865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 49938: () => { if (document.fullscreenElement) return 1; },  
 49984: () => { return Module.canvas.width; },  
 50016: () => { return screen.width; },  
 50041: () => { document.exitFullscreen(); },  
 50068: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 50201: () => { return window.innerWidth; },  
 50227: () => { return window.innerHeight; },  
 50254: () => { if (document.fullscreenElement) return 1; },  
 50300: () => { return Module.canvas.width; },  
 50332: () => { return parseInt(Module.canvas.style.width); },  
 50380: () => { if (document.fullscreenElement) return 1; },  
 50426: () => { return Module.canvas.width; },  
 50458: () => { return screen.width; },  
 50483: () => { return window.innerWidth; },  
 50509: () => { return window.innerHeight; },  
 50536: () => { if (document.fullscreenElement) return 1; },  
 50582: () => { return Module.canvas.width; },  
 50614: () => { return screen.width; },  
 50639: () => { document.exitFullscreen(); },  
 50666: () => { if (document.fullscreenElement) return 1; },  
 50712: () => { return Module.canvas.width; },  
 50744: () => { return parseInt(Module.canvas.style.width); },  
 50792: () => { document.exitFullscreen(); },  
 50819: ($0) => { Module.canvas.style.opacity = $0; },  
 50857: () => { return screen.width; },  
 50882: () => { return screen.height; },  
 50908: () => { return window.screenX; },  
 50935: () => { return window.screenY; },  
 50962: () => { return window.devicePixelRatio; },  
 50998: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 51051: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 51102: () => { Module.canvas.style.cursor = 'none'; },  
 51139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 51395: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 51446: () => { if (document.fullscreenElement) return 1; },  
 51492: () => { return window.innerWidth; },  
 51518: () => { return window.innerHeight; },  
 51545: () => { if (document.pointerLockElement) return 1; }
};
