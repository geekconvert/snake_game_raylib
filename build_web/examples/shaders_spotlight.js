...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsqjfg9sx.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_spotlight.data';
      var REMOTE_PACKAGE_BASE = 'shaders_spotlight.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_spotlight.data');

      };
      Module['addRunDependency']('datafile_shaders_spotlight.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsqjfg9sx.js
...
function findWasmBinary() {
    return locateFile('shaders_spotlight.wasm');
}
...
var ASM_CONSTS = {
  30816: () => { if (document.fullscreenElement) return 1; },  
 30862: () => { return Module.canvas.width; },  
 30894: () => { return parseInt(Module.canvas.style.width); },  
 30942: () => { document.exitFullscreen(); },  
 30969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31042: () => { if (document.fullscreenElement) return 1; },  
 31088: () => { return Module.canvas.width; },  
 31120: () => { return screen.width; },  
 31145: () => { document.exitFullscreen(); },  
 31172: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31305: () => { return window.innerWidth; },  
 31331: () => { return window.innerHeight; },  
 31358: () => { if (document.fullscreenElement) return 1; },  
 31404: () => { return Module.canvas.width; },  
 31436: () => { return parseInt(Module.canvas.style.width); },  
 31484: () => { if (document.fullscreenElement) return 1; },  
 31530: () => { return Module.canvas.width; },  
 31562: () => { return screen.width; },  
 31587: () => { return window.innerWidth; },  
 31613: () => { return window.innerHeight; },  
 31640: () => { if (document.fullscreenElement) return 1; },  
 31686: () => { return Module.canvas.width; },  
 31718: () => { return screen.width; },  
 31743: () => { document.exitFullscreen(); },  
 31770: () => { if (document.fullscreenElement) return 1; },  
 31816: () => { return Module.canvas.width; },  
 31848: () => { return parseInt(Module.canvas.style.width); },  
 31896: () => { document.exitFullscreen(); },  
 31923: ($0) => { Module.canvas.style.opacity = $0; },  
 31961: () => { return screen.width; },  
 31986: () => { return screen.height; },  
 32012: () => { return window.screenX; },  
 32039: () => { return window.screenY; },  
 32066: () => { return window.devicePixelRatio; },  
 32102: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32155: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32206: () => { Module.canvas.style.cursor = 'none'; },  
 32243: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32499: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
