...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph2dqvf_v.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_point_rendering.data';
      var REMOTE_PACKAGE_BASE = 'models_point_rendering.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_point_rendering.data');

      };
      Module['addRunDependency']('datafile_models_point_rendering.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph2dqvf_v.js
...
function findWasmBinary() {
    return locateFile('models_point_rendering.wasm');
}
...
var ASM_CONSTS = {
  27048: () => { if (document.fullscreenElement) return 1; },  
 27094: () => { return Module.canvas.width; },  
 27126: () => { return parseInt(Module.canvas.style.width); },  
 27174: () => { document.exitFullscreen(); },  
 27201: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27274: () => { if (document.fullscreenElement) return 1; },  
 27320: () => { return Module.canvas.width; },  
 27352: () => { return screen.width; },  
 27377: () => { document.exitFullscreen(); },  
 27404: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27537: () => { return window.innerWidth; },  
 27563: () => { return window.innerHeight; },  
 27590: () => { if (document.fullscreenElement) return 1; },  
 27636: () => { return Module.canvas.width; },  
 27668: () => { return parseInt(Module.canvas.style.width); },  
 27716: () => { if (document.fullscreenElement) return 1; },  
 27762: () => { return Module.canvas.width; },  
 27794: () => { return screen.width; },  
 27819: () => { return window.innerWidth; },  
 27845: () => { return window.innerHeight; },  
 27872: () => { if (document.fullscreenElement) return 1; },  
 27918: () => { return Module.canvas.width; },  
 27950: () => { return screen.width; },  
 27975: () => { document.exitFullscreen(); },  
 28002: () => { if (document.fullscreenElement) return 1; },  
 28048: () => { return Module.canvas.width; },  
 28080: () => { return parseInt(Module.canvas.style.width); },  
 28128: () => { document.exitFullscreen(); },  
 28155: ($0) => { Module.canvas.style.opacity = $0; },  
 28193: () => { return screen.width; },  
 28218: () => { return screen.height; },  
 28244: () => { return window.screenX; },  
 28271: () => { return window.screenY; },  
 28298: () => { return window.devicePixelRatio; },  
 28334: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28387: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28438: () => { Module.canvas.style.cursor = 'none'; },  
 28475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28731: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28782: () => { if (document.fullscreenElement) return 1; },  
 28828: () => { return window.innerWidth; },  
 28854: () => { return window.innerHeight; },  
 28881: () => { if (document.pointerLockElement) return 1; }
};
