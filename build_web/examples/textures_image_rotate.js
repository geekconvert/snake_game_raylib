...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmposcm3gwm.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_rotate.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_rotate.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_rotate.data');

      };
      Module['addRunDependency']('datafile_textures_image_rotate.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmposcm3gwm.js
...
function findWasmBinary() {
    return locateFile('textures_image_rotate.wasm');
}
...
var ASM_CONSTS = {
  30352: () => { if (document.fullscreenElement) return 1; },  
 30398: () => { return Module.canvas.width; },  
 30430: () => { return parseInt(Module.canvas.style.width); },  
 30478: () => { document.exitFullscreen(); },  
 30505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30578: () => { if (document.fullscreenElement) return 1; },  
 30624: () => { return Module.canvas.width; },  
 30656: () => { return screen.width; },  
 30681: () => { document.exitFullscreen(); },  
 30708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30841: () => { return window.innerWidth; },  
 30867: () => { return window.innerHeight; },  
 30894: () => { if (document.fullscreenElement) return 1; },  
 30940: () => { return Module.canvas.width; },  
 30972: () => { return parseInt(Module.canvas.style.width); },  
 31020: () => { if (document.fullscreenElement) return 1; },  
 31066: () => { return Module.canvas.width; },  
 31098: () => { return screen.width; },  
 31123: () => { return window.innerWidth; },  
 31149: () => { return window.innerHeight; },  
 31176: () => { if (document.fullscreenElement) return 1; },  
 31222: () => { return Module.canvas.width; },  
 31254: () => { return screen.width; },  
 31279: () => { document.exitFullscreen(); },  
 31306: () => { if (document.fullscreenElement) return 1; },  
 31352: () => { return Module.canvas.width; },  
 31384: () => { return parseInt(Module.canvas.style.width); },  
 31432: () => { document.exitFullscreen(); },  
 31459: ($0) => { Module.canvas.style.opacity = $0; },  
 31497: () => { return screen.width; },  
 31522: () => { return screen.height; },  
 31548: () => { return window.screenX; },  
 31575: () => { return window.screenY; },  
 31602: () => { return window.devicePixelRatio; },  
 31638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31742: () => { Module.canvas.style.cursor = 'none'; },  
 31779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32035: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32086: () => { if (document.fullscreenElement) return 1; },  
 32132: () => { return window.innerWidth; },  
 32158: () => { return window.innerHeight; },  
 32185: () => { if (document.pointerLockElement) return 1; }
};
