...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpnyr_yvpc.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_basic_window_web.data';
      var REMOTE_PACKAGE_BASE = 'core_basic_window_web.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_basic_window_web.data');

      };
      Module['addRunDependency']('datafile_core_basic_window_web.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpnyr_yvpc.js
...
function findWasmBinary() {
    return locateFile('core_basic_window_web.wasm');
}
...
var ASM_CONSTS = {
  26256: () => { if (document.fullscreenElement) return 1; },  
 26302: () => { return Module.canvas.width; },  
 26334: () => { return parseInt(Module.canvas.style.width); },  
 ...
 26528: () => { return Module.canvas.width; },  
 26560: () => { return screen.width; },  
 26585: () => { document.exitFullscreen(); },  
 26612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26745: () => { return window.innerWidth; },  
 26771: () => { return window.innerHeight; },  
 26798: () => { if (document.fullscreenElement) return 1; },  
 26844: () => { return Module.canvas.width; },  
 26876: () => { return parseInt(Module.canvas.style.width); },  
 26924: () => { if (document.fullscreenElement) return 1; },  
 26970: () => { return Module.canvas.width; },  
 27002: () => { return screen.width; },  
 27027: () => { return window.innerWidth; },  
 27053: () => { return window.innerHeight; },  
 27080: () => { if (document.fullscreenElement) return 1; },  
 27126: () => { return Module.canvas.width; },  
 27158: () => { return screen.width; },  
 27183: () => { document.exitFullscreen(); },  
 27210: () => { if (document.fullscreenElement) return 1; },  
 27256: () => { return Module.canvas.width; },  
 27288: () => { return parseInt(Module.canvas.style.width); },  
 27336: () => { document.exitFullscreen(); },  
 27363: ($0) => { Module.canvas.style.opacity = $0; },  
 27401: () => { return screen.width; },  
 27426: () => { return screen.height; },  
 27452: () => { return window.screenX; },  
 27479: () => { return window.screenY; },  
 27506: () => { return window.devicePixelRatio; },  
 27542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27595: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27646: () => { Module.canvas.style.cursor = 'none'; },  
 27683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 27939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27990: () => { if (document.fullscreenElement) return 1; },  
 28036: () => { return window.innerWidth; },  
 28062: () => { return window.innerHeight; },  
 28089: () => { if (document.pointerLockElement) return 1; }
};
