...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpn6w0jyun.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_vr_simulator.data';
      var REMOTE_PACKAGE_BASE = 'core_vr_simulator.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_vr_simulator.data');

      };
      Module['addRunDependency']('datafile_core_vr_simulator.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpn6w0jyun.js
...
function findWasmBinary() {
    return locateFile('core_vr_simulator.wasm');
}
...
var ASM_CONSTS = {
  27736: () => { if (document.fullscreenElement) return 1; },  
 27782: () => { return Module.canvas.width; },  
 27814: () => { return parseInt(Module.canvas.style.width); },  
 27862: () => { document.exitFullscreen(); },  
 27889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27962: () => { if (document.fullscreenElement) return 1; },  
 28008: () => { return Module.canvas.width; },  
 28040: () => { return screen.width; },  
 28065: () => { document.exitFullscreen(); },  
 28092: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28225: () => { return window.innerWidth; },  
 28251: () => { return window.innerHeight; },  
 28278: () => { if (document.fullscreenElement) return 1; },  
 28324: () => { return Module.canvas.width; },  
 28356: () => { return parseInt(Module.canvas.style.width); },  
 28404: () => { if (document.fullscreenElement) return 1; },  
 28450: () => { return Module.canvas.width; },  
 28482: () => { return screen.width; },  
 28507: () => { return window.innerWidth; },  
 28533: () => { return window.innerHeight; },  
 28560: () => { if (document.fullscreenElement) return 1; },  
 28606: () => { return Module.canvas.width; },  
 28638: () => { return screen.width; },  
 28663: () => { document.exitFullscreen(); },  
 28690: () => { if (document.fullscreenElement) return 1; },  
 28736: () => { return Module.canvas.width; },  
 28768: () => { return parseInt(Module.canvas.style.width); },  
 28816: () => { document.exitFullscreen(); },  
 28843: ($0) => { Module.canvas.style.opacity = $0; },  
 28881: () => { return screen.width; },  
 28906: () => { return screen.height; },  
 28932: () => { return window.screenX; },  
 28959: () => { return window.screenY; },  
 28986: () => { return window.devicePixelRatio; },  
 29022: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 29075: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29126: () => { Module.canvas.style.cursor = 'none'; },  
 29163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29419: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29470: () => { if (document.fullscreenElement) return 1; },  
 29516: () => { return window.innerWidth; },  
 29542: () => { return window.innerHeight; },  
 29569: () => { if (document.pointerLockElement) return 1; }
};
