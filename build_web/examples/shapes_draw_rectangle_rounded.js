...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpuu9zvn2a.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_draw_rectangle_rounded.data';
      var REMOTE_PACKAGE_BASE = 'shapes_draw_rectangle_rounded.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_draw_rectangle_rounded.data');

      };
      Module['addRunDependency']('datafile_shapes_draw_rectangle_rounded.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpuu9zvn2a.js
...
function findWasmBinary() {
    return locateFile('shapes_draw_rectangle_rounded.wasm');
}
...
var ASM_CONSTS = {
  34624: () => { if (document.fullscreenElement) return 1; },  
 34670: () => { return Module.canvas.width; },  
 34702: () => { return parseInt(Module.canvas.style.width); },  
 34750: () => { document.exitFullscreen(); },  
 34777: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34850: () => { if (document.fullscreenElement) return 1; },  
 34896: () => { return Module.canvas.width; },  
 34928: () => { return screen.width; },  
 34953: () => { document.exitFullscreen(); },  
 34980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35113: () => { return window.innerWidth; },  
 35139: () => { return window.innerHeight; },  
 35166: () => { if (document.fullscreenElement) return 1; },  
 35212: () => { return Module.canvas.width; },  
 35244: () => { return parseInt(Module.canvas.style.width); },  
 35292: () => { if (document.fullscreenElement) return 1; },  
 35338: () => { return Module.canvas.width; },  
 35370: () => { return screen.width; },  
 35395: () => { return window.innerWidth; },  
 35421: () => { return window.innerHeight; },  
 35448: () => { if (document.fullscreenElement) return 1; },  
 35494: () => { return Module.canvas.width; },  
 35526: () => { return screen.width; },  
 35551: () => { document.exitFullscreen(); },  
 35578: () => { if (document.fullscreenElement) return 1; },  
 35624: () => { return Module.canvas.width; },  
 35656: () => { return parseInt(Module.canvas.style.width); },  
 35704: () => { document.exitFullscreen(); },  
 35731: ($0) => { Module.canvas.style.opacity = $0; },  
 35769: () => { return screen.width; },  
 35794: () => { return screen.height; },  
 35820: () => { return window.screenX; },  
 35847: () => { return window.screenY; },  
 35874: () => { return window.devicePixelRatio; },  
 35910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 35963: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36014: () => { Module.canvas.style.cursor = 'none'; },  
 36051: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36307: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36358: () => { if (document.fullscreenElement) return 1; },  
 36404: () => { return window.innerWidth; },  
 36430: () => { return window.innerHeight; },  
 36457: () => { if (document.pointerLockElement) return 1; }
};
