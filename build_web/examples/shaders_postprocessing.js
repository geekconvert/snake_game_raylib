...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_3urt03x.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_postprocessing.data';
      var REMOTE_PACKAGE_BASE = 'shaders_postprocessing.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_postprocessing.data');

      };
      Module['addRunDependency']('datafile_shaders_postprocessing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_3urt03x.js
...
function findWasmBinary() {
    return locateFile('shaders_postprocessing.wasm');
}
...
var ASM_CONSTS = {
  41976: () => { if (document.fullscreenElement) return 1; },  
 42022: () => { return Module.canvas.width; },  
 42054: () => { return parseInt(Module.canvas.style.width); },  
 42102: () => { document.exitFullscreen(); },  
 42129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 42202: () => { if (document.fullscreenElement) return 1; },  
 42248: () => { return Module.canvas.width; },  
 42280: () => { return screen.width; },  
 42305: () => { document.exitFullscreen(); },  
 42332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 42465: () => { return window.innerWidth; },  
 42491: () => { return window.innerHeight; },  
 42518: () => { if (document.fullscreenElement) return 1; },  
 42564: () => { return Module.canvas.width; },  
 42596: () => { return parseInt(Module.canvas.style.width); },  
 42644: () => { if (document.fullscreenElement) return 1; },  
 42690: () => { return Module.canvas.width; },  
 42722: () => { return screen.width; },  
 42747: () => { return window.innerWidth; },  
 42773: () => { return window.innerHeight; },  
 42800: () => { if (document.fullscreenElement) return 1; },  
 42846: () => { return Module.canvas.width; },  
 42878: () => { return screen.width; },  
 42903: () => { document.exitFullscreen(); },  
 42930: () => { if (document.fullscreenElement) return 1; },  
 42976: () => { return Module.canvas.width; },  
 43008: () => { return parseInt(Module.canvas.style.width); },  
 43056: () => { document.exitFullscreen(); },  
 43083: ($0) => { Module.canvas.style.opacity = $0; },  
 43121: () => { return screen.width; },  
 43146: () => { return screen.height; },  
 43172: () => { return window.screenX; },  
 43199: () => { return window.screenY; },  
 43226: () => { return window.devicePixelRatio; },  
 43262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 43315: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43366: () => { Module.canvas.style.cursor = 'none'; },  
 43403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 43659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43710: () => { if (document.fullscreenElement) return 1; },  
 43756: () => { return window.innerWidth; },  
 43782: () => { return window.innerHeight; },  
 43809: () => { if (document.pointerLockElement) return 1; }
};
