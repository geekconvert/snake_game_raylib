...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpghoeqm2x.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_eratosthenes.data';
      var REMOTE_PACKAGE_BASE = 'shaders_eratosthenes.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_eratosthenes.data');

      };
      Module['addRunDependency']('datafile_shaders_eratosthenes.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpghoeqm2x.js
...
function findWasmBinary() {
    return locateFile('shaders_eratosthenes.wasm');
}
...
var ASM_CONSTS = {
  27200: () => { if (document.fullscreenElement) return 1; },  
 27246: () => { return Module.canvas.width; },  
 27278: () => { return parseInt(Module.canvas.style.width); },  
 27326: () => { document.exitFullscreen(); },  
 27353: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27426: () => { if (document.fullscreenElement) return 1; },  
 27472: () => { return Module.canvas.width; },  
 27504: () => { return screen.width; },  
 27529: () => { document.exitFullscreen(); },  
 27556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27689: () => { return window.innerWidth; },  
 27715: () => { return window.innerHeight; },  
 27742: () => { if (document.fullscreenElement) return 1; },  
 27788: () => { return Module.canvas.width; },  
 27820: () => { return parseInt(Module.canvas.style.width); },  
 27868: () => { if (document.fullscreenElement) return 1; },  
 27914: () => { return Module.canvas.width; },  
 27946: () => { return screen.width; },  
 27971: () => { return window.innerWidth; },  
 27997: () => { return window.innerHeight; },  
 28024: () => { if (document.fullscreenElement) return 1; },  
 28070: () => { return Module.canvas.width; },  
 28102: () => { return screen.width; },  
 28127: () => { document.exitFullscreen(); },  
 28154: () => { if (document.fullscreenElement) return 1; },  
 28200: () => { return Module.canvas.width; },  
 28232: () => { return parseInt(Module.canvas.style.width); },  
 28280: () => { document.exitFullscreen(); },  
 28307: ($0) => { Module.canvas.style.opacity = $0; },  
 28345: () => { return screen.width; },  
 28370: () => { return screen.height; },  
 28396: () => { return window.screenX; },  
 28423: () => { return window.screenY; },  
 28450: () => { return window.devicePixelRatio; },  
 28486: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28539: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28590: () => { Module.canvas.style.cursor = 'none'; },  
 28627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28883: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28934: () => { if (document.fullscreenElement) return 1; },  
 28980: () => { return window.innerWidth; },  
 29006: () => { return window.innerHeight; },  
 29033: () => { if (document.pointerLockElement) return 1; }
};
