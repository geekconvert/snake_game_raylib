...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp6p0j9_qq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_view_depth.data';
      var REMOTE_PACKAGE_BASE = 'shaders_view_depth.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_view_depth.data');

      };
      Module['addRunDependency']('datafile_shaders_view_depth.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp6p0j9_qq.js
...
function findWasmBinary() {
    return locateFile('shaders_view_depth.wasm');
}
...
var ASM_CONSTS = {
  28360: () => { if (document.fullscreenElement) return 1; },  
 28406: () => { return Module.canvas.width; },  
 28438: () => { return parseInt(Module.canvas.style.width); },  
 28486: () => { document.exitFullscreen(); },  
 28513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 28586: () => { if (document.fullscreenElement) return 1; },  
 28632: () => { return Module.canvas.width; },  
 28664: () => { return screen.width; },  
 28689: () => { document.exitFullscreen(); },  
 28716: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28849: () => { return window.innerWidth; },  
 28875: () => { return window.innerHeight; },  
 28902: () => { if (document.fullscreenElement) return 1; },  
 28948: () => { return Module.canvas.width; },  
 28980: () => { return parseInt(Module.canvas.style.width); },  
 29028: () => { if (document.fullscreenElement) return 1; },  
 29074: () => { return Module.canvas.width; },  
 29106: () => { return screen.width; },  
 29131: () => { return window.innerWidth; },  
 29157: () => { return window.innerHeight; },  
 29184: () => { if (document.fullscreenElement) return 1; },  
 29230: () => { return Module.canvas.width; },  
 29262: () => { return screen.width; },  
 29287: () => { document.exitFullscreen(); },  
 29314: () => { if (document.fullscreenElement) return 1; },  
 29360: () => { return Module.canvas.width; },  
 29392: () => { return parseInt(Module.canvas.style.width); },  
 29440: () => { document.exitFullscreen(); },  
 29467: ($0) => { Module.canvas.style.opacity = $0; },  
 29505: () => { return screen.width; },  
 29530: () => { return screen.height; },  
 29556: () => { return window.screenX; },  
 29583: () => { return window.screenY; },  
 29610: () => { return window.devicePixelRatio; },  
 29646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 29699: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29750: () => { Module.canvas.style.cursor = 'none'; },  
 29787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 30043: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30094: () => { if (document.fullscreenElement) return 1; },  
 30140: () => { return window.innerWidth; },  
 30166: () => { return window.innerHeight; },  
 30193: () => { if (document.pointerLockElement) return 1; }
};
