...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfc765se_.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_texture_tiling.data';
      var REMOTE_PACKAGE_BASE = 'shaders_texture_tiling.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_texture_tiling.data');

      };
      Module['addRunDependency']('datafile_shaders_texture_tiling.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfc765se_.js
...
function findWasmBinary() {
    return locateFile('shaders_texture_tiling.wasm');
}
...
var ASM_CONSTS = {
  31800: () => { if (document.fullscreenElement) return 1; },  
 31846: () => { return Module.canvas.width; },  
 31878: () => { return parseInt(Module.canvas.style.width); },  
 31926: () => { document.exitFullscreen(); },  
 31953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 32026: () => { if (document.fullscreenElement) return 1; },  
 32072: () => { return Module.canvas.width; },  
 32104: () => { return screen.width; },  
 32129: () => { document.exitFullscreen(); },  
 32156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 32289: () => { return window.innerWidth; },  
 32315: () => { return window.innerHeight; },  
 32342: () => { if (document.fullscreenElement) return 1; },  
 32388: () => { return Module.canvas.width; },  
 32420: () => { return parseInt(Module.canvas.style.width); },  
 32468: () => { if (document.fullscreenElement) return 1; },  
 32514: () => { return Module.canvas.width; },  
 32546: () => { return screen.width; },  
 32571: () => { return window.innerWidth; },  
 32597: () => { return window.innerHeight; },  
 32624: () => { if (document.fullscreenElement) return 1; },  
 32670: () => { return Module.canvas.width; },  
 32702: () => { return screen.width; },  
 32727: () => { document.exitFullscreen(); },  
 32754: () => { if (document.fullscreenElement) return 1; },  
 32800: () => { return Module.canvas.width; },  
 32832: () => { return parseInt(Module.canvas.style.width); },  
 32880: () => { document.exitFullscreen(); },  
 32907: ($0) => { Module.canvas.style.opacity = $0; },  
 32945: () => { return screen.width; },  
 32970: () => { return screen.height; },  
 32996: () => { return window.screenX; },  
 33023: () => { return window.screenY; },  
 33050: () => { return window.devicePixelRatio; },  
 33086: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 33139: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 33190: () => { Module.canvas.style.cursor = 'none'; },  
 33227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 33483: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 33534: () => { if (document.fullscreenElement) return 1; },  
 33580: () => { return window.innerWidth; },  
 33606: () => { return window.innerHeight; },  
 33633: () => { if (document.pointerLockElement) return 1; }
};
