...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp1pn79khz.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_billboard.data';
      var REMOTE_PACKAGE_BASE = 'models_billboard.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_billboard.data');

      };
      Module['addRunDependency']('datafile_models_billboard.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp1pn79khz.js
...
function findWasmBinary() {
    return locateFile('models_billboard.wasm');
}
...
var ASM_CONSTS = {
  30456: () => { if (document.fullscreenElement) return 1; },  
 30502: () => { return Module.canvas.width; },  
 30534: () => { return parseInt(Module.canvas.style.width); },  
 30582: () => { document.exitFullscreen(); },  
 30609: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30682: () => { if (document.fullscreenElement) return 1; },  
 30728: () => { return Module.canvas.width; },  
 30760: () => { return screen.width; },  
 30785: () => { document.exitFullscreen(); },  
 30812: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30945: () => { return window.innerWidth; },  
 30971: () => { return window.innerHeight; },  
 30998: () => { if (document.fullscreenElement) return 1; },  
 31044: () => { return Module.canvas.width; },  
 31076: () => { return parseInt(Module.canvas.style.width); },  
 31124: () => { if (document.fullscreenElement) return 1; },  
 31170: () => { return Module.canvas.width; },  
 31202: () => { return screen.width; },  
 31227: () => { return window.innerWidth; },  
 31253: () => { return window.innerHeight; },  
 31280: () => { if (document.fullscreenElement) return 1; },  
 31326: () => { return Module.canvas.width; },  
 31358: () => { return screen.width; },  
 31383: () => { document.exitFullscreen(); },  
 31410: () => { if (document.fullscreenElement) return 1; },  
 31456: () => { return Module.canvas.width; },  
 31488: () => { return parseInt(Module.canvas.style.width); },  
 31536: () => { document.exitFullscreen(); },  
 31563: ($0) => { Module.canvas.style.opacity = $0; },  
 31601: () => { return screen.width; },  
 31626: () => { return screen.height; },  
 31652: () => { return window.screenX; },  
 31679: () => { return window.screenY; },  
 31706: () => { return window.devicePixelRatio; },  
 31742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31795: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31846: () => { Module.canvas.style.cursor = 'none'; },  
 31883: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32139: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32190: () => { if (document.fullscreenElement) return 1; },  
 32236: () => { return window.innerWidth; },  
 32262: () => { return window.innerHeight; },  
 32289: () => { if (document.pointerLockElement) return 1; }
};
