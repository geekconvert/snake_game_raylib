...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl_ejlqf2.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_tesseract_view.data';
      var REMOTE_PACKAGE_BASE = 'models_tesseract_view.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_tesseract_view.data');

      };
      Module['addRunDependency']('datafile_models_tesseract_view.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl_ejlqf2.js
...
function findWasmBinary() {
    return locateFile('models_tesseract_view.wasm');
}
...
var ASM_CONSTS = {
  26760: () => { if (document.fullscreenElement) return 1; },  
 26806: () => { return Module.canvas.width; },  
 26838: () => { return parseInt(Module.canvas.style.width); },  
 26886: () => { document.exitFullscreen(); },  
 26913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26986: () => { if (document.fullscreenElement) return 1; },  
 27032: () => { return Module.canvas.width; },  
 27064: () => { return screen.width; },  
 27089: () => { document.exitFullscreen(); },  
 27116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27249: () => { return window.innerWidth; },  
 27275: () => { return window.innerHeight; },  
 27302: () => { if (document.fullscreenElement) return 1; },  
 27348: () => { return Module.canvas.width; },  
 27380: () => { return parseInt(Module.canvas.style.width); },  
 27428: () => { if (document.fullscreenElement) return 1; },  
 27474: () => { return Module.canvas.width; },  
 27506: () => { return screen.width; },  
 27531: () => { return window.innerWidth; },  
 27557: () => { return window.innerHeight; },  
 27584: () => { if (document.fullscreenElement) return 1; },  
 27630: () => { return Module.canvas.width; },  
 27662: () => { return screen.width; },  
 27687: () => { document.exitFullscreen(); },  
 27714: () => { if (document.fullscreenElement) return 1; },  
 27760: () => { return Module.canvas.width; },  
 27792: () => { return parseInt(Module.canvas.style.width); },  
 27840: () => { document.exitFullscreen(); },  
 27867: ($0) => { Module.canvas.style.opacity = $0; },  
 27905: () => { return screen.width; },  
 27930: () => { return screen.height; },  
 27956: () => { return window.screenX; },  
 27983: () => { return window.screenY; },  
 28010: () => { return window.devicePixelRatio; },  
 28046: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28099: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28150: () => { Module.canvas.style.cursor = 'none'; },  
 28187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28443: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28494: () => { if (document.fullscreenElement) return 1; },  
 28540: () => { return window.innerWidth; },  
 28566: () => { return window.innerHeight; },  
 28593: () => { if (document.pointerLockElement) return 1; }
};
