...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp9bdqdkhc.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_splines_drawing.data';
      var REMOTE_PACKAGE_BASE = 'shapes_splines_drawing.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_splines_drawing.data');

      };
      Module['addRunDependency']('datafile_shapes_splines_drawing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp9bdqdkhc.js
...
function findWasmBinary() {
    return locateFile('shapes_splines_drawing.wasm');
}
...
var ASM_CONSTS = {
  34960: () => { if (document.fullscreenElement) return 1; },  
 35006: () => { return Module.canvas.width; },  
 35038: () => { return parseInt(Module.canvas.style.width); },  
 35086: () => { document.exitFullscreen(); },  
 35113: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 35186: () => { if (document.fullscreenElement) return 1; },  
 35232: () => { return Module.canvas.width; },  
 35264: () => { return screen.width; },  
 35289: () => { document.exitFullscreen(); },  
 35316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35449: () => { return window.innerWidth; },  
 35475: () => { return window.innerHeight; },  
 35502: () => { if (document.fullscreenElement) return 1; },  
 35548: () => { return Module.canvas.width; },  
 35580: () => { return parseInt(Module.canvas.style.width); },  
 35628: () => { if (document.fullscreenElement) return 1; },  
 35674: () => { return Module.canvas.width; },  
 35706: () => { return screen.width; },  
 35731: () => { return window.innerWidth; },  
 35757: () => { return window.innerHeight; },  
 35784: () => { if (document.fullscreenElement) return 1; },  
 35830: () => { return Module.canvas.width; },  
 35862: () => { return screen.width; },  
 35887: () => { document.exitFullscreen(); },  
 35914: () => { if (document.fullscreenElement) return 1; },  
 35960: () => { return Module.canvas.width; },  
 35992: () => { return parseInt(Module.canvas.style.width); },  
 36040: () => { document.exitFullscreen(); },  
 36067: ($0) => { Module.canvas.style.opacity = $0; },  
 36105: () => { return screen.width; },  
 36130: () => { return screen.height; },  
 36156: () => { return window.screenX; },  
 36183: () => { return window.screenY; },  
 36210: () => { return window.devicePixelRatio; },  
 36246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 36299: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36350: () => { Module.canvas.style.cursor = 'none'; },  
 36387: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36643: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36694: () => { if (document.fullscreenElement) return 1; },  
 36740: () => { return window.innerWidth; },  
 36766: () => { return window.innerHeight; },  
 36793: () => { if (document.pointerLockElement) return 1; }
};
