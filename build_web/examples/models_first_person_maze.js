...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmptukg78a2.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_first_person_maze.data';
      var REMOTE_PACKAGE_BASE = 'models_first_person_maze.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_first_person_maze.data');

      };
      Module['addRunDependency']('datafile_models_first_person_maze.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmptukg78a2.js
...
function findWasmBinary() {
    return locateFile('models_first_person_maze.wasm');
}
...
var ASM_CONSTS = {
  31080: () => { if (document.fullscreenElement) return 1; },  
 31126: () => { return Module.canvas.width; },  
 31158: () => { return parseInt(Module.canvas.style.width); },  
 31206: () => { document.exitFullscreen(); },  
 31233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31306: () => { if (document.fullscreenElement) return 1; },  
 31352: () => { return Module.canvas.width; },  
 31384: () => { return screen.width; },  
 31409: () => { document.exitFullscreen(); },  
 31436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31569: () => { return window.innerWidth; },  
 31595: () => { return window.innerHeight; },  
 31622: () => { if (document.fullscreenElement) return 1; },  
 31668: () => { return Module.canvas.width; },  
 31700: () => { return parseInt(Module.canvas.style.width); },  
 31748: () => { if (document.fullscreenElement) return 1; },  
 31794: () => { return Module.canvas.width; },  
 31826: () => { return screen.width; },  
 31851: () => { return window.innerWidth; },  
 31877: () => { return window.innerHeight; },  
 31904: () => { if (document.fullscreenElement) return 1; },  
 31950: () => { return Module.canvas.width; },  
 31982: () => { return screen.width; },  
 32007: () => { document.exitFullscreen(); },  
 32034: () => { if (document.fullscreenElement) return 1; },  
 32080: () => { return Module.canvas.width; },  
 32112: () => { return parseInt(Module.canvas.style.width); },  
 32160: () => { document.exitFullscreen(); },  
 32187: ($0) => { Module.canvas.style.opacity = $0; },  
 32225: () => { return screen.width; },  
 32250: () => { return screen.height; },  
 32276: () => { return window.screenX; },  
 32303: () => { return window.screenY; },  
 32330: () => { return window.devicePixelRatio; },  
 32366: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32419: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32470: () => { Module.canvas.style.cursor = 'none'; },  
 32507: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32763: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32814: () => { if (document.fullscreenElement) return 1; },  
 32860: () => { return window.innerWidth; },  
 32886: () => { return window.innerHeight; },  
 32913: () => { if (document.pointerLockElement) return 1; }
};
