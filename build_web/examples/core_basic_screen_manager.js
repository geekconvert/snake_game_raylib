...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjpd3uake.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_basic_screen_manager.data';
      var REMOTE_PACKAGE_BASE = 'core_basic_screen_manager.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_basic_screen_manager.data');

      };
      Module['addRunDependency']('datafile_core_basic_screen_manager.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjpd3uake.js
...
function findWasmBinary() {
    return locateFile('core_basic_screen_manager.wasm');
}
...
var ASM_CONSTS = {
  26432: () => { if (document.fullscreenElement) return 1; },  
 26478: () => { return Module.canvas.width; },  
 26510: () => { return parseInt(Module.canvas.style.width); },  
 26558: () => { document.exitFullscreen(); },  
 26585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26658: () => { if (document.fullscreenElement) return 1; },  
 26704: () => { return Module.canvas.width; },  
 26736: () => { return screen.width; },  
 26761: () => { document.exitFullscreen(); },  
 26788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26921: () => { return window.innerWidth; },  
 26947: () => { return window.innerHeight; },  
 26974: () => { if (document.fullscreenElement) return 1; },  
 27020: () => { return Module.canvas.width; },  
 27052: () => { return parseInt(Module.canvas.style.width); },  
 27100: () => { if (document.fullscreenElement) return 1; },  
 27146: () => { return Module.canvas.width; },  
 27178: () => { return screen.width; },  
 27203: () => { return window.innerWidth; },  
 27229: () => { return window.innerHeight; },  
 27256: () => { if (document.fullscreenElement) return 1; },  
 27302: () => { return Module.canvas.width; },  
 27334: () => { return screen.width; },  
 27359: () => { document.exitFullscreen(); },  
 27386: () => { if (document.fullscreenElement) return 1; },  
 27432: () => { return Module.canvas.width; },  
 27464: () => { return parseInt(Module.canvas.style.width); },  
 27512: () => { document.exitFullscreen(); },  
 27539: ($0) => { Module.canvas.style.opacity = $0; },  
 27577: () => { return screen.width; },  
 27602: () => { return screen.height; },  
 27628: () => { return window.screenX; },  
 27655: () => { return window.screenY; },  
 27682: () => { return window.devicePixelRatio; },  
 27718: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27771: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27822: () => { Module.canvas.style.cursor = 'none'; },  
 27859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28115: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28166: () => { if (document.fullscreenElement) return 1; },  
 28212: () => { return window.innerWidth; },  
 28238: () => { return window.innerHeight; },  
 28265: () => { if (document.pointerLockElement) return 1; }
};
