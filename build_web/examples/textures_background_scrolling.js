...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpi7iqitl6.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_background_scrolling.data';
      var REMOTE_PACKAGE_BASE = 'textures_background_scrolling.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_background_scrolling.data');

      };
      Module['addRunDependency']('datafile_textures_background_scrolling.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpi7iqitl6.js
...
function findWasmBinary() {
    return locateFile('textures_background_scrolling.wasm');
}
...
var ASM_CONSTS = {
  30384: () => { if (document.fullscreenElement) return 1; },  
 30430: () => { return Module.canvas.width; },  
 30462: () => { return parseInt(Module.canvas.style.width); },  
 30510: () => { document.exitFullscreen(); },  
 30537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30610: () => { if (document.fullscreenElement) return 1; },  
 30656: () => { return Module.canvas.width; },  
 30688: () => { return screen.width; },  
 30713: () => { document.exitFullscreen(); },  
 30740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30873: () => { return window.innerWidth; },  
 30899: () => { return window.innerHeight; },  
 30926: () => { if (document.fullscreenElement) return 1; },  
 30972: () => { return Module.canvas.width; },  
 31004: () => { return parseInt(Module.canvas.style.width); },  
 31052: () => { if (document.fullscreenElement) return 1; },  
 31098: () => { return Module.canvas.width; },  
 31130: () => { return screen.width; },  
 31155: () => { return window.innerWidth; },  
 31181: () => { return window.innerHeight; },  
 31208: () => { if (document.fullscreenElement) return 1; },  
 31254: () => { return Module.canvas.width; },  
 31286: () => { return screen.width; },  
 31311: () => { document.exitFullscreen(); },  
 31338: () => { if (document.fullscreenElement) return 1; },  
 31384: () => { return Module.canvas.width; },  
 31416: () => { return parseInt(Module.canvas.style.width); },  
 31464: () => { document.exitFullscreen(); },  
 31491: ($0) => { Module.canvas.style.opacity = $0; },  
 31529: () => { return screen.width; },  
 31554: () => { return screen.height; },  
 31580: () => { return window.screenX; },  
 31607: () => { return window.screenY; },  
 31634: () => { return window.devicePixelRatio; },  
 31670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31723: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31774: () => { Module.canvas.style.cursor = 'none'; },  
 31811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32067: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32118: () => { if (document.fullscreenElement) return 1; },  
 32164: () => { return window.innerWidth; },  
 32190: () => { return window.innerHeight; },  
 32217: () => { if (document.pointerLockElement) return 1; }
};
