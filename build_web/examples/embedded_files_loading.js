...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsh0en7un.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'embedded_files_loading.data';
      var REMOTE_PACKAGE_BASE = 'embedded_files_loading.data';
...
Module['FS_createPath']("/resources/shaders", "glsl430", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_embedded_files_loading.data');

      };
      Module['addRunDependency']('datafile_embedded_files_loading.data');
    ...
    loadPackage({"files": [{"filename": "/resources/audio_data.h", "start": 0, "end": 580970}, {"filename": "/resources/image_data.h", "start": 580970, "end": 1709772}, {"filename": "/resources/shaders/glsl100/point_particle.fs", "start": 1709772, "end": 1710296}, {"filename": "/resources/shaders/glsl100/point_particle.vs", "start": 1710296, "end": 1710944}, {"filename": "/resources/shaders/glsl330/point_particle.fs", "start": 1710944, "end": 1711483}, {"filename": "/resources/shaders/glsl330/point_particle.vs", "start": 1711483, "end": 1712107}, {"filename": "/resources/shaders/glsl430/gol.glsl", "start": 1712107, "end": 1713533}, {"filename": "/resources/shaders/glsl430/gol_render.glsl", "start": 1713533, "end": 1714149}, {"filename": "/resources/shaders/glsl430/gol_transfert.glsl", "start": 1714149, "end": 1715544}], "remote_package_size": 1715544});

  })();

// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsh0en7un.js
...
function findWasmBinary() {
    return locateFile('embedded_files_loading.wasm');
}
...
var ASM_CONSTS = {
 ...
 336873: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 336939: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 337332: ($0) => { miniaudio.untrack_device_by_index($0); },  
 337375: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 337500: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 337626: () => { if (document.fullscreenElement) return 1; },  
 337672: () => { return Module.canvas.width; },  
 337704: () => { return parseInt(Module.canvas.style.width); },  
 337752: () => { document.exitFullscreen(); },  
 337779: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 337852: () => { if (document.fullscreenElement) return 1; },  
 337898: () => { return Module.canvas.width; },  
 337930: () => { return screen.width; },  
 337955: () => { document.exitFullscreen(); },  
 337982: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 338115: () => { return window.innerWidth; },  
 338141: () => { return window.innerHeight; },  
 338168: () => { if (document.fullscreenElement) return 1; },  
 338214: () => { return Module.canvas.width; },  
 338246: () => { return parseInt(Module.canvas.style.width); },  
 338294: () => { if (document.fullscreenElement) return 1; },  
 338340: () => { return Module.canvas.width; },  
 338372: () => { return screen.width; },  
 338397: () => { return window.innerWidth; },  
 338423: () => { return window.innerHeight; },  
 338450: () => { if (document.fullscreenElement) return 1; },  
 338496: () => { return Module.canvas.width; },  
 338528: () => { return screen.width; },  
 338553: () => { document.exitFullscreen(); },  
 338580: () => { if (document.fullscreenElement) return 1; },  
 338626: () => { return Module.canvas.width; },  
 338658: () => { return parseInt(Module.canvas.style.width); },  
 338706: () => { document.exitFullscreen(); },  
 338733: ($0) => { Module.canvas.style.opacity = $0; },  
 338771: () => { return screen.width; },  
 338796: () => { return screen.height; },  
 338822: () => { return window.screenX; },  
 338849: () => { return window.screenY; },  
 338876: () => { return window.devicePixelRatio; },  
 338912: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 338965: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 339016: () => { Module.canvas.style.cursor = 'none'; },  
 339053: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 339309: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 339360: () => { if (document.fullscreenElement) return 1; },  
 339406: () => { return window.innerWidth; },  
 339432: () => { return window.innerHeight; },  
 339459: () => { if (document.pointerLockElement) return 1; }
};
