...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpetkvceh2.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_3d_camera_first_person.data';
      var REMOTE_PACKAGE_BASE = 'core_3d_camera_first_person.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_3d_camera_first_person.data');

      };
      Module['addRunDependency']('datafile_core_3d_camera_first_person.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpetkvceh2.js
...
function findWasmBinary() {
    return locateFile('core_3d_camera_first_person.wasm');
}
...
var ASM_CONSTS = {
  26920: () => { if (document.fullscreenElement) return 1; },  
 26966: () => { return Module.canvas.width; },  
 26998: () => { return parseInt(Module.canvas.style.width); },  
 27046: () => { document.exitFullscreen(); },  
 27073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27146: () => { if (document.fullscreenElement) return 1; },  
 27192: () => { return Module.canvas.width; },  
 27224: () => { return screen.width; },  
 27249: () => { document.exitFullscreen(); },  
 27276: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27409: () => { return window.innerWidth; },  
 27435: () => { return window.innerHeight; },  
 27462: () => { if (document.fullscreenElement) return 1; },  
 27508: () => { return Module.canvas.width; },  
 27540: () => { return parseInt(Module.canvas.style.width); },  
 27588: () => { if (document.fullscreenElement) return 1; },  
 27634: () => { return Module.canvas.width; },  
 27666: () => { return screen.width; },  
 27691: () => { return window.innerWidth; },  
 27717: () => { return window.innerHeight; },  
 27744: () => { if (document.fullscreenElement) return 1; },  
 27790: () => { return Module.canvas.width; },  
 27822: () => { return screen.width; },  
 27847: () => { document.exitFullscreen(); },  
 27874: () => { if (document.fullscreenElement) return 1; },  
 27920: () => { return Module.canvas.width; },  
 27952: () => { return parseInt(Module.canvas.style.width); },  
 28000: () => { document.exitFullscreen(); },  
 28027: ($0) => { Module.canvas.style.opacity = $0; },  
 28065: () => { return screen.width; },  
 28090: () => { return screen.height; },  
 28116: () => { return window.screenX; },  
 28143: () => { return window.screenY; },  
 28170: () => { return window.devicePixelRatio; },  
 28206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28259: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28310: () => { Module.canvas.style.cursor = 'none'; },  
 28347: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28603: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28654: () => { if (document.fullscreenElement) return 1; },  
 28700: () => { return window.innerWidth; },  
 28726: () => { return window.innerHeight; },  
 28753: () => { if (document.pointerLockElement) return 1; }
};
