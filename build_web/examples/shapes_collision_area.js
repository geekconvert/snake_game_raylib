...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjp9tt5_d.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_collision_area.data';
      var REMOTE_PACKAGE_BASE = 'shapes_collision_area.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_collision_area.data');

      };
      Module['addRunDependency']('datafile_shapes_collision_area.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjp9tt5_d.js
...
function findWasmBinary() {
    return locateFile('shapes_collision_area.wasm');
}
...
var ASM_CONSTS = {
  26336: () => { if (document.fullscreenElement) return 1; },  
 26382: () => { return Module.canvas.width; },  
 26414: () => { return parseInt(Module.canvas.style.width); },  
 26462: () => { document.exitFullscreen(); },  
 26489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26562: () => { if (document.fullscreenElement) return 1; },  
 26608: () => { return Module.canvas.width; },  
 26640: () => { return screen.width; },  
 26665: () => { document.exitFullscreen(); },  
 26692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26825: () => { return window.innerWidth; },  
 26851: () => { return window.innerHeight; },  
 26878: () => { if (document.fullscreenElement) return 1; },  
 26924: () => { return Module.canvas.width; },  
 26956: () => { return parseInt(Module.canvas.style.width); },  
 27004: () => { if (document.fullscreenElement) return 1; },  
 27050: () => { return Module.canvas.width; },  
 27082: () => { return screen.width; },  
 27107: () => { return window.innerWidth; },  
 27133: () => { return window.innerHeight; },  
 27160: () => { if (document.fullscreenElement) return 1; },  
 27206: () => { return Module.canvas.width; },  
 27238: () => { return screen.width; },  
 27263: () => { document.exitFullscreen(); },  
 27290: () => { if (document.fullscreenElement) return 1; },  
 27336: () => { return Module.canvas.width; },  
 27368: () => { return parseInt(Module.canvas.style.width); },  
 27416: () => { document.exitFullscreen(); },  
 27443: ($0) => { Module.canvas.style.opacity = $0; },  
 27481: () => { return screen.width; },  
 27506: () => { return screen.height; },  
 27532: () => { return window.screenX; },  
 27559: () => { return window.screenY; },  
 27586: () => { return window.devicePixelRatio; },  
 27622: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27675: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27726: () => { Module.canvas.style.cursor = 'none'; },  
 27763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28019: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28070: () => { if (document.fullscreenElement) return 1; },  
 28116: () => { return window.innerWidth; },  
 28142: () => { return window.innerHeight; },  
 28169: () => { if (document.pointerLockElement) return 1; }
};
