...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmps20jz5k_.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_rounded_rectangle.data';
      var REMOTE_PACKAGE_BASE = 'shaders_rounded_rectangle.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_rounded_rectangle.data');

      };
      Module['addRunDependency']('datafile_shaders_rounded_rectangle.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmps20jz5k_.js
...
function findWasmBinary() {
    return locateFile('shaders_rounded_rectangle.wasm');
}
...
var ASM_CONSTS = {
  27104: () => { if (document.fullscreenElement) return 1; },  
 27150: () => { return Module.canvas.width; },  
 27182: () => { return parseInt(Module.canvas.style.width); },  
 27230: () => { document.exitFullscreen(); },  
 27257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27330: () => { if (document.fullscreenElement) return 1; },  
 27376: () => { return Module.canvas.width; },  
 27408: () => { return screen.width; },  
 27433: () => { document.exitFullscreen(); },  
 27460: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27593: () => { return window.innerWidth; },  
 27619: () => { return window.innerHeight; },  
 27646: () => { if (document.fullscreenElement) return 1; },  
 27692: () => { return Module.canvas.width; },  
 27724: () => { return parseInt(Module.canvas.style.width); },  
 27772: () => { if (document.fullscreenElement) return 1; },  
 27818: () => { return Module.canvas.width; },  
 27850: () => { return screen.width; },  
 27875: () => { return window.innerWidth; },  
 27901: () => { return window.innerHeight; },  
 27928: () => { if (document.fullscreenElement) return 1; },  
 27974: () => { return Module.canvas.width; },  
 28006: () => { return screen.width; },  
 28031: () => { document.exitFullscreen(); },  
 28058: () => { if (document.fullscreenElement) return 1; },  
 28104: () => { return Module.canvas.width; },  
 28136: () => { return parseInt(Module.canvas.style.width); },  
 28184: () => { document.exitFullscreen(); },  
 28211: ($0) => { Module.canvas.style.opacity = $0; },  
 28249: () => { return screen.width; },  
 28274: () => { return screen.height; },  
 28300: () => { return window.screenX; },  
 28327: () => { return window.screenY; },  
 28354: () => { return window.devicePixelRatio; },  
 28390: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28443: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28494: () => { Module.canvas.style.cursor = 'none'; },  
 28531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28787: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28838: () => { if (document.fullscreenElement) return 1; },  
 28884: () => { return window.innerWidth; },  
 28910: () => { return window.innerHeight; },  
 28937: () => { if (document.pointerLockElement) return 1; }
};
