...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpj1teqpgb.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_input_mouse.data';
      var REMOTE_PACKAGE_BASE = 'core_input_mouse.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_input_mouse.data');

      };
      Module['addRunDependency']('datafile_core_input_mouse.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpj1teqpgb.js
...
function findWasmBinary() {
    return locateFile('core_input_mouse.wasm');
}
...
var ASM_CONSTS = {
  26512: () => { if (document.fullscreenElement) return 1; },  
 26558: () => { return Module.canvas.width; },  
 26590: () => { return parseInt(Module.canvas.style.width); },  
 26638: () => { document.exitFullscreen(); },  
 26665: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26738: () => { if (document.fullscreenElement) return 1; },  
 26784: () => { return Module.canvas.width; },  
 26816: () => { return screen.width; },  
 26841: () => { document.exitFullscreen(); },  
 26868: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27001: () => { return window.innerWidth; },  
 27027: () => { return window.innerHeight; },  
 27054: () => { if (document.fullscreenElement) return 1; },  
 27100: () => { return Module.canvas.width; },  
 27132: () => { return parseInt(Module.canvas.style.width); },  
 27180: () => { if (document.fullscreenElement) return 1; },  
 27226: () => { return Module.canvas.width; },  
 27258: () => { return screen.width; },  
 27283: () => { return window.innerWidth; },  
 27309: () => { return window.innerHeight; },  
 27336: () => { if (document.fullscreenElement) return 1; },  
 27382: () => { return Module.canvas.width; },  
 27414: () => { return screen.width; },  
 27439: () => { document.exitFullscreen(); },  
 27466: () => { if (document.fullscreenElement) return 1; },  
 27512: () => { return Module.canvas.width; },  
 27544: () => { return parseInt(Module.canvas.style.width); },  
 27592: () => { document.exitFullscreen(); },  
 27619: ($0) => { Module.canvas.style.opacity = $0; },  
 27657: () => { return screen.width; },  
 27682: () => { return screen.height; },  
 27708: () => { return window.screenX; },  
 27735: () => { return window.screenY; },  
 27762: () => { return window.devicePixelRatio; },  
 27798: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27851: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27902: () => { Module.canvas.style.cursor = 'none'; },  
 27939: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28195: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28246: () => { if (document.fullscreenElement) return 1; },  
 28292: () => { return window.innerWidth; },  
 28318: () => { return window.innerHeight; },  
 28345: () => { if (document.pointerLockElement) return 1; }
};
