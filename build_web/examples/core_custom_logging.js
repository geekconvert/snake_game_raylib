...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_sxnswiv.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_custom_logging.data';
      var REMOTE_PACKAGE_BASE = 'core_custom_logging.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_custom_logging.data');

      };
      Module['addRunDependency']('datafile_core_custom_logging.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_sxnswiv.js
...
function findWasmBinary() {
    return locateFile('core_custom_logging.wasm');
}
...
var ASM_CONSTS = {
  26896: () => { if (document.fullscreenElement) return 1; },  
 26942: () => { return Module.canvas.width; },  
 26974: () => { return parseInt(Module.canvas.style.width); },  
 27022: () => { document.exitFullscreen(); },  
 27049: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27122: () => { if (document.fullscreenElement) return 1; },  
 27168: () => { return Module.canvas.width; },  
 27200: () => { return screen.width; },  
 27225: () => { document.exitFullscreen(); },  
 27252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27385: () => { return window.innerWidth; },  
 27411: () => { return window.innerHeight; },  
 27438: () => { if (document.fullscreenElement) return 1; },  
 27484: () => { return Module.canvas.width; },  
 27516: () => { return parseInt(Module.canvas.style.width); },  
 27564: () => { if (document.fullscreenElement) return 1; },  
 27610: () => { return Module.canvas.width; },  
 27642: () => { return screen.width; },  
 27667: () => { return window.innerWidth; },  
 27693: () => { return window.innerHeight; },  
 27720: () => { if (document.fullscreenElement) return 1; },  
 27766: () => { return Module.canvas.width; },  
 27798: () => { return screen.width; },  
 27823: () => { document.exitFullscreen(); },  
 27850: () => { if (document.fullscreenElement) return 1; },  
 27896: () => { return Module.canvas.width; },  
 27928: () => { return parseInt(Module.canvas.style.width); },  
 27976: () => { document.exitFullscreen(); },  
 28003: ($0) => { Module.canvas.style.opacity = $0; },  
 28041: () => { return screen.width; },  
 28066: () => { return screen.height; },  
 28092: () => { return window.screenX; },  
 28119: () => { return window.screenY; },  
 28146: () => { return window.devicePixelRatio; },  
 28182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28235: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28286: () => { Module.canvas.style.cursor = 'none'; },  
 28323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28579: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28630: () => { if (document.fullscreenElement) return 1; },  
 28676: () => { return window.innerWidth; },  
 28702: () => { return window.innerHeight; },  
 28729: () => { if (document.pointerLockElement) return 1; }
};
