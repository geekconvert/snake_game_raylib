...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdhsxbt2p.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_window_letterbox.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_window_letterbox.data');

      };
      Module['addRunDependency']('datafile_core_window_letterbox.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdhsxbt2p.js
...
function findWasmBinary() {
    return locateFile('core_window_letterbox.wasm');
}
...
var ASM_CONSTS = {
  27184: () => { if (document.fullscreenElement) return 1; },  
 27230: () => { return Module.canvas.width; },  
 27262: () => { return parseInt(Module.canvas.style.width); },  
 27310: () => { document.exitFullscreen(); },  
 27337: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27410: () => { if (document.fullscreenElement) return 1; },  
 27456: () => { return Module.canvas.width; },  
 27488: () => { return screen.width; },  
 27513: () => { document.exitFullscreen(); },  
 27540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27673: () => { return window.innerWidth; },  
 27699: () => { return window.innerHeight; },  
 27726: () => { if (document.fullscreenElement) return 1; },  
 27772: () => { return Module.canvas.width; },  
 27804: () => { return parseInt(Module.canvas.style.width); },  
 27852: () => { if (document.fullscreenElement) return 1; },  
 27898: () => { return Module.canvas.width; },  
 27930: () => { return screen.width; },  
 27955: () => { return window.innerWidth; },  
 27981: () => { return window.innerHeight; },  
 28008: () => { if (document.fullscreenElement) return 1; },  
 28054: () => { return Module.canvas.width; },  
 28086: () => { return screen.width; },  
 28111: () => { document.exitFullscreen(); },  
 28138: () => { if (document.fullscreenElement) return 1; },  
 28184: () => { return Module.canvas.width; },  
 28216: () => { return parseInt(Module.canvas.style.width); },  
 28264: () => { document.exitFullscreen(); },  
 28291: ($0) => { Module.canvas.style.opacity = $0; },  
 28329: () => { return screen.width; },  
 28354: () => { return screen.height; },  
 28380: () => { return window.screenX; },  
 28407: () => { return window.screenY; },  
 28434: () => { return window.devicePixelRatio; },  
 28470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28523: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28574: () => { Module.canvas.style.cursor = 'none'; },  
 28611: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28867: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28918: () => { if (document.fullscreenElement) return 1; },  
 28964: () => { return window.innerWidth; },  
 28990: () => { return window.innerHeight; },  
 29017: () => { if (document.pointerLockElement) return 1; }
};
