...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpakehyrsw.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_raymarching.data';
      var REMOTE_PACKAGE_BASE = 'shaders_raymarching.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_raymarching.data');

      };
      Module['addRunDependency']('datafile_shaders_raymarching.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpakehyrsw.js
...
function findWasmBinary() {
    return locateFile('shaders_raymarching.wasm');
}
...
var ASM_CONSTS = {
  27008: () => { if (document.fullscreenElement) return 1; },  
 27054: () => { return Module.canvas.width; },  
 27086: () => { return parseInt(Module.canvas.style.width); },  
 27134: () => { document.exitFullscreen(); },  
 27161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27234: () => { if (document.fullscreenElement) return 1; },  
 27280: () => { return Module.canvas.width; },  
 27312: () => { return screen.width; },  
 27337: () => { document.exitFullscreen(); },  
 27364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27497: () => { return window.innerWidth; },  
 27523: () => { return window.innerHeight; },  
 27550: () => { if (document.fullscreenElement) return 1; },  
 27596: () => { return Module.canvas.width; },  
 27628: () => { return parseInt(Module.canvas.style.width); },  
 27676: () => { if (document.fullscreenElement) return 1; },  
 27722: () => { return Module.canvas.width; },  
 27754: () => { return screen.width; },  
 27779: () => { return window.innerWidth; },  
 27805: () => { return window.innerHeight; },  
 27832: () => { if (document.fullscreenElement) return 1; },  
 27878: () => { return Module.canvas.width; },  
 27910: () => { return screen.width; },  
 27935: () => { document.exitFullscreen(); },  
 27962: () => { if (document.fullscreenElement) return 1; },  
 28008: () => { return Module.canvas.width; },  
 28040: () => { return parseInt(Module.canvas.style.width); },  
 28088: () => { document.exitFullscreen(); },  
 28115: ($0) => { Module.canvas.style.opacity = $0; },  
 28153: () => { return screen.width; },  
 28178: () => { return screen.height; },  
 28204: () => { return window.screenX; },  
 28231: () => { return window.screenY; },  
 28258: () => { return window.devicePixelRatio; },  
 28294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28347: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28398: () => { Module.canvas.style.cursor = 'none'; },  
 28435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28742: () => { if (document.fullscreenElement) return 1; },  
 28788: () => { return window.innerWidth; },  
 28814: () => { return window.innerHeight; },  
 28841: () => { if (document.pointerLockElement) return 1; }
};
