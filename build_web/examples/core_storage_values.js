...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdo4x9sx0.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_storage_values.data';
      var REMOTE_PACKAGE_BASE = 'core_storage_values.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_storage_values.data');

      };
      Module['addRunDependency']('datafile_core_storage_values.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdo4x9sx0.js
...
function findWasmBinary() {
    return locateFile('core_storage_values.wasm');
}
...
var ASM_CONSTS = {
  26928: () => { if (document.fullscreenElement) return 1; },  
 26974: () => { return Module.canvas.width; },  
 27006: () => { return parseInt(Module.canvas.style.width); },  
 27054: () => { document.exitFullscreen(); },  
 27081: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27154: () => { if (document.fullscreenElement) return 1; },  
 27200: () => { return Module.canvas.width; },  
 27232: () => { return screen.width; },  
 27257: () => { document.exitFullscreen(); },  
 27284: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27417: () => { return window.innerWidth; },  
 27443: () => { return window.innerHeight; },  
 27470: () => { if (document.fullscreenElement) return 1; },  
 27516: () => { return Module.canvas.width; },  
 27548: () => { return parseInt(Module.canvas.style.width); },  
 27596: () => { if (document.fullscreenElement) return 1; },  
 27642: () => { return Module.canvas.width; },  
 27674: () => { return screen.width; },  
 27699: () => { return window.innerWidth; },  
 27725: () => { return window.innerHeight; },  
 27752: () => { if (document.fullscreenElement) return 1; },  
 27798: () => { return Module.canvas.width; },  
 27830: () => { return screen.width; },  
 27855: () => { document.exitFullscreen(); },  
 27882: () => { if (document.fullscreenElement) return 1; },  
 27928: () => { return Module.canvas.width; },  
 27960: () => { return parseInt(Module.canvas.style.width); },  
 28008: () => { document.exitFullscreen(); },  
 28035: ($0) => { Module.canvas.style.opacity = $0; },  
 28073: () => { return screen.width; },  
 28098: () => { return screen.height; },  
 28124: () => { return window.screenX; },  
 28151: () => { return window.screenY; },  
 28178: () => { return window.devicePixelRatio; },  
 28214: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28267: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28318: () => { Module.canvas.style.cursor = 'none'; },  
 28355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28611: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28662: () => { if (document.fullscreenElement) return 1; },  
 28708: () => { return window.innerWidth; },  
 28734: () => { return window.innerHeight; },  
 28761: () => { if (document.pointerLockElement) return 1; }
};
