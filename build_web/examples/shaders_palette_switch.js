...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfg0tudql.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_palette_switch.data';
      var REMOTE_PACKAGE_BASE = 'shaders_palette_switch.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_palette_switch.data');

      };
      Module['addRunDependency']('datafile_shaders_palette_switch.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfg0tudql.js
...
function findWasmBinary() {
    return locateFile('shaders_palette_switch.wasm');
}
...
var ASM_CONSTS = {
  27216: () => { if (document.fullscreenElement) return 1; },  
 27262: () => { return Module.canvas.width; },  
 27294: () => { return parseInt(Module.canvas.style.width); },  
 27342: () => { document.exitFullscreen(); },  
 27369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27442: () => { if (document.fullscreenElement) return 1; },  
 27488: () => { return Module.canvas.width; },  
 27520: () => { return screen.width; },  
 27545: () => { document.exitFullscreen(); },  
 27572: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27705: () => { return window.innerWidth; },  
 27731: () => { return window.innerHeight; },  
 27758: () => { if (document.fullscreenElement) return 1; },  
 27804: () => { return Module.canvas.width; },  
 27836: () => { return parseInt(Module.canvas.style.width); },  
 27884: () => { if (document.fullscreenElement) return 1; },  
 27930: () => { return Module.canvas.width; },  
 27962: () => { return screen.width; },  
 27987: () => { return window.innerWidth; },  
 28013: () => { return window.innerHeight; },  
 28040: () => { if (document.fullscreenElement) return 1; },  
 28086: () => { return Module.canvas.width; },  
 28118: () => { return screen.width; },  
 28143: () => { document.exitFullscreen(); },  
 28170: () => { if (document.fullscreenElement) return 1; },  
 28216: () => { return Module.canvas.width; },  
 28248: () => { return parseInt(Module.canvas.style.width); },  
 28296: () => { document.exitFullscreen(); },  
 28323: ($0) => { Module.canvas.style.opacity = $0; },  
 28361: () => { return screen.width; },  
 28386: () => { return screen.height; },  
 28412: () => { return window.screenX; },  
 28439: () => { return window.screenY; },  
 28466: () => { return window.devicePixelRatio; },  
 28502: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28555: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28606: () => { Module.canvas.style.cursor = 'none'; },  
 28643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28899: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28950: () => { if (document.fullscreenElement) return 1; },  
 28996: () => { return window.innerWidth; },  
 29022: () => { return window.innerHeight; },  
 29049: () => { if (document.pointerLockElement) return 1; }
};
