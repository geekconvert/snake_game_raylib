...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmprnbbe9xh.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_easings_rectangle_array.data';
      var REMOTE_PACKAGE_BASE = 'shapes_easings_rectangle_array.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_easings_rectangle_array.data');

      };
      Module['addRunDependency']('datafile_shapes_easings_rectangle_array.data');
    ...
    loadPackage({"files": [{"filename": "/resources/.gitkeep", "start": 0, "end": 0}], "remote_package_size": 0});

  })();

// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmprnbbe9xh.js
...
function findWasmBinary() {
    return locateFile('shapes_easings_rectangle_array.wasm');
}
...
var ASM_CONSTS = {
  26304: () => { if (document.fullscreenElement) return 1; },  
 26350: () => { return Module.canvas.width; },  
 26382: () => { return parseInt(Module.canvas.style.width); },  
 26430: () => { document.exitFullscreen(); },  
 26457: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26530: () => { if (document.fullscreenElement) return 1; },  
 26576: () => { return Module.canvas.width; },  
 26608: () => { return screen.width; },  
 26633: () => { document.exitFullscreen(); },  
 26660: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26793: () => { return window.innerWidth; },  
 26819: () => { return window.innerHeight; },  
 26846: () => { if (document.fullscreenElement) return 1; },  
 26892: () => { return Module.canvas.width; },  
 26924: () => { return parseInt(Module.canvas.style.width); },  
 26972: () => { if (document.fullscreenElement) return 1; },  
 27018: () => { return Module.canvas.width; },  
 27050: () => { return screen.width; },  
 27075: () => { return window.innerWidth; },  
 27101: () => { return window.innerHeight; },  
 27128: () => { if (document.fullscreenElement) return 1; },  
 27174: () => { return Module.canvas.width; },  
 27206: () => { return screen.width; },  
 27231: () => { document.exitFullscreen(); },  
 27258: () => { if (document.fullscreenElement) return 1; },  
 27304: () => { return Module.canvas.width; },  
 27336: () => { return parseInt(Module.canvas.style.width); },  
 27384: () => { document.exitFullscreen(); },  
 27411: ($0) => { Module.canvas.style.opacity = $0; },  
 27449: () => { return screen.width; },  
 27474: () => { return screen.height; },  
 27500: () => { return window.screenX; },  
 27527: () => { return window.screenY; },  
 27554: () => { return window.devicePixelRatio; },  
 27590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27643: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27694: () => { Module.canvas.style.cursor = 'none'; },  
 27731: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 27987: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28038: () => { if (document.fullscreenElement) return 1; },  
 28084: () => { return window.innerWidth; },  
 28110: () => { return window.innerHeight; },  
 28137: () => { if (document.pointerLockElement) return 1; }
};
