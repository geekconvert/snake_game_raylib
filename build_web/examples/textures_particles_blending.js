...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpamk8hdmx.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_particles_blending.data';
      var REMOTE_PACKAGE_BASE = 'textures_particles_blending.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_particles_blending.data');

      };
      Module['addRunDependency']('datafile_textures_particles_blending.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpamk8hdmx.js
...
function findWasmBinary() {
    return locateFile('textures_particles_blending.wasm');
}
...
var ASM_CONSTS = {
  30256: () => { if (document.fullscreenElement) return 1; },  
 30302: () => { return Module.canvas.width; },  
 30334: () => { return parseInt(Module.canvas.style.width); },  
 30382: () => { document.exitFullscreen(); },  
 30409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30482: () => { if (document.fullscreenElement) return 1; },  
 30528: () => { return Module.canvas.width; },  
 30560: () => { return screen.width; },  
 30585: () => { document.exitFullscreen(); },  
 30612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30745: () => { return window.innerWidth; },  
 30771: () => { return window.innerHeight; },  
 30798: () => { if (document.fullscreenElement) return 1; },  
 30844: () => { return Module.canvas.width; },  
 30876: () => { return parseInt(Module.canvas.style.width); },  
 30924: () => { if (document.fullscreenElement) return 1; },  
 30970: () => { return Module.canvas.width; },  
 31002: () => { return screen.width; },  
 31027: () => { return window.innerWidth; },  
 31053: () => { return window.innerHeight; },  
 31080: () => { if (document.fullscreenElement) return 1; },  
 31126: () => { return Module.canvas.width; },  
 31158: () => { return screen.width; },  
 31183: () => { document.exitFullscreen(); },  
 31210: () => { if (document.fullscreenElement) return 1; },  
 31256: () => { return Module.canvas.width; },  
 31288: () => { return parseInt(Module.canvas.style.width); },  
 31336: () => { document.exitFullscreen(); },  
 31363: ($0) => { Module.canvas.style.opacity = $0; },  
 31401: () => { return screen.width; },  
 31426: () => { return screen.height; },  
 31452: () => { return window.screenX; },  
 31479: () => { return window.screenY; },  
 31506: () => { return window.devicePixelRatio; },  
 31542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31595: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31646: () => { Module.canvas.style.cursor = 'none'; },  
 31683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31990: () => { if (document.fullscreenElement) return 1; },  
 32036: () => { return window.innerWidth; },  
 32062: () => { return window.innerHeight; },  
 32089: () => { if (document.pointerLockElement) return 1; }
};
