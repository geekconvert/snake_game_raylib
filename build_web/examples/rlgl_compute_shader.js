...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpcspqw_40.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'rlgl_compute_shader.data';
      var REMOTE_PACKAGE_BASE = 'rlgl_compute_shader.data';
...
Module['FS_createPath']("/resources/shaders", "glsl430", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_rlgl_compute_shader.data');

      };
      Module['addRunDependency']('datafile_rlgl_compute_shader.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpcspqw_40.js
...
function findWasmBinary() {
    return locateFile('rlgl_compute_shader.wasm');
}
...
var ASM_CONSTS = {
  27040: () => { if (document.fullscreenElement) return 1; },  
 27086: () => { return Module.canvas.width; },  
 27118: () => { return parseInt(Module.canvas.style.width); },  
 27166: () => { document.exitFullscreen(); },  
 27193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27266: () => { if (document.fullscreenElement) return 1; },  
 27312: () => { return Module.canvas.width; },  
 27344: () => { return screen.width; },  
 27369: () => { document.exitFullscreen(); },  
 27396: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27529: () => { return window.innerWidth; },  
 27555: () => { return window.innerHeight; },  
 27582: () => { if (document.fullscreenElement) return 1; },  
 27628: () => { return Module.canvas.width; },  
 27660: () => { return parseInt(Module.canvas.style.width); },  
 27708: () => { if (document.fullscreenElement) return 1; },  
 27754: () => { return Module.canvas.width; },  
 27786: () => { return screen.width; },  
 27811: () => { return window.innerWidth; },  
 27837: () => { return window.innerHeight; },  
 27864: () => { if (document.fullscreenElement) return 1; },  
 27910: () => { return Module.canvas.width; },  
 27942: () => { return screen.width; },  
 27967: () => { document.exitFullscreen(); },  
 27994: () => { if (document.fullscreenElement) return 1; },  
 28040: () => { return Module.canvas.width; },  
 28072: () => { return parseInt(Module.canvas.style.width); },  
 28120: () => { document.exitFullscreen(); },  
 28147: ($0) => { Module.canvas.style.opacity = $0; },  
 28185: () => { return screen.width; },  
 28210: () => { return screen.height; },  
 28236: () => { return window.screenX; },  
 28263: () => { return window.screenY; },  
 28290: () => { return window.devicePixelRatio; },  
 28326: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28379: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28430: () => { Module.canvas.style.cursor = 'none'; },  
 28467: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28723: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28774: () => { if (document.fullscreenElement) return 1; },  
 28820: () => { return window.innerWidth; },  
 28846: () => { return window.innerHeight; },  
 28873: () => { if (document.pointerLockElement) return 1; }
};
