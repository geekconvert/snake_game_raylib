...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph7bdhunq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_loading_thread.data';
      var REMOTE_PACKAGE_BASE = 'core_loading_thread.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_loading_thread.data');

      };
      Module['addRunDependency']('datafile_core_loading_thread.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph7bdhunq.js
...
function findWasmBinary() {
    return locateFile('core_loading_thread.wasm');
}
...
var ASM_CONSTS = {
  26384: () => { if (document.fullscreenElement) return 1; },  
 26430: () => { return Module.canvas.width; },  
 26462: () => { return parseInt(Module.canvas.style.width); },  
 26510: () => { document.exitFullscreen(); },  
 26537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26610: () => { if (document.fullscreenElement) return 1; },  
 26656: () => { return Module.canvas.width; },  
 26688: () => { return screen.width; },  
 26713: () => { document.exitFullscreen(); },  
 26740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26873: () => { return window.innerWidth; },  
 26899: () => { return window.innerHeight; },  
 26926: () => { if (document.fullscreenElement) return 1; },  
 26972: () => { return Module.canvas.width; },  
 27004: () => { return parseInt(Module.canvas.style.width); },  
 27052: () => { if (document.fullscreenElement) return 1; },  
 27098: () => { return Module.canvas.width; },  
 27130: () => { return screen.width; },  
 27155: () => { return window.innerWidth; },  
 27181: () => { return window.innerHeight; },  
 27208: () => { if (document.fullscreenElement) return 1; },  
 27254: () => { return Module.canvas.width; },  
 27286: () => { return screen.width; },  
 27311: () => { document.exitFullscreen(); },  
 27338: () => { if (document.fullscreenElement) return 1; },  
 27384: () => { return Module.canvas.width; },  
 27416: () => { return parseInt(Module.canvas.style.width); },  
 27464: () => { document.exitFullscreen(); },  
 27491: ($0) => { Module.canvas.style.opacity = $0; },  
 27529: () => { return screen.width; },  
 27554: () => { return screen.height; },  
 27580: () => { return window.screenX; },  
 27607: () => { return window.screenY; },  
 27634: () => { return window.devicePixelRatio; },  
 27670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27723: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27774: () => { Module.canvas.style.cursor = 'none'; },  
 27811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28067: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28118: () => { if (document.fullscreenElement) return 1; },  
 28164: () => { return window.innerWidth; },  
 28190: () => { return window.innerHeight; },  
 28217: () => { if (document.pointerLockElement) return 1; }
};
