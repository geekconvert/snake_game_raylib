...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp0xx24hct.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_box_collisions.data';
      var REMOTE_PACKAGE_BASE = 'models_box_collisions.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_box_collisions.data');

      };
      Module['addRunDependency']('datafile_models_box_collisions.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp0xx24hct.js
...
function findWasmBinary() {
    return locateFile('models_box_collisions.wasm');
}
...
var ASM_CONSTS = {
  26584: () => { if (document.fullscreenElement) return 1; },  
 26630: () => { return Module.canvas.width; },  
 26662: () => { return parseInt(Module.canvas.style.width); },  
 26710: () => { document.exitFullscreen(); },  
 26737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26810: () => { if (document.fullscreenElement) return 1; },  
 26856: () => { return Module.canvas.width; },  
 26888: () => { return screen.width; },  
 26913: () => { document.exitFullscreen(); },  
 26940: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27073: () => { return window.innerWidth; },  
 27099: () => { return window.innerHeight; },  
 27126: () => { if (document.fullscreenElement) return 1; },  
 27172: () => { return Module.canvas.width; },  
 27204: () => { return parseInt(Module.canvas.style.width); },  
 27252: () => { if (document.fullscreenElement) return 1; },  
 27298: () => { return Module.canvas.width; },  
 27330: () => { return screen.width; },  
 27355: () => { return window.innerWidth; },  
 27381: () => { return window.innerHeight; },  
 27408: () => { if (document.fullscreenElement) return 1; },  
 27454: () => { return Module.canvas.width; },  
 27486: () => { return screen.width; },  
 27511: () => { document.exitFullscreen(); },  
 27538: () => { if (document.fullscreenElement) return 1; },  
 27584: () => { return Module.canvas.width; },  
 27616: () => { return parseInt(Module.canvas.style.width); },  
 27664: () => { document.exitFullscreen(); },  
 27691: ($0) => { Module.canvas.style.opacity = $0; },  
 27729: () => { return screen.width; },  
 27754: () => { return screen.height; },  
 27780: () => { return window.screenX; },  
 27807: () => { return window.screenY; },  
 27834: () => { return window.devicePixelRatio; },  
 27870: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27923: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27974: () => { Module.canvas.style.cursor = 'none'; },  
 28011: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28267: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28318: () => { if (document.fullscreenElement) return 1; },  
 28364: () => { return window.innerWidth; },  
 28390: () => { return window.innerHeight; },  
 28417: () => { if (document.pointerLockElement) return 1; }
};
