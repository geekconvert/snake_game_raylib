...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpndibozfu.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_3d_camera_split_screen.data';
      var REMOTE_PACKAGE_BASE = 'core_3d_camera_split_screen.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_3d_camera_split_screen.data');

      };
      Module['addRunDependency']('datafile_core_3d_camera_split_screen.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpndibozfu.js
...
function findWasmBinary() {
    return locateFile('core_3d_camera_split_screen.wasm');
}
...
var ASM_CONSTS = {
  26984: () => { if (document.fullscreenElement) return 1; },  
 27030: () => { return Module.canvas.width; },  
 27062: () => { return parseInt(Module.canvas.style.width); },  
 27110: () => { document.exitFullscreen(); },  
 27137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27210: () => { if (document.fullscreenElement) return 1; },  
 27256: () => { return Module.canvas.width; },  
 27288: () => { return screen.width; },  
 27313: () => { document.exitFullscreen(); },  
 27340: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27473: () => { return window.innerWidth; },  
 27499: () => { return window.innerHeight; },  
 27526: () => { if (document.fullscreenElement) return 1; },  
 27572: () => { return Module.canvas.width; },  
 27604: () => { return parseInt(Module.canvas.style.width); },  
 27652: () => { if (document.fullscreenElement) return 1; },  
 27698: () => { return Module.canvas.width; },  
 27730: () => { return screen.width; },  
 27755: () => { return window.innerWidth; },  
 27781: () => { return window.innerHeight; },  
 27808: () => { if (document.fullscreenElement) return 1; },  
 27854: () => { return Module.canvas.width; },  
 27886: () => { return screen.width; },  
 27911: () => { document.exitFullscreen(); },  
 27938: () => { if (document.fullscreenElement) return 1; },  
 27984: () => { return Module.canvas.width; },  
 28016: () => { return parseInt(Module.canvas.style.width); },  
 28064: () => { document.exitFullscreen(); },  
 28091: ($0) => { Module.canvas.style.opacity = $0; },  
 28129: () => { return screen.width; },  
 28154: () => { return screen.height; },  
 28180: () => { return window.screenX; },  
 28207: () => { return window.screenY; },  
 28234: () => { return window.devicePixelRatio; },  
 28270: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28323: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28374: () => { Module.canvas.style.cursor = 'none'; },  
 28411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28667: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28718: () => { if (document.fullscreenElement) return 1; },  
 28764: () => { return window.innerWidth; },  
 28790: () => { return window.innerHeight; },  
 28817: () => { if (document.pointerLockElement) return 1; }
};
