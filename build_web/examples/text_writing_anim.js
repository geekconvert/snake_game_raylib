...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpedy8v06s.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_writing_anim.data';
      var REMOTE_PACKAGE_BASE = 'text_writing_anim.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_writing_anim.data');

      };
      Module['addRunDependency']('datafile_text_writing_anim.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpedy8v06s.js
...
function findWasmBinary() {
    return locateFile('text_writing_anim.wasm');
}
...
var ASM_CONSTS = {
  26464: () => { if (document.fullscreenElement) return 1; },  
 26510: () => { return Module.canvas.width; },  
 26542: () => { return parseInt(Module.canvas.style.width); },  
 26590: () => { document.exitFullscreen(); },  
 26617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26690: () => { if (document.fullscreenElement) return 1; },  
 26736: () => { return Module.canvas.width; },  
 26768: () => { return screen.width; },  
 26793: () => { document.exitFullscreen(); },  
 26820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26953: () => { return window.innerWidth; },  
 26979: () => { return window.innerHeight; },  
 27006: () => { if (document.fullscreenElement) return 1; },  
 27052: () => { return Module.canvas.width; },  
 27084: () => { return parseInt(Module.canvas.style.width); },  
 27132: () => { if (document.fullscreenElement) return 1; },  
 27178: () => { return Module.canvas.width; },  
 27210: () => { return screen.width; },  
 27235: () => { return window.innerWidth; },  
 27261: () => { return window.innerHeight; },  
 27288: () => { if (document.fullscreenElement) return 1; },  
 27334: () => { return Module.canvas.width; },  
 27366: () => { return screen.width; },  
 27391: () => { document.exitFullscreen(); },  
 27418: () => { if (document.fullscreenElement) return 1; },  
 27464: () => { return Module.canvas.width; },  
 27496: () => { return parseInt(Module.canvas.style.width); },  
 27544: () => { document.exitFullscreen(); },  
 27571: ($0) => { Module.canvas.style.opacity = $0; },  
 27609: () => { return screen.width; },  
 27634: () => { return screen.height; },  
 27660: () => { return window.screenX; },  
 27687: () => { return window.screenY; },  
 27714: () => { return window.devicePixelRatio; },  
 27750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27803: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27854: () => { Module.canvas.style.cursor = 'none'; },  
 27891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28147: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28198: () => { if (document.fullscreenElement) return 1; },  
 28244: () => { return window.innerWidth; },  
 28270: () => { return window.innerHeight; },  
 28297: () => { if (document.pointerLockElement) return 1; }
};
