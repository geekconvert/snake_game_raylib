...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp954pjvy3.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_custom_uniform.data';
      var REMOTE_PACKAGE_BASE = 'shaders_custom_uniform.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_custom_uniform.data');

      };
      Module['addRunDependency']('datafile_shaders_custom_uniform.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp954pjvy3.js
...
function findWasmBinary() {
    return locateFile('shaders_custom_uniform.wasm');
}
...
var ASM_CONSTS = {
  41384: () => { if (document.fullscreenElement) return 1; },  
 41430: () => { return Module.canvas.width; },  
 41462: () => { return parseInt(Module.canvas.style.width); },  
 41510: () => { document.exitFullscreen(); },  
 41537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41610: () => { if (document.fullscreenElement) return 1; },  
 41656: () => { return Module.canvas.width; },  
 41688: () => { return screen.width; },  
 41713: () => { document.exitFullscreen(); },  
 41740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41873: () => { return window.innerWidth; },  
 41899: () => { return window.innerHeight; },  
 41926: () => { if (document.fullscreenElement) return 1; },  
 41972: () => { return Module.canvas.width; },  
 42004: () => { return parseInt(Module.canvas.style.width); },  
 42052: () => { if (document.fullscreenElement) return 1; },  
 42098: () => { return Module.canvas.width; },  
 42130: () => { return screen.width; },  
 42155: () => { return window.innerWidth; },  
 42181: () => { return window.innerHeight; },  
 42208: () => { if (document.fullscreenElement) return 1; },  
 42254: () => { return Module.canvas.width; },  
 42286: () => { return screen.width; },  
 42311: () => { document.exitFullscreen(); },  
 42338: () => { if (document.fullscreenElement) return 1; },  
 42384: () => { return Module.canvas.width; },  
 42416: () => { return parseInt(Module.canvas.style.width); },  
 42464: () => { document.exitFullscreen(); },  
 42491: ($0) => { Module.canvas.style.opacity = $0; },  
 42529: () => { return screen.width; },  
 42554: () => { return screen.height; },  
 42580: () => { return window.screenX; },  
 42607: () => { return window.screenY; },  
 42634: () => { return window.devicePixelRatio; },  
 42670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42723: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42774: () => { Module.canvas.style.cursor = 'none'; },  
 42811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 43067: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43118: () => { if (document.fullscreenElement) return 1; },  
 43164: () => { return window.innerWidth; },  
 43190: () => { return window.innerHeight; },  
 43217: () => { if (document.pointerLockElement) return 1; }
};
