...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmptznpp_8w.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_channel.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_channel.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_channel.data');

      };
      Module['addRunDependency']('datafile_textures_image_channel.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmptznpp_8w.js
...
function findWasmBinary() {
    return locateFile('textures_image_channel.wasm');
}
...
var ASM_CONSTS = {
  36352: () => { if (document.fullscreenElement) return 1; },  
 36398: () => { return Module.canvas.width; },  
 36430: () => { return parseInt(Module.canvas.style.width); },  
 36478: () => { document.exitFullscreen(); },  
 36505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36578: () => { if (document.fullscreenElement) return 1; },  
 36624: () => { return Module.canvas.width; },  
 36656: () => { return screen.width; },  
 36681: () => { document.exitFullscreen(); },  
 36708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36841: () => { return window.innerWidth; },  
 36867: () => { return window.innerHeight; },  
 36894: () => { if (document.fullscreenElement) return 1; },  
 36940: () => { return Module.canvas.width; },  
 36972: () => { return parseInt(Module.canvas.style.width); },  
 37020: () => { if (document.fullscreenElement) return 1; },  
 37066: () => { return Module.canvas.width; },  
 37098: () => { return screen.width; },  
 37123: () => { return window.innerWidth; },  
 37149: () => { return window.innerHeight; },  
 37176: () => { if (document.fullscreenElement) return 1; },  
 37222: () => { return Module.canvas.width; },  
 37254: () => { return screen.width; },  
 37279: () => { document.exitFullscreen(); },  
 37306: () => { if (document.fullscreenElement) return 1; },  
 37352: () => { return Module.canvas.width; },  
 37384: () => { return parseInt(Module.canvas.style.width); },  
 37432: () => { document.exitFullscreen(); },  
 37459: ($0) => { Module.canvas.style.opacity = $0; },  
 37497: () => { return screen.width; },  
 37522: () => { return screen.height; },  
 37548: () => { return window.screenX; },  
 37575: () => { return window.screenY; },  
 37602: () => { return window.devicePixelRatio; },  
 37638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37742: () => { Module.canvas.style.cursor = 'none'; },  
 37779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38035: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 38086: () => { if (document.fullscreenElement) return 1; },  
 38132: () => { return window.innerWidth; },  
 38158: () => { return window.innerHeight; },  
 38185: () => { if (document.pointerLockElement) return 1; }
};
