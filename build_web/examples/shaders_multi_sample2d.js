...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpam5yv4bm.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_multi_sample2d.data';
      var REMOTE_PACKAGE_BASE = 'shaders_multi_sample2d.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_multi_sample2d.data');

      };
      Module['addRunDependency']('datafile_shaders_multi_sample2d.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpam5yv4bm.js
...
function findWasmBinary() {
    return locateFile('shaders_multi_sample2d.wasm');
}
