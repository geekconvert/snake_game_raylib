...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpksujdobk.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_simple_mask.data';
      var REMOTE_PACKAGE_BASE = 'shaders_simple_mask.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_simple_mask.data');

      };
      Module['addRunDependency']('datafile_shaders_simple_mask.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpksujdobk.js
...
function findWasmBinary() {
    return locateFile('shaders_simple_mask.wasm');
}
...
var ASM_CONSTS = {
  32280: () => { if (document.fullscreenElement) return 1; },  
 32326: () => { return Module.canvas.width; },  
 32358: () => { return parseInt(Module.canvas.style.width); },  
 32406: () => { document.exitFullscreen(); },  
 32433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 32506: () => { if (document.fullscreenElement) return 1; },  
 32552: () => { return Module.canvas.width; },  
 32584: () => { return screen.width; },  
 32609: () => { document.exitFullscreen(); },  
 32636: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 32769: () => { return window.innerWidth; },  
 32795: () => { return window.innerHeight; },  
 32822: () => { if (document.fullscreenElement) return 1; },  
 32868: () => { return Module.canvas.width; },  
 32900: () => { return parseInt(Module.canvas.style.width); },  
 32948: () => { if (document.fullscreenElement) return 1; },  
 32994: () => { return Module.canvas.width; },  
 33026: () => { return screen.width; },  
 33051: () => { return window.innerWidth; },  
 33077: () => { return window.innerHeight; },  
 33104: () => { if (document.fullscreenElement) return 1; },  
 33150: () => { return Module.canvas.width; },  
 33182: () => { return screen.width; },  
 33207: () => { document.exitFullscreen(); },  
 33234: () => { if (document.fullscreenElement) return 1; },  
 33280: () => { return Module.canvas.width; },  
 33312: () => { return parseInt(Module.canvas.style.width); },  
 33360: () => { document.exitFullscreen(); },  
 33387: ($0) => { Module.canvas.style.opacity = $0; },  
 33425: () => { return screen.width; },  
 33450: () => { return screen.height; },  
 33476: () => { return window.screenX; },  
 33503: () => { return window.screenY; },  
 33530: () => { return window.devicePixelRatio; },  
 33566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 33619: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 33670: () => { Module.canvas.style.cursor = 'none'; },  
 33707: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 33963: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 34014: () => { if (document.fullscreenElement) return 1; },  
 34060: () => { return window.innerWidth; },  
 34086: () => { return window.innerHeight; },  
 34113: () => { if (document.pointerLockElement) return 1; }
};
