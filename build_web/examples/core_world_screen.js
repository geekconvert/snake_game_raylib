...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmphicuaka3.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_world_screen.data';
      var REMOTE_PACKAGE_BASE = 'core_world_screen.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_world_screen.data');

      };
      Module['addRunDependency']('datafile_core_world_screen.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmphicuaka3.js
...
function findWasmBinary() {
    return locateFile('core_world_screen.wasm');
}
...
var ASM_CONSTS = {
  26616: () => { if (document.fullscreenElement) return 1; },  
 26662: () => { return Module.canvas.width; },  
 26694: () => { return parseInt(Module.canvas.style.width); },  
 26742: () => { document.exitFullscreen(); },  
 26769: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26842: () => { if (document.fullscreenElement) return 1; },  
 26888: () => { return Module.canvas.width; },  
 26920: () => { return screen.width; },  
 26945: () => { document.exitFullscreen(); },  
 26972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27105: () => { return window.innerWidth; },  
 27131: () => { return window.innerHeight; },  
 27158: () => { if (document.fullscreenElement) return 1; },  
 27204: () => { return Module.canvas.width; },  
 27236: () => { return parseInt(Module.canvas.style.width); },  
 27284: () => { if (document.fullscreenElement) return 1; },  
 27330: () => { return Module.canvas.width; },  
 27362: () => { return screen.width; },  
 27387: () => { return window.innerWidth; },  
 27413: () => { return window.innerHeight; },  
 27440: () => { if (document.fullscreenElement) return 1; },  
 27486: () => { return Module.canvas.width; },  
 27518: () => { return screen.width; },  
 27543: () => { document.exitFullscreen(); },  
 27570: () => { if (document.fullscreenElement) return 1; },  
 27616: () => { return Module.canvas.width; },  
 27648: () => { return parseInt(Module.canvas.style.width); },  
 27696: () => { document.exitFullscreen(); },  
 27723: ($0) => { Module.canvas.style.opacity = $0; },  
 27761: () => { return screen.width; },  
 27786: () => { return screen.height; },  
 27812: () => { return window.screenX; },  
 27839: () => { return window.screenY; },  
 27866: () => { return window.devicePixelRatio; },  
 27902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27955: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28006: () => { Module.canvas.style.cursor = 'none'; },  
 28043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28299: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28350: () => { if (document.fullscreenElement) return 1; },  
 28396: () => { return window.innerWidth; },  
 28422: () => { return window.innerHeight; },  
 28449: () => { if (document.pointerLockElement) return 1; }
};
