...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_82hdbp5.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_gpu_skinning.data';
      var REMOTE_PACKAGE_BASE = 'models_gpu_skinning.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_gpu_skinning.data');

      };
      Module['addRunDependency']('datafile_models_gpu_skinning.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_82hdbp5.js
...
function findWasmBinary() {
    return locateFile('models_gpu_skinning.wasm');
}
...
var ASM_CONSTS = {
  41464: () => { if (document.fullscreenElement) return 1; },  
 41510: () => { return Module.canvas.width; },  
 41542: () => { return parseInt(Module.canvas.style.width); },  
 41590: () => { document.exitFullscreen(); },  
 41617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41690: () => { if (document.fullscreenElement) return 1; },  
 41736: () => { return Module.canvas.width; },  
 41768: () => { return screen.width; },  
 41793: () => { document.exitFullscreen(); },  
 41820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41953: () => { return window.innerWidth; },  
 41979: () => { return window.innerHeight; },  
 42006: () => { if (document.fullscreenElement) return 1; },  
 42052: () => { return Module.canvas.width; },  
 42084: () => { return parseInt(Module.canvas.style.width); },  
 42132: () => { if (document.fullscreenElement) return 1; },  
 42178: () => { return Module.canvas.width; },  
 42210: () => { return screen.width; },  
 42235: () => { return window.innerWidth; },  
 42261: () => { return window.innerHeight; },  
 42288: () => { if (document.fullscreenElement) return 1; },  
 42334: () => { return Module.canvas.width; },  
 42366: () => { return screen.width; },  
 42391: () => { document.exitFullscreen(); },  
 42418: () => { if (document.fullscreenElement) return 1; },  
 42464: () => { return Module.canvas.width; },  
 42496: () => { return parseInt(Module.canvas.style.width); },  
 42544: () => { document.exitFullscreen(); },  
 42571: ($0) => { Module.canvas.style.opacity = $0; },  
 42609: () => { return screen.width; },  
 42634: () => { return screen.height; },  
 42660: () => { return window.screenX; },  
 42687: () => { return window.screenY; },  
 42714: () => { return window.devicePixelRatio; },  
 42750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42803: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42854: () => { Module.canvas.style.cursor = 'none'; },  
 42891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 43147: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43198: () => { if (document.fullscreenElement) return 1; },  
 43244: () => { return window.innerWidth; },  
 43270: () => { return window.innerHeight; },  
 43297: () => { if (document.pointerLockElement) return 1; }
};
