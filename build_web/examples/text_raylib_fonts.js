...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdtr8kk8n.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_raylib_fonts.data';
      var REMOTE_PACKAGE_BASE = 'text_raylib_fonts.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_raylib_fonts.data');

      };
      Module['addRunDependency']('datafile_text_raylib_fonts.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdtr8kk8n.js
...
function findWasmBinary() {
    return locateFile('text_raylib_fonts.wasm');
}
...
var ASM_CONSTS = {
  46352: () => { if (document.fullscreenElement) return 1; },  
 46398: () => { return Module.canvas.width; },  
 46430: () => { return parseInt(Module.canvas.style.width); },  
 46478: () => { document.exitFullscreen(); },  
 46505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 46578: () => { if (document.fullscreenElement) return 1; },  
 46624: () => { return Module.canvas.width; },  
 46656: () => { return screen.width; },  
 46681: () => { document.exitFullscreen(); },  
 46708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 46841: () => { return window.innerWidth; },  
 46867: () => { return window.innerHeight; },  
 46894: () => { if (document.fullscreenElement) return 1; },  
 46940: () => { return Module.canvas.width; },  
 46972: () => { return parseInt(Module.canvas.style.width); },  
 47020: () => { if (document.fullscreenElement) return 1; },  
 47066: () => { return Module.canvas.width; },  
 47098: () => { return screen.width; },  
 47123: () => { return window.innerWidth; },  
 47149: () => { return window.innerHeight; },  
 47176: () => { if (document.fullscreenElement) return 1; },  
 47222: () => { return Module.canvas.width; },  
 47254: () => { return screen.width; },  
 47279: () => { document.exitFullscreen(); },  
 47306: () => { if (document.fullscreenElement) return 1; },  
 47352: () => { return Module.canvas.width; },  
 47384: () => { return parseInt(Module.canvas.style.width); },  
 47432: () => { document.exitFullscreen(); },  
 47459: ($0) => { Module.canvas.style.opacity = $0; },  
 47497: () => { return screen.width; },  
 47522: () => { return screen.height; },  
 47548: () => { return window.screenX; },  
 47575: () => { return window.screenY; },  
 47602: () => { return window.devicePixelRatio; },  
 47638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 47691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47742: () => { Module.canvas.style.cursor = 'none'; },  
 47779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 48035: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 48086: () => { if (document.fullscreenElement) return 1; },  
 48132: () => { return window.innerWidth; },  
 48158: () => { return window.innerHeight; },  
 48185: () => { if (document.pointerLockElement) return 1; }
};
