...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpzlnpjld7.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_window_should_close.data';
      var REMOTE_PACKAGE_BASE = 'core_window_should_close.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_window_should_close.data');

      };
      Module['addRunDependency']('datafile_core_window_should_close.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpzlnpjld7.js
...
function findWasmBinary() {
    return locateFile('core_window_should_close.wasm');
}
...
var ASM_CONSTS = {
  26368: () => { if (document.fullscreenElement) return 1; },  
 26414: () => { return Module.canvas.width; },  
 26446: () => { return parseInt(Module.canvas.style.width); },  
 26494: () => { document.exitFullscreen(); },  
 26521: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26594: () => { if (document.fullscreenElement) return 1; },  
 26640: () => { return Module.canvas.width; },  
 26672: () => { return screen.width; },  
 26697: () => { document.exitFullscreen(); },  
 26724: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26857: () => { return window.innerWidth; },  
 26883: () => { return window.innerHeight; },  
 26910: () => { if (document.fullscreenElement) return 1; },  
 26956: () => { return Module.canvas.width; },  
 26988: () => { return parseInt(Module.canvas.style.width); },  
 27036: () => { if (document.fullscreenElement) return 1; },  
 27082: () => { return Module.canvas.width; },  
 27114: () => { return screen.width; },  
 27139: () => { return window.innerWidth; },  
 27165: () => { return window.innerHeight; },  
 27192: () => { if (document.fullscreenElement) return 1; },  
 27238: () => { return Module.canvas.width; },  
 27270: () => { return screen.width; },  
 27295: () => { document.exitFullscreen(); },  
 27322: () => { if (document.fullscreenElement) return 1; },  
 27368: () => { return Module.canvas.width; },  
 27400: () => { return parseInt(Module.canvas.style.width); },  
 27448: () => { document.exitFullscreen(); },  
 27475: ($0) => { Module.canvas.style.opacity = $0; },  
 27513: () => { return screen.width; },  
 27538: () => { return screen.height; },  
 27564: () => { return window.screenX; },  
 27591: () => { return window.screenY; },  
 27618: () => { return window.devicePixelRatio; },  
 27654: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27707: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27758: () => { Module.canvas.style.cursor = 'none'; },  
 27795: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28051: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28102: () => { if (document.fullscreenElement) return 1; },  
 28148: () => { return window.innerWidth; },  
 28174: () => { return window.innerHeight; },  
 28201: () => { if (document.pointerLockElement) return 1; }
};
