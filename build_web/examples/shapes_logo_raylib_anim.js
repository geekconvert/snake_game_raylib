...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpbn3g7xpd.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_logo_raylib_anim.data';
      var REMOTE_PACKAGE_BASE = 'shapes_logo_raylib_anim.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_logo_raylib_anim.data');

      };
      Module['addRunDependency']('datafile_shapes_logo_raylib_anim.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpbn3g7xpd.js
...
function findWasmBinary() {
    return locateFile('shapes_logo_raylib_anim.wasm');
}
...
var ASM_CONSTS = {
  26288: () => { if (document.fullscreenElement) return 1; },  
 26334: () => { return Module.canvas.width; },  
 26366: () => { return parseInt(Module.canvas.style.width); },  
 26414: () => { document.exitFullscreen(); },  
 26441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26514: () => { if (document.fullscreenElement) return 1; },  
 26560: () => { return Module.canvas.width; },  
 26592: () => { return screen.width; },  
 26617: () => { document.exitFullscreen(); },  
 26644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26777: () => { return window.innerWidth; },  
 26803: () => { return window.innerHeight; },  
 26830: () => { if (document.fullscreenElement) return 1; },  
 26876: () => { return Module.canvas.width; },  
 26908: () => { return parseInt(Module.canvas.style.width); },  
 26956: () => { if (document.fullscreenElement) return 1; },  
 27002: () => { return Module.canvas.width; },  
 27034: () => { return screen.width; },  
 27059: () => { return window.innerWidth; },  
 27085: () => { return window.innerHeight; },  
 27112: () => { if (document.fullscreenElement) return 1; },  
 27158: () => { return Module.canvas.width; },  
 27190: () => { return screen.width; },  
 27215: () => { document.exitFullscreen(); },  
 27242: () => { if (document.fullscreenElement) return 1; },  
 27288: () => { return Module.canvas.width; },  
 27320: () => { return parseInt(Module.canvas.style.width); },  
 27368: () => { document.exitFullscreen(); },  
 27395: ($0) => { Module.canvas.style.opacity = $0; },  
 27433: () => { return screen.width; },  
 27458: () => { return screen.height; },  
 27484: () => { return window.screenX; },  
 27511: () => { return window.screenY; },  
 27538: () => { return window.devicePixelRatio; },  
 27574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27627: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27678: () => { Module.canvas.style.cursor = 'none'; },  
 27715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 27971: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28022: () => { if (document.fullscreenElement) return 1; },  
 28068: () => { return window.innerWidth; },  
 28094: () => { return window.innerHeight; },  
 28121: () => { if (document.pointerLockElement) return 1; }
};
