...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdg52ll5t.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_yaw_pitch_roll.data';
      var REMOTE_PACKAGE_BASE = 'models_yaw_pitch_roll.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_yaw_pitch_roll.data');

      };
      Module['addRunDependency']('datafile_models_yaw_pitch_roll.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdg52ll5t.js
...
function findWasmBinary() {
    return locateFile('models_yaw_pitch_roll.wasm');
}
...
var ASM_CONSTS = {
  40632: () => { if (document.fullscreenElement) return 1; },  
 40678: () => { return Module.canvas.width; },  
 40710: () => { return parseInt(Module.canvas.style.width); },  
 40758: () => { document.exitFullscreen(); },  
 40785: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 40858: () => { if (document.fullscreenElement) return 1; },  
 40904: () => { return Module.canvas.width; },  
 40936: () => { return screen.width; },  
 40961: () => { document.exitFullscreen(); },  
 40988: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41121: () => { return window.innerWidth; },  
 41147: () => { return window.innerHeight; },  
 41174: () => { if (document.fullscreenElement) return 1; },  
 41220: () => { return Module.canvas.width; },  
 41252: () => { return parseInt(Module.canvas.style.width); },  
 41300: () => { if (document.fullscreenElement) return 1; },  
 41346: () => { return Module.canvas.width; },  
 41378: () => { return screen.width; },  
 41403: () => { return window.innerWidth; },  
 41429: () => { return window.innerHeight; },  
 41456: () => { if (document.fullscreenElement) return 1; },  
 41502: () => { return Module.canvas.width; },  
 41534: () => { return screen.width; },  
 41559: () => { document.exitFullscreen(); },  
 41586: () => { if (document.fullscreenElement) return 1; },  
 41632: () => { return Module.canvas.width; },  
 41664: () => { return parseInt(Module.canvas.style.width); },  
 41712: () => { document.exitFullscreen(); },  
 41739: ($0) => { Module.canvas.style.opacity = $0; },  
 41777: () => { return screen.width; },  
 41802: () => { return screen.height; },  
 41828: () => { return window.screenX; },  
 41855: () => { return window.screenY; },  
 41882: () => { return window.devicePixelRatio; },  
 41918: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 41971: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42022: () => { Module.canvas.style.cursor = 'none'; },  
 42059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42315: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42366: () => { if (document.fullscreenElement) return 1; },  
 42412: () => { return window.innerWidth; },  
 42438: () => { return window.innerHeight; },  
 42465: () => { if (document.pointerLockElement) return 1; }
};
