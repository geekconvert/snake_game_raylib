...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpocmp9jgy.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_smooth_pixelperfect.data';
      var REMOTE_PACKAGE_BASE = 'core_smooth_pixelperfect.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_smooth_pixelperfect.data');

      };
      Module['addRunDependency']('datafile_core_smooth_pixelperfect.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpocmp9jgy.js
...
function findWasmBinary() {
    return locateFile('core_smooth_pixelperfect.wasm');
}
...
var ASM_CONSTS = {
  26848: () => { if (document.fullscreenElement) return 1; },  
 26894: () => { return Module.canvas.width; },  
 26926: () => { return parseInt(Module.canvas.style.width); },  
 26974: () => { document.exitFullscreen(); },  
 27001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27074: () => { if (document.fullscreenElement) return 1; },  
 27120: () => { return Module.canvas.width; },  
 27152: () => { return screen.width; },  
 27177: () => { document.exitFullscreen(); },  
 27204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27337: () => { return window.innerWidth; },  
 27363: () => { return window.innerHeight; },  
 27390: () => { if (document.fullscreenElement) return 1; },  
 27436: () => { return Module.canvas.width; },  
 27468: () => { return parseInt(Module.canvas.style.width); },  
 27516: () => { if (document.fullscreenElement) return 1; },  
 27562: () => { return Module.canvas.width; },  
 27594: () => { return screen.width; },  
 27619: () => { return window.innerWidth; },  
 27645: () => { return window.innerHeight; },  
 27672: () => { if (document.fullscreenElement) return 1; },  
 27718: () => { return Module.canvas.width; },  
 27750: () => { return screen.width; },  
 27775: () => { document.exitFullscreen(); },  
 27802: () => { if (document.fullscreenElement) return 1; },  
 27848: () => { return Module.canvas.width; },  
 27880: () => { return parseInt(Module.canvas.style.width); },  
 27928: () => { document.exitFullscreen(); },  
 27955: ($0) => { Module.canvas.style.opacity = $0; },  
 27993: () => { return screen.width; },  
 28018: () => { return screen.height; },  
 28044: () => { return window.screenX; },  
 28071: () => { return window.screenY; },  
 28098: () => { return window.devicePixelRatio; },  
 28134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28187: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28238: () => { Module.canvas.style.cursor = 'none'; },  
 28275: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28531: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28582: () => { if (document.fullscreenElement) return 1; },  
 28628: () => { return window.innerWidth; },  
 28654: () => { return window.innerHeight; },  
 28681: () => { if (document.pointerLockElement) return 1; }
};
