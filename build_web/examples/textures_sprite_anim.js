...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmprlnp24el.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_sprite_anim.data';
      var REMOTE_PACKAGE_BASE = 'textures_sprite_anim.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_sprite_anim.data');

      };
      Module['addRunDependency']('datafile_textures_sprite_anim.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmprlnp24el.js
...
function findWasmBinary() {
    return locateFile('textures_sprite_anim.wasm');
}
...
var ASM_CONSTS = {
  30272: () => { if (document.fullscreenElement) return 1; },  
 30318: () => { return Module.canvas.width; },  
 30350: () => { return parseInt(Module.canvas.style.width); },  
 30398: () => { document.exitFullscreen(); },  
 30425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30498: () => { if (document.fullscreenElement) return 1; },  
 30544: () => { return Module.canvas.width; },  
 30576: () => { return screen.width; },  
 30601: () => { document.exitFullscreen(); },  
 30628: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30761: () => { return window.innerWidth; },  
 30787: () => { return window.innerHeight; },  
 30814: () => { if (document.fullscreenElement) return 1; },  
 30860: () => { return Module.canvas.width; },  
 30892: () => { return parseInt(Module.canvas.style.width); },  
 30940: () => { if (document.fullscreenElement) return 1; },  
 30986: () => { return Module.canvas.width; },  
 31018: () => { return screen.width; },  
 31043: () => { return window.innerWidth; },  
 31069: () => { return window.innerHeight; },  
 31096: () => { if (document.fullscreenElement) return 1; },  
 31142: () => { return Module.canvas.width; },  
 31174: () => { return screen.width; },  
 31199: () => { document.exitFullscreen(); },  
 31226: () => { if (document.fullscreenElement) return 1; },  
 31272: () => { return Module.canvas.width; },  
 31304: () => { return parseInt(Module.canvas.style.width); },  
 31352: () => { document.exitFullscreen(); },  
 31379: ($0) => { Module.canvas.style.opacity = $0; },  
 31417: () => { return screen.width; },  
 31442: () => { return screen.height; },  
 31468: () => { return window.screenX; },  
 31495: () => { return window.screenY; },  
 31522: () => { return window.devicePixelRatio; },  
 31558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31611: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31662: () => { Module.canvas.style.cursor = 'none'; },  
 31699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31955: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32006: () => { if (document.fullscreenElement) return 1; },  
 32052: () => { return window.innerWidth; },  
 32078: () => { return window.innerHeight; },  
 32105: () => { if (document.pointerLockElement) return 1; }
};
