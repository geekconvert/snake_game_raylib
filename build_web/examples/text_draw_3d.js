...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpy3dwpcas.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_draw_3d.data';
      var REMOTE_PACKAGE_BASE = 'text_draw_3d.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_draw_3d.data');

      };
      Module['addRunDependency']('datafile_text_draw_3d.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpy3dwpcas.js
...
function findWasmBinary() {
    return locateFile('text_draw_3d.wasm');
}
...
var ASM_CONSTS = {
  47048: () => { if (document.fullscreenElement) return 1; },  
 47094: () => { return Module.canvas.width; },  
 47126: () => { return parseInt(Module.canvas.style.width); },  
 47174: () => { document.exitFullscreen(); },  
 47201: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 47274: () => { if (document.fullscreenElement) return 1; },  
 47320: () => { return Module.canvas.width; },  
 47352: () => { return screen.width; },  
 47377: () => { document.exitFullscreen(); },  
 47404: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 47537: () => { return window.innerWidth; },  
 47563: () => { return window.innerHeight; },  
 47590: () => { if (document.fullscreenElement) return 1; },  
 47636: () => { return Module.canvas.width; },  
 47668: () => { return parseInt(Module.canvas.style.width); },  
 47716: () => { if (document.fullscreenElement) return 1; },  
 47762: () => { return Module.canvas.width; },  
 47794: () => { return screen.width; },  
 47819: () => { return window.innerWidth; },  
 47845: () => { return window.innerHeight; },  
 47872: () => { if (document.fullscreenElement) return 1; },  
 47918: () => { return Module.canvas.width; },  
 47950: () => { return screen.width; },  
 47975: () => { document.exitFullscreen(); },  
 48002: () => { if (document.fullscreenElement) return 1; },  
 48048: () => { return Module.canvas.width; },  
 48080: () => { return parseInt(Module.canvas.style.width); },  
 48128: () => { document.exitFullscreen(); },  
 48155: ($0) => { Module.canvas.style.opacity = $0; },  
 48193: () => { return screen.width; },  
 48218: () => { return screen.height; },  
 48244: () => { return window.screenX; },  
 48271: () => { return window.screenY; },  
 48298: () => { return window.devicePixelRatio; },  
 48334: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 48387: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 48438: () => { Module.canvas.style.cursor = 'none'; },  
 48475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 48731: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 48782: () => { if (document.fullscreenElement) return 1; },  
 48828: () => { return window.innerWidth; },  
 48854: () => { return window.innerHeight; },  
 48881: () => { if (document.pointerLockElement) return 1; }
};
