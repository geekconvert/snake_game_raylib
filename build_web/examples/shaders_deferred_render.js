...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpt1ol2jh7.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_deferred_render.data';
      var REMOTE_PACKAGE_BASE = 'shaders_deferred_render.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_deferred_render.data');

      };
      Module['addRunDependency']('datafile_shaders_deferred_render.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpt1ol2jh7.js
...
function findWasmBinary() {
    return locateFile('shaders_deferred_render.wasm');
}
...
var ASM_CONSTS = {
  28792: () => { if (document.fullscreenElement) return 1; },  
 28838: () => { return Module.canvas.width; },  
 28870: () => { return parseInt(Module.canvas.style.width); },  
 28918: () => { document.exitFullscreen(); },  
 28945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 29018: () => { if (document.fullscreenElement) return 1; },  
 29064: () => { return Module.canvas.width; },  
 29096: () => { return screen.width; },  
 29121: () => { document.exitFullscreen(); },  
 29148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 29281: () => { return window.innerWidth; },  
 29307: () => { return window.innerHeight; },  
 29334: () => { if (document.fullscreenElement) return 1; },  
 29380: () => { return Module.canvas.width; },  
 29412: () => { return parseInt(Module.canvas.style.width); },  
 29460: () => { if (document.fullscreenElement) return 1; },  
 29506: () => { return Module.canvas.width; },  
 29538: () => { return screen.width; },  
 29563: () => { return window.innerWidth; },  
 29589: () => { return window.innerHeight; },  
 29616: () => { if (document.fullscreenElement) return 1; },  
 29662: () => { return Module.canvas.width; },  
 29694: () => { return screen.width; },  
 29719: () => { document.exitFullscreen(); },  
 29746: () => { if (document.fullscreenElement) return 1; },  
 29792: () => { return Module.canvas.width; },  
 29824: () => { return parseInt(Module.canvas.style.width); },  
 29872: () => { document.exitFullscreen(); },  
 29899: ($0) => { Module.canvas.style.opacity = $0; },  
 29937: () => { return screen.width; },  
 29962: () => { return screen.height; },  
 29988: () => { return window.screenX; },  
 30015: () => { return window.screenY; },  
 30042: () => { return window.devicePixelRatio; },  
 30078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 30131: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30182: () => { Module.canvas.style.cursor = 'none'; },  
 30219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 30475: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 30526: () => { if (document.fullscreenElement) return 1; },  
 30572: () => { return window.innerWidth; },  
 30598: () => { return window.innerHeight; },  
 30625: () => { if (document.pointerLockElement) return 1; }
};
