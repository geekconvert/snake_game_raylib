...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjpkcbisx.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_hot_reloading.data';
      var REMOTE_PACKAGE_BASE = 'shaders_hot_reloading.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_hot_reloading.data');

      };
      Module['addRunDependency']('datafile_shaders_hot_reloading.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpjpkcbisx.js
...
function findWasmBinary() {
    return locateFile('shaders_hot_reloading.wasm');
}
...
var ASM_CONSTS = {
  27376: () => { if (document.fullscreenElement) return 1; },  
 27422: () => { return Module.canvas.width; },  
 27454: () => { return parseInt(Module.canvas.style.width); },  
 27502: () => { document.exitFullscreen(); },  
 27529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27602: () => { if (document.fullscreenElement) return 1; },  
 27648: () => { return Module.canvas.width; },  
 27680: () => { return screen.width; },  
 27705: () => { document.exitFullscreen(); },  
 27732: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27865: () => { return window.innerWidth; },  
 27891: () => { return window.innerHeight; },  
 27918: () => { if (document.fullscreenElement) return 1; },  
 27964: () => { return Module.canvas.width; },  
 27996: () => { return parseInt(Module.canvas.style.width); },  
 28044: () => { if (document.fullscreenElement) return 1; },  
 28090: () => { return Module.canvas.width; },  
 28122: () => { return screen.width; },  
 28147: () => { return window.innerWidth; },  
 28173: () => { return window.innerHeight; },  
 28200: () => { if (document.fullscreenElement) return 1; },  
 28246: () => { return Module.canvas.width; },  
 28278: () => { return screen.width; },  
 28303: () => { document.exitFullscreen(); },  
 28330: () => { if (document.fullscreenElement) return 1; },  
 28376: () => { return Module.canvas.width; },  
 28408: () => { return parseInt(Module.canvas.style.width); },  
 28456: () => { document.exitFullscreen(); },  
 28483: ($0) => { Module.canvas.style.opacity = $0; },  
 28521: () => { return screen.width; },  
 28546: () => { return screen.height; },  
 28572: () => { return window.screenX; },  
 28599: () => { return window.screenY; },  
 28626: () => { return window.devicePixelRatio; },  
 28662: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28715: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28766: () => { Module.canvas.style.cursor = 'none'; },  
 28803: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29059: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29110: () => { if (document.fullscreenElement) return 1; },  
 29156: () => { return window.innerWidth; },  
 29182: () => { return window.innerHeight; },  
 29209: () => { if (document.pointerLockElement) return 1; }
};
