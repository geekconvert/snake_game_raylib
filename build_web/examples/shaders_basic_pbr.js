...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpossk05e4.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_basic_pbr.data';
      var REMOTE_PACKAGE_BASE = 'shaders_basic_pbr.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_basic_pbr.data');

      };
      Module['addRunDependency']('datafile_shaders_basic_pbr.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpossk05e4.js
...
function findWasmBinary() {
    return locateFile('shaders_basic_pbr.wasm');
}
