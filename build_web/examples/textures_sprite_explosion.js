...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpllxabeqh.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_sprite_explosion.data';
      var REMOTE_PACKAGE_BASE = 'textures_sprite_explosion.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_sprite_explosion.data');

      };
      Module['addRunDependency']('datafile_textures_sprite_explosion.data');
    ...
    loadPackage({"files": [{"filename": "/resources/KAISG.ttf", "start": 0, "end": 79912}, {"filename": "/resources/LICENSE.md", "start": 79912, "end": 82694}, {"filename": "/resources/boom.wav", "start": 82694, "end": 96357, "audio": 1}, {"filename": "/resources/button.png", "start": 96357, "end": 119816}, {"filename": "/resources/buttonfx.wav", "start": 119816, "end": 208060, "audio": 1}, {"filename": "/resources/cat.png", "start": 208060, "end": 596527}, {"filename": "/resources/custom_jupiter_crash.png", "start": 596527, "end": 625569}, {"filename": "/resources/cyberpunk_street_background.png", "start": 625569, "end": 633304}, {"filename": "/resources/cyberpunk_street_foreground.png", "start": 633304, "end": 651339}, {"filename": "/resources/cyberpunk_street_midground.png", "start": 651339, "end": 659141}, {"filename": "/resources/explosion.png", "start": 659141, "end": 1489649}, {"filename": "/resources/fudesumi.png", "start": 1489649, "end": 1712268}, {"filename": "/resources/fudesumi.raw", "start": 1712268, "end": 2498700}, {"filename": "/resources/ninepatch_button.png", "start": 2498700, "end": 2504602}, {"filename": "/resources/parrots.png", "start": 2504602, "end": 2799562}, {"filename": "/resources/patterns.png", "start": 2799562, "end": 2806949}, {"filename": "/resources/raylib_logo.png", "start": 2806949, "end": 2810621}, {"filename": "/resources/road.png", "start": 2810621, "end": 2811627}, {"filename": "/resources/scarfy.png", "start": 2811627, "end": 2822021}, {"filename": "/resources/scarfy_run.gif", "start": 2822021, "end": 2843282}, {"filename": "/resources/spark_flame.png", "start": 2843282, "end": 2850819}, {"filename": "/resources/wabbit_alpha.png", "start": 2850819, "end": 2851315}], "remote_package_size": 2851315});

  })();

// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpllxabeqh.js
...
function findWasmBinary() {
    return locateFile('textures_sprite_explosion.wasm');
}
...
var ASM_CONSTS = {
  64744: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 66902: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 67066: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 67170: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 67341: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 70169: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 70235: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 70628: ($0) => { miniaudio.untrack_device_by_index($0); },  
 70671: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 70796: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 70922: () => { if (document.fullscreenElement) return 1; },  
 70968: () => { return Module.canvas.width; },  
 71000: () => { return parseInt(Module.canvas.style.width); },  
 71048: () => { document.exitFullscreen(); },  
 71075: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 71148: () => { if (document.fullscreenElement) return 1; },  
 71194: () => { return Module.canvas.width; },  
 71226: () => { return screen.width; },  
 71251: () => { document.exitFullscreen(); },  
 71278: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 71411: () => { return window.innerWidth; },  
 71437: () => { return window.innerHeight; },  
 71464: () => { if (document.fullscreenElement) return 1; },  
 71510: () => { return Module.canvas.width; },  
 71542: () => { return parseInt(Module.canvas.style.width); },  
 71590: () => { if (document.fullscreenElement) return 1; },  
 71636: () => { return Module.canvas.width; },  
 71668: () => { return screen.width; },  
 71693: () => { return window.innerWidth; },  
 71719: () => { return window.innerHeight; },  
 71746: () => { if (document.fullscreenElement) return 1; },  
 71792: () => { return Module.canvas.width; },  
 71824: () => { return screen.width; },  
 71849: () => { document.exitFullscreen(); },  
 71876: () => { if (document.fullscreenElement) return 1; },  
 71922: () => { return Module.canvas.width; },  
 71954: () => { return parseInt(Module.canvas.style.width); },  
 72002: () => { document.exitFullscreen(); },  
 72029: ($0) => { Module.canvas.style.opacity = $0; },  
 72067: () => { return screen.width; },  
 72092: () => { return screen.height; },  
 72118: () => { return window.screenX; },  
 72145: () => { return window.screenY; },  
 72172: () => { return window.devicePixelRatio; },  
 72208: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72261: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 72312: () => { Module.canvas.style.cursor = 'none'; },  
 72349: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 72605: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 72656: () => { if (document.fullscreenElement) return 1; },  
 72702: () => { return window.innerWidth; },  
 72728: () => { return window.innerHeight; },  
 72755: () => { if (document.pointerLockElement) return 1; }
};
