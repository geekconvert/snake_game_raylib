...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp89pvy7ib.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_2d_camera_split_screen.data';
      var REMOTE_PACKAGE_BASE = 'core_2d_camera_split_screen.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_2d_camera_split_screen.data');

      };
      Module['addRunDependency']('datafile_core_2d_camera_split_screen.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp89pvy7ib.js
...
function findWasmBinary() {
    return locateFile('core_2d_camera_split_screen.wasm');
}
...
var ASM_CONSTS = {
  26816: () => { if (document.fullscreenElement) return 1; },  
 26862: () => { return Module.canvas.width; },  
 26894: () => { return parseInt(Module.canvas.style.width); },  
 26942: () => { document.exitFullscreen(); },  
 26969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27042: () => { if (document.fullscreenElement) return 1; },  
 27088: () => { return Module.canvas.width; },  
 27120: () => { return screen.width; },  
 27145: () => { document.exitFullscreen(); },  
 27172: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27305: () => { return window.innerWidth; },  
 27331: () => { return window.innerHeight; },  
 27358: () => { if (document.fullscreenElement) return 1; },  
 27404: () => { return Module.canvas.width; },  
 27436: () => { return parseInt(Module.canvas.style.width); },  
 27484: () => { if (document.fullscreenElement) return 1; },  
 27530: () => { return Module.canvas.width; },  
 27562: () => { return screen.width; },  
 27587: () => { return window.innerWidth; },  
 27613: () => { return window.innerHeight; },  
 27640: () => { if (document.fullscreenElement) return 1; },  
 27686: () => { return Module.canvas.width; },  
 27718: () => { return screen.width; },  
 27743: () => { document.exitFullscreen(); },  
 27770: () => { if (document.fullscreenElement) return 1; },  
 27816: () => { return Module.canvas.width; },  
 27848: () => { return parseInt(Module.canvas.style.width); },  
 27896: () => { document.exitFullscreen(); },  
 27923: ($0) => { Module.canvas.style.opacity = $0; },  
 27961: () => { return screen.width; },  
 27986: () => { return screen.height; },  
 28012: () => { return window.screenX; },  
 28039: () => { return window.screenY; },  
 28066: () => { return window.devicePixelRatio; },  
 28102: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28155: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28206: () => { Module.canvas.style.cursor = 'none'; },  
 28243: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28499: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28550: () => { if (document.fullscreenElement) return 1; },  
 28596: () => { return window.innerWidth; },  
 28622: () => { return window.innerHeight; },  
 28649: () => { if (document.pointerLockElement) return 1; }
};
