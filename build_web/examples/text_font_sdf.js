...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpc1cqifdl.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_font_sdf.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_font_sdf.data');

      };
      Module['addRunDependency']('datafile_text_font_sdf.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpc1cqifdl.js
...
function findWasmBinary() {
    return locateFile('text_font_sdf.wasm');
}
...
var ASM_CONSTS = {
  35488: () => { if (document.fullscreenElement) return 1; },  
 35534: () => { return Module.canvas.width; },  
 35566: () => { return parseInt(Module.canvas.style.width); },  
 35614: () => { document.exitFullscreen(); },  
 35641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 35714: () => { if (document.fullscreenElement) return 1; },  
 35760: () => { return Module.canvas.width; },  
 35792: () => { return screen.width; },  
 35817: () => { document.exitFullscreen(); },  
 35844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35977: () => { return window.innerWidth; },  
 36003: () => { return window.innerHeight; },  
 36030: () => { if (document.fullscreenElement) return 1; },  
 36076: () => { return Module.canvas.width; },  
 36108: () => { return parseInt(Module.canvas.style.width); },  
 36156: () => { if (document.fullscreenElement) return 1; },  
 36202: () => { return Module.canvas.width; },  
 36234: () => { return screen.width; },  
 36259: () => { return window.innerWidth; },  
 36285: () => { return window.innerHeight; },  
 36312: () => { if (document.fullscreenElement) return 1; },  
 36358: () => { return Module.canvas.width; },  
 36390: () => { return screen.width; },  
 36415: () => { document.exitFullscreen(); },  
 36442: () => { if (document.fullscreenElement) return 1; },  
 36488: () => { return Module.canvas.width; },  
 36520: () => { return parseInt(Module.canvas.style.width); },  
 36568: () => { document.exitFullscreen(); },  
 36595: ($0) => { Module.canvas.style.opacity = $0; },  
 36633: () => { return screen.width; },  
 36658: () => { return screen.height; },  
 36684: () => { return window.screenX; },  
 36711: () => { return window.screenY; },  
 36738: () => { return window.devicePixelRatio; },  
 36774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 36827: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 36878: () => { Module.canvas.style.cursor = 'none'; },  
 36915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37222: () => { if (document.fullscreenElement) return 1; },  
 37268: () => { return window.innerWidth; },  
 37294: () => { return window.innerHeight; },  
 37321: () => { if (document.pointerLockElement) return 1; }
};
