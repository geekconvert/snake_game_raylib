...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgbf3se_4.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_npatch_drawing.data';
      var REMOTE_PACKAGE_BASE = 'textures_npatch_drawing.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_npatch_drawing.data');

      };
      Module['addRunDependency']('datafile_textures_npatch_drawing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgbf3se_4.js
...
function findWasmBinary() {
    return locateFile('textures_npatch_drawing.wasm');
}
...
var ASM_CONSTS = {
 ...
 30510: () => { return Module.canvas.width; },  
 30542: () => { return parseInt(Module.canvas.style.width); },  
 30590: () => { document.exitFullscreen(); },  
 30617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30690: () => { if (document.fullscreenElement) return 1; },  
 30736: () => { return Module.canvas.width; },  
 30768: () => { return screen.width; },  
 30793: () => { document.exitFullscreen(); },  
 30820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30953: () => { return window.innerWidth; },  
 30979: () => { return window.innerHeight; },  
 31006: () => { if (document.fullscreenElement) return 1; },  
 31052: () => { return Module.canvas.width; },  
 31084: () => { return parseInt(Module.canvas.style.width); },  
 31132: () => { if (document.fullscreenElement) return 1; },  
 31178: () => { return Module.canvas.width; },  
 31210: () => { return screen.width; },  
 31235: () => { return window.innerWidth; },  
 31261: () => { return window.innerHeight; },  
 31288: () => { if (document.fullscreenElement) return 1; },  
 31334: () => { return Module.canvas.width; },  
 31366: () => { return screen.width; },  
 31391: () => { document.exitFullscreen(); },  
 31418: () => { if (document.fullscreenElement) return 1; },  
 31464: () => { return Module.canvas.width; },  
 31496: () => { return parseInt(Module.canvas.style.width); },  
 31544: () => { document.exitFullscreen(); },  
 31571: ($0) => { Module.canvas.style.opacity = $0; },  
 31609: () => { return screen.width; },  
 31634: () => { return screen.height; },  
 31660: () => { return window.screenX; },  
 31687: () => { return window.screenY; },  
 31714: () => { return window.devicePixelRatio; },  
 31750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31803: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31854: () => { Module.canvas.style.cursor = 'none'; },  
 31891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32147: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32198: () => { if (document.fullscreenElement) return 1; },  
 32244: () => { return window.innerWidth; },  
 32270: () => { return window.innerHeight; },  
 32297: () => { if (document.pointerLockElement) return 1; }
};
