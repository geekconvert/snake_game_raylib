...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpindipjve.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_geometric_shapes.data';
      var REMOTE_PACKAGE_BASE = 'models_geometric_shapes.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_geometric_shapes.data');

      };
      Module['addRunDependency']('datafile_models_geometric_shapes.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpindipjve.js
...
function findWasmBinary() {
    return locateFile('models_geometric_shapes.wasm');
}
...
var ASM_CONSTS = {
  26536: () => { if (document.fullscreenElement) return 1; },  
 26582: () => { return Module.canvas.width; },  
 26614: () => { return parseInt(Module.canvas.style.width); },  
 26662: () => { document.exitFullscreen(); },  
 26689: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26762: () => { if (document.fullscreenElement) return 1; },  
 26808: () => { return Module.canvas.width; },  
 26840: () => { return screen.width; },  
 26865: () => { document.exitFullscreen(); },  
 26892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27025: () => { return window.innerWidth; },  
 27051: () => { return window.innerHeight; },  
 27078: () => { if (document.fullscreenElement) return 1; },  
 27124: () => { return Module.canvas.width; },  
 27156: () => { return parseInt(Module.canvas.style.width); },  
 27204: () => { if (document.fullscreenElement) return 1; },  
 27250: () => { return Module.canvas.width; },  
 27282: () => { return screen.width; },  
 27307: () => { return window.innerWidth; },  
 27333: () => { return window.innerHeight; },  
 27360: () => { if (document.fullscreenElement) return 1; },  
 27406: () => { return Module.canvas.width; },  
 27438: () => { return screen.width; },  
 27463: () => { document.exitFullscreen(); },  
 27490: () => { if (document.fullscreenElement) return 1; },  
 27536: () => { return Module.canvas.width; },  
 27568: () => { return parseInt(Module.canvas.style.width); },  
 27616: () => { document.exitFullscreen(); },  
 27643: ($0) => { Module.canvas.style.opacity = $0; },  
 27681: () => { return screen.width; },  
 27706: () => { return screen.height; },  
 27732: () => { return window.screenX; },  
 27759: () => { return window.screenY; },  
 27786: () => { return window.devicePixelRatio; },  
 27822: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27875: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27926: () => { Module.canvas.style.cursor = 'none'; },  
 27963: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28219: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28270: () => { if (document.fullscreenElement) return 1; },  
 28316: () => { return window.innerWidth; },  
 28342: () => { return window.innerHeight; },  
 28369: () => { if (document.pointerLockElement) return 1; }
};
