...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_7bbvsll.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_font_filters.data';
      var REMOTE_PACKAGE_BASE = 'text_font_filters.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_font_filters.data');

      };
      Module['addRunDependency']('datafile_text_font_filters.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp_7bbvsll.js
...
function findWasmBinary() {
    return locateFile('text_font_filters.wasm');
}
...
var ASM_CONSTS = {
  39600: () => { if (document.fullscreenElement) return 1; },  
 39646: () => { return Module.canvas.width; },  
 39678: () => { return parseInt(Module.canvas.style.width); },  
 39726: () => { document.exitFullscreen(); },  
 39753: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 39826: () => { if (document.fullscreenElement) return 1; },  
 39872: () => { return Module.canvas.width; },  
 39904: () => { return screen.width; },  
 39929: () => { document.exitFullscreen(); },  
 39956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 40089: () => { return window.innerWidth; },  
 40115: () => { return window.innerHeight; },  
 40142: () => { if (document.fullscreenElement) return 1; },  
 40188: () => { return Module.canvas.width; },  
 40220: () => { return parseInt(Module.canvas.style.width); },  
 40268: () => { if (document.fullscreenElement) return 1; },  
 40314: () => { return Module.canvas.width; },  
 40346: () => { return screen.width; },  
 40371: () => { return window.innerWidth; },  
 40397: () => { return window.innerHeight; },  
 40424: () => { if (document.fullscreenElement) return 1; },  
 40470: () => { return Module.canvas.width; },  
 40502: () => { return screen.width; },  
 40527: () => { document.exitFullscreen(); },  
 40554: () => { if (document.fullscreenElement) return 1; },  
 40600: () => { return Module.canvas.width; },  
 40632: () => { return parseInt(Module.canvas.style.width); },  
 40680: () => { document.exitFullscreen(); },  
 40707: ($0) => { Module.canvas.style.opacity = $0; },  
 40745: () => { return screen.width; },  
 40770: () => { return screen.height; },  
 40796: () => { return window.screenX; },  
 40823: () => { return window.screenY; },  
 40850: () => { return window.devicePixelRatio; },  
 40886: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 40939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 40990: () => { Module.canvas.style.cursor = 'none'; },  
 41027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 41283: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 41334: () => { if (document.fullscreenElement) return 1; },  
 41380: () => { return window.innerWidth; },  
 41406: () => { return window.innerHeight; },  
 41433: () => { if (document.pointerLockElement) return 1; }
};
