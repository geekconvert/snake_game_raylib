...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl90l54oq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_hybrid_render.data';
      var REMOTE_PACKAGE_BASE = 'shaders_hybrid_render.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_hybrid_render.data');

      };
      Module['addRunDependency']('datafile_shaders_hybrid_render.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpl90l54oq.js
...
function findWasmBinary() {
    return locateFile('shaders_hybrid_render.wasm');
}
...
var ASM_CONSTS = {
  27464: () => { if (document.fullscreenElement) return 1; },  
 27510: () => { return Module.canvas.width; },  
 27542: () => { return parseInt(Module.canvas.style.width); },  
 27590: () => { document.exitFullscreen(); },  
 27617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27690: () => { if (document.fullscreenElement) return 1; },  
 27736: () => { return Module.canvas.width; },  
 27768: () => { return screen.width; },  
 27793: () => { document.exitFullscreen(); },  
 27820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27953: () => { return window.innerWidth; },  
 27979: () => { return window.innerHeight; },  
 28006: () => { if (document.fullscreenElement) return 1; },  
 28052: () => { return Module.canvas.width; },  
 28084: () => { return parseInt(Module.canvas.style.width); },  
 28132: () => { if (document.fullscreenElement) return 1; },  
 28178: () => { return Module.canvas.width; },  
 28210: () => { return screen.width; },  
 28235: () => { return window.innerWidth; },  
 28261: () => { return window.innerHeight; },  
 28288: () => { if (document.fullscreenElement) return 1; },  
 28334: () => { return Module.canvas.width; },  
 28366: () => { return screen.width; },  
 28391: () => { document.exitFullscreen(); },  
 28418: () => { if (document.fullscreenElement) return 1; },  
 28464: () => { return Module.canvas.width; },  
 28496: () => { return parseInt(Module.canvas.style.width); },  
 28544: () => { document.exitFullscreen(); },  
 28571: ($0) => { Module.canvas.style.opacity = $0; },  
 28609: () => { return screen.width; },  
 28634: () => { return screen.height; },  
 28660: () => { return window.screenX; },  
 28687: () => { return window.screenY; },  
 28714: () => { return window.devicePixelRatio; },  
 28750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28803: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28854: () => { Module.canvas.style.cursor = 'none'; },  
 28891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29147: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29198: () => { if (document.fullscreenElement) return 1; },  
 29244: () => { return window.innerWidth; },  
 29270: () => { return window.innerHeight; },  
 29297: () => { if (document.pointerLockElement) return 1; }
};
