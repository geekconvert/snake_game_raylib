...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpoitd6_vg.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_rectangle_scaling.data';
      var REMOTE_PACKAGE_BASE = 'shapes_rectangle_scaling.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_rectangle_scaling.data');

      };
      Module['addRunDependency']('datafile_shapes_rectangle_scaling.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpoitd6_vg.js
...
function findWasmBinary() {
    return locateFile('shapes_rectangle_scaling.wasm');
}
...
var ASM_CONSTS = {
  26352: () => { if (document.fullscreenElement) return 1; },  
 26398: () => { return Module.canvas.width; },  
 26430: () => { return parseInt(Module.canvas.style.width); },  
 26478: () => { document.exitFullscreen(); },  
 26505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26578: () => { if (document.fullscreenElement) return 1; },  
 26624: () => { return Module.canvas.width; },  
 26656: () => { return screen.width; },  
 26681: () => { document.exitFullscreen(); },  
 26708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26841: () => { return window.innerWidth; },  
 26867: () => { return window.innerHeight; },  
 26894: () => { if (document.fullscreenElement) return 1; },  
 26940: () => { return Module.canvas.width; },  
 26972: () => { return parseInt(Module.canvas.style.width); },  
 27020: () => { if (document.fullscreenElement) return 1; },  
 27066: () => { return Module.canvas.width; },  
 27098: () => { return screen.width; },  
 27123: () => { return window.innerWidth; },  
 27149: () => { return window.innerHeight; },  
 27176: () => { if (document.fullscreenElement) return 1; },  
 27222: () => { return Module.canvas.width; },  
 27254: () => { return screen.width; },  
 27279: () => { document.exitFullscreen(); },  
 27306: () => { if (document.fullscreenElement) return 1; },  
 27352: () => { return Module.canvas.width; },  
 27384: () => { return parseInt(Module.canvas.style.width); },  
 27432: () => { document.exitFullscreen(); },  
 27459: ($0) => { Module.canvas.style.opacity = $0; },  
 27497: () => { return screen.width; },  
 27522: () => { return screen.height; },  
 27548: () => { return window.screenX; },  
 27575: () => { return window.screenY; },  
 27602: () => { return window.devicePixelRatio; },  
 27638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27742: () => { Module.canvas.style.cursor = 'none'; },  
 27779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28035: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28086: () => { if (document.fullscreenElement) return 1; },  
 28132: () => { return window.innerWidth; },  
 28158: () => { return window.innerHeight; },  
 28185: () => { if (document.pointerLockElement) return 1; }
};
