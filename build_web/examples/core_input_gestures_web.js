...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmplh7nch5o.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_input_gestures_web.data';
      var REMOTE_PACKAGE_BASE = 'core_input_gestures_web.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_input_gestures_web.data');

      };
      Module['addRunDependency']('datafile_core_input_gestures_web.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmplh7nch5o.js
...
function findWasmBinary() {
    return locateFile('core_input_gestures_web.wasm');
}
...
var ASM_CONSTS = {
  26720: () => { if (document.fullscreenElement) return 1; },  
 26766: () => { return Module.canvas.width; },  
 26798: () => { return parseInt(Module.canvas.style.width); },  
 26846: () => { document.exitFullscreen(); },  
 26873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26946: () => { if (document.fullscreenElement) return 1; },  
 26992: () => { return Module.canvas.width; },  
 27024: () => { return screen.width; },  
 27049: () => { document.exitFullscreen(); },  
 27076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27209: () => { return window.innerWidth; },  
 27235: () => { return window.innerHeight; },  
 27262: () => { if (document.fullscreenElement) return 1; },  
 27308: () => { return Module.canvas.width; },  
 27340: () => { return parseInt(Module.canvas.style.width); },  
 27388: () => { if (document.fullscreenElement) return 1; },  
 27434: () => { return Module.canvas.width; },  
 27466: () => { return screen.width; },  
 27491: () => { return window.innerWidth; },  
 27517: () => { return window.innerHeight; },  
 27544: () => { if (document.fullscreenElement) return 1; },  
 27590: () => { return Module.canvas.width; },  
 27622: () => { return screen.width; },  
 27647: () => { document.exitFullscreen(); },  
 27674: () => { if (document.fullscreenElement) return 1; },  
 27720: () => { return Module.canvas.width; },  
 27752: () => { return parseInt(Module.canvas.style.width); },  
 27800: () => { document.exitFullscreen(); },  
 27827: ($0) => { Module.canvas.style.opacity = $0; },  
 27865: () => { return screen.width; },  
 27890: () => { return screen.height; },  
 27916: () => { return window.screenX; },  
 27943: () => { return window.screenY; },  
 27970: () => { return window.devicePixelRatio; },  
 28006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28059: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28110: () => { Module.canvas.style.cursor = 'none'; },  
 28147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28403: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28454: () => { if (document.fullscreenElement) return 1; },  
 28500: () => { return window.innerWidth; },  
 28526: () => { return window.innerHeight; },  
 28553: () => { if (document.pointerLockElement) return 1; }
};
