...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpbgyyolks.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_skybox.data';
      var REMOTE_PACKAGE_BASE = 'models_skybox.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_skybox.data');

      };
      Module['addRunDependency']('datafile_models_skybox.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpbgyyolks.js
...
function findWasmBinary() {
    return locateFile('models_skybox.wasm');
}
...
var ASM_CONSTS = {
  38072: () => { if (document.fullscreenElement) return 1; },  
 38118: () => { return Module.canvas.width; },  
 38150: () => { return parseInt(Module.canvas.style.width); },  
 38198: () => { document.exitFullscreen(); },  
 38225: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 38298: () => { if (document.fullscreenElement) return 1; },  
 38344: () => { return Module.canvas.width; },  
 38376: () => { return screen.width; },  
 38401: () => { document.exitFullscreen(); },  
 38428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 38561: () => { return window.innerWidth; },  
 38587: () => { return window.innerHeight; },  
 38614: () => { if (document.fullscreenElement) return 1; },  
 38660: () => { return Module.canvas.width; },  
 38692: () => { return parseInt(Module.canvas.style.width); },  
 38740: () => { if (document.fullscreenElement) return 1; },  
 38786: () => { return Module.canvas.width; },  
 38818: () => { return screen.width; },  
 38843: () => { return window.innerWidth; },  
 38869: () => { return window.innerHeight; },  
 38896: () => { if (document.fullscreenElement) return 1; },  
 38942: () => { return Module.canvas.width; },  
 38974: () => { return screen.width; },  
 38999: () => { document.exitFullscreen(); },  
 39026: () => { if (document.fullscreenElement) return 1; },  
 39072: () => { return Module.canvas.width; },  
 39104: () => { return parseInt(Module.canvas.style.width); },  
 39152: () => { document.exitFullscreen(); },  
 39179: ($0) => { Module.canvas.style.opacity = $0; },  
 39217: () => { return screen.width; },  
 39242: () => { return screen.height; },  
 39268: () => { return window.screenX; },  
 39295: () => { return window.screenY; },  
 39322: () => { return window.devicePixelRatio; },  
 39358: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 39411: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 39462: () => { Module.canvas.style.cursor = 'none'; },  
 39499: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 39755: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 39806: () => { if (document.fullscreenElement) return 1; },  
 39852: () => { return window.innerWidth; },  
 39878: () => { return window.innerHeight; },  
 39905: () => { if (document.pointerLockElement) return 1; }
};
