...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp7ue4uqjh.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_loading_gltf.data';
      var REMOTE_PACKAGE_BASE = 'models_loading_gltf.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_loading_gltf.data');

      };
      Module['addRunDependency']('datafile_models_loading_gltf.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp7ue4uqjh.js
...
function findWasmBinary() {
    return locateFile('models_loading_gltf.wasm');
}
...
var ASM_CONSTS = {
  41176: () => { if (document.fullscreenElement) return 1; },  
 41222: () => { return Module.canvas.width; },  
 41254: () => { return parseInt(Module.canvas.style.width); },  
 41302: () => { document.exitFullscreen(); },  
 41329: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41402: () => { if (document.fullscreenElement) return 1; },  
 41448: () => { return Module.canvas.width; },  
 41480: () => { return screen.width; },  
 41505: () => { document.exitFullscreen(); },  
 41532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41665: () => { return window.innerWidth; },  
 41691: () => { return window.innerHeight; },  
 41718: () => { if (document.fullscreenElement) return 1; },  
 41764: () => { return Module.canvas.width; },  
 41796: () => { return parseInt(Module.canvas.style.width); },  
 41844: () => { if (document.fullscreenElement) return 1; },  
 41890: () => { return Module.canvas.width; },  
 41922: () => { return screen.width; },  
 41947: () => { return window.innerWidth; },  
 41973: () => { return window.innerHeight; },  
 42000: () => { if (document.fullscreenElement) return 1; },  
 42046: () => { return Module.canvas.width; },  
 42078: () => { return screen.width; },  
 42103: () => { document.exitFullscreen(); },  
 42130: () => { if (document.fullscreenElement) return 1; },  
 42176: () => { return Module.canvas.width; },  
 42208: () => { return parseInt(Module.canvas.style.width); },  
 42256: () => { document.exitFullscreen(); },  
 42283: ($0) => { Module.canvas.style.opacity = $0; },  
 42321: () => { return screen.width; },  
 42346: () => { return screen.height; },  
 42372: () => { return window.screenX; },  
 42399: () => { return window.screenY; },  
 42426: () => { return window.devicePixelRatio; },  
 42462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42515: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42566: () => { Module.canvas.style.cursor = 'none'; },  
 42603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42859: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42910: () => { if (document.fullscreenElement) return 1; },  
 42956: () => { return window.innerWidth; },  
 42982: () => { return window.innerHeight; },  
 43009: () => { if (document.pointerLockElement) return 1; }
};
