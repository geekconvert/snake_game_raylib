...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx7s38oa0.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_following_eyes.data';
      var REMOTE_PACKAGE_BASE = 'shapes_following_eyes.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_following_eyes.data');

      };
      Module['addRunDependency']('datafile_shapes_following_eyes.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx7s38oa0.js
...
function findWasmBinary() {
    return locateFile('shapes_following_eyes.wasm');
}
...
var ASM_CONSTS = {
  26272: () => { if (document.fullscreenElement) return 1; },  
 26318: () => { return Module.canvas.width; },  
 26350: () => { return parseInt(Module.canvas.style.width); },  
 26398: () => { document.exitFullscreen(); },  
 26425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26498: () => { if (document.fullscreenElement) return 1; },  
 26544: () => { return Module.canvas.width; },  
 26576: () => { return screen.width; },  
 26601: () => { document.exitFullscreen(); },  
 26628: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26761: () => { return window.innerWidth; },  
 26787: () => { return window.innerHeight; },  
 26814: () => { if (document.fullscreenElement) return 1; },  
 26860: () => { return Module.canvas.width; },  
 26892: () => { return parseInt(Module.canvas.style.width); },  
 26940: () => { if (document.fullscreenElement) return 1; },  
 26986: () => { return Module.canvas.width; },  
 27018: () => { return screen.width; },  
 27043: () => { return window.innerWidth; },  
 27069: () => { return window.innerHeight; },  
 27096: () => { if (document.fullscreenElement) return 1; },  
 27142: () => { return Module.canvas.width; },  
 27174: () => { return screen.width; },  
 27199: () => { document.exitFullscreen(); },  
 27226: () => { if (document.fullscreenElement) return 1; },  
 27272: () => { return Module.canvas.width; },  
 27304: () => { return parseInt(Module.canvas.style.width); },  
 27352: () => { document.exitFullscreen(); },  
 27379: ($0) => { Module.canvas.style.opacity = $0; },  
 27417: () => { return screen.width; },  
 27442: () => { return screen.height; },  
 27468: () => { return window.screenX; },  
 27495: () => { return window.screenY; },  
 27522: () => { return window.devicePixelRatio; },  
 27558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27611: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27662: () => { Module.canvas.style.cursor = 'none'; },  
 27699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 27955: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28006: () => { if (document.fullscreenElement) return 1; },  
 28052: () => { return window.innerWidth; },  
 28078: () => { return window.innerHeight; },  
 28105: () => { if (document.pointerLockElement) return 1; }
};
