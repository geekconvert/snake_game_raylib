...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph_i2_lpy.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_mesh_instancing.data';
      var REMOTE_PACKAGE_BASE = 'shaders_mesh_instancing.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_mesh_instancing.data');

      };
      Module['addRunDependency']('datafile_shaders_mesh_instancing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmph_i2_lpy.js
...
function findWasmBinary() {
    return locateFile('shaders_mesh_instancing.wasm');
}
...
var ASM_CONSTS = {
  27896: () => { if (document.fullscreenElement) return 1; },  
 27942: () => { return Module.canvas.width; },  
 27974: () => { return parseInt(Module.canvas.style.width); },  
 28022: () => { document.exitFullscreen(); },  
 28049: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 28122: () => { if (document.fullscreenElement) return 1; },  
 28168: () => { return Module.canvas.width; },  
 28200: () => { return screen.width; },  
 28225: () => { document.exitFullscreen(); },  
 28252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28385: () => { return window.innerWidth; },  
 28411: () => { return window.innerHeight; },  
 28438: () => { if (document.fullscreenElement) return 1; },  
 28484: () => { return Module.canvas.width; },  
 28516: () => { return parseInt(Module.canvas.style.width); },  
 28564: () => { if (document.fullscreenElement) return 1; },  
 28610: () => { return Module.canvas.width; },  
 28642: () => { return screen.width; },  
 28667: () => { return window.innerWidth; },  
 28693: () => { return window.innerHeight; },  
 28720: () => { if (document.fullscreenElement) return 1; },  
 28766: () => { return Module.canvas.width; },  
 28798: () => { return screen.width; },  
 28823: () => { document.exitFullscreen(); },  
 28850: () => { if (document.fullscreenElement) return 1; },  
 28896: () => { return Module.canvas.width; },  
 28928: () => { return parseInt(Module.canvas.style.width); },  
 28976: () => { document.exitFullscreen(); },  
 29003: ($0) => { Module.canvas.style.opacity = $0; },  
 29041: () => { return screen.width; },  
 29066: () => { return screen.height; },  
 29092: () => { return window.screenX; },  
 29119: () => { return window.screenY; },  
 29146: () => { return window.devicePixelRatio; },  
 29182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 29235: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29286: () => { Module.canvas.style.cursor = 'none'; },  
 29323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29579: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29630: () => { if (document.fullscreenElement) return 1; },  
 29676: () => { return window.innerWidth; },  
 29702: () => { return window.innerHeight; },  
 29729: () => { if (document.pointerLockElement) return 1; }
};
