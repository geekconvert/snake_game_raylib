...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpit8wxr8o.js
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpit8wxr8o.js
...
function findWasmBinary() {
    return locateFile('textures_raw_data.wasm');
}
...
var ASM_CONSTS = {
  26656: () => { if (document.fullscreenElement) return 1; },  
 26702: () => { return Module.canvas.width; },  
 26734: () => { return parseInt(Module.canvas.style.width); },  
 26782: () => { document.exitFullscreen(); },  
 26809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26882: () => { if (document.fullscreenElement) return 1; },  
 26928: () => { return Module.canvas.width; },  
 26960: () => { return screen.width; },  
 26985: () => { document.exitFullscreen(); },  
 27012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27145: () => { return window.innerWidth; },  
 27171: () => { return window.innerHeight; },  
 27198: () => { if (document.fullscreenElement) return 1; },  
 27244: () => { return Module.canvas.width; },  
 27276: () => { return parseInt(Module.canvas.style.width); },  
 27324: () => { if (document.fullscreenElement) return 1; },  
 27370: () => { return Module.canvas.width; },  
 27402: () => { return screen.width; },  
 27427: () => { return window.innerWidth; },  
 27453: () => { return window.innerHeight; },  
 27480: () => { if (document.fullscreenElement) return 1; },  
 27526: () => { return Module.canvas.width; },  
 27558: () => { return screen.width; },  
 27583: () => { document.exitFullscreen(); },  
 27610: () => { if (document.fullscreenElement) return 1; },  
 27656: () => { return Module.canvas.width; },  
 27688: () => { return parseInt(Module.canvas.style.width); },  
 27736: () => { document.exitFullscreen(); },  
 27763: ($0) => { Module.canvas.style.opacity = $0; },  
 27801: () => { return screen.width; },  
 27826: () => { return screen.height; },  
 27852: () => { return window.screenX; },  
 27879: () => { return window.screenY; },  
 27906: () => { return window.devicePixelRatio; },  
 27942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27995: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28046: () => { Module.canvas.style.cursor = 'none'; },  
 28083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28339: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28390: () => { if (document.fullscreenElement) return 1; },  
 28436: () => { return window.innerWidth; },  
 28462: () => { return window.innerHeight; },  
 28489: () => { if (document.pointerLockElement) return 1; }
};
