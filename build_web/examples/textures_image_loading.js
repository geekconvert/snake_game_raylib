...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgv54_fyj.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_loading.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_loading.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_loading.data');

      };
      Module['addRunDependency']('datafile_textures_image_loading.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpgv54_fyj.js
...
function findWasmBinary() {
    return locateFile('textures_image_loading.wasm');
}
...
var ASM_CONSTS = {
  30224: () => { if (document.fullscreenElement) return 1; },  
 30270: () => { return Module.canvas.width; },  
 30302: () => { return parseInt(Module.canvas.style.width); },  
 30350: () => { document.exitFullscreen(); },  
 30377: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30450: () => { if (document.fullscreenElement) return 1; },  
 30496: () => { return Module.canvas.width; },  
 30528: () => { return screen.width; },  
 30553: () => { document.exitFullscreen(); },  
 30580: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30713: () => { return window.innerWidth; },  
 30739: () => { return window.innerHeight; },  
 30766: () => { if (document.fullscreenElement) return 1; },  
 30812: () => { return Module.canvas.width; },  
 30844: () => { return parseInt(Module.canvas.style.width); },  
 30892: () => { if (document.fullscreenElement) return 1; },  
 30938: () => { return Module.canvas.width; },  
 30970: () => { return screen.width; },  
 30995: () => { return window.innerWidth; },  
 31021: () => { return window.innerHeight; },  
 31048: () => { if (document.fullscreenElement) return 1; },  
 31094: () => { return Module.canvas.width; },  
 31126: () => { return screen.width; },  
 31151: () => { document.exitFullscreen(); },  
 31178: () => { if (document.fullscreenElement) return 1; },  
 31224: () => { return Module.canvas.width; },  
 31256: () => { return parseInt(Module.canvas.style.width); },  
 31304: () => { document.exitFullscreen(); },  
 31331: ($0) => { Module.canvas.style.opacity = $0; },  
 31369: () => { return screen.width; },  
 31394: () => { return screen.height; },  
 31420: () => { return window.screenX; },  
 31447: () => { return window.screenY; },  
 31474: () => { return window.devicePixelRatio; },  
 31510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31563: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31614: () => { Module.canvas.style.cursor = 'none'; },  
 31651: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31907: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31958: () => { if (document.fullscreenElement) return 1; },  
 32004: () => { return window.innerWidth; },  
 32030: () => { return window.innerHeight; },  
 32057: () => { if (document.pointerLockElement) return 1; }
};
