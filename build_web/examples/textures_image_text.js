...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp66qsblna.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_text.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_text.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_text.data');

      };
      Module['addRunDependency']('datafile_textures_image_text.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp66qsblna.js
...
function findWasmBinary() {
    return locateFile('textures_image_text.wasm');
}
...
var ASM_CONSTS = {
 ...
 44334: () => { return Module.canvas.width; },  
 44366: () => { return parseInt(Module.canvas.style.width); },  
 44414: () => { document.exitFullscreen(); },  
 44441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 44514: () => { if (document.fullscreenElement) return 1; },  
 44560: () => { return Module.canvas.width; },  
 44592: () => { return screen.width; },  
 44617: () => { document.exitFullscreen(); },  
 44644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 44777: () => { return window.innerWidth; },  
 44803: () => { return window.innerHeight; },  
 44830: () => { if (document.fullscreenElement) return 1; },  
 44876: () => { return Module.canvas.width; },  
 44908: () => { return parseInt(Module.canvas.style.width); },  
 44956: () => { if (document.fullscreenElement) return 1; },  
 45002: () => { return Module.canvas.width; },  
 45034: () => { return screen.width; },  
 45059: () => { return window.innerWidth; },  
 45085: () => { return window.innerHeight; },  
 45112: () => { if (document.fullscreenElement) return 1; },  
 45158: () => { return Module.canvas.width; },  
 45190: () => { return screen.width; },  
 45215: () => { document.exitFullscreen(); },  
 45242: () => { if (document.fullscreenElement) return 1; },  
 45288: () => { return Module.canvas.width; },  
 45320: () => { return parseInt(Module.canvas.style.width); },  
 45368: () => { document.exitFullscreen(); },  
 45395: ($0) => { Module.canvas.style.opacity = $0; },  
 45433: () => { return screen.width; },  
 45458: () => { return screen.height; },  
 45484: () => { return window.screenX; },  
 45511: () => { return window.screenY; },  
 45538: () => { return window.devicePixelRatio; },  
 45574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 45627: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 45678: () => { Module.canvas.style.cursor = 'none'; },  
 45715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 45971: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 46022: () => { if (document.fullscreenElement) return 1; },  
 46068: () => { return window.innerWidth; },  
 46094: () => { return window.innerHeight; },  
 46121: () => { if (document.pointerLockElement) return 1; }
};
