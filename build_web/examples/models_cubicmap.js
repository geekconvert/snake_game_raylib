...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpzt9yfwhd.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_cubicmap.data';
      var REMOTE_PACKAGE_BASE = 'models_cubicmap.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_cubicmap.data');

      };
      Module['addRunDependency']('datafile_models_cubicmap.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpzt9yfwhd.js
...
function findWasmBinary() {
    return locateFile('models_cubicmap.wasm');
}
...
var ASM_CONSTS = {
  31144: () => { if (document.fullscreenElement) return 1; },  
 31190: () => { return Module.canvas.width; },  
 31222: () => { return parseInt(Module.canvas.style.width); },  
 31270: () => { document.exitFullscreen(); },  
 31297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31370: () => { if (document.fullscreenElement) return 1; },  
 31416: () => { return Module.canvas.width; },  
 31448: () => { return screen.width; },  
 31473: () => { document.exitFullscreen(); },  
 31500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31633: () => { return window.innerWidth; },  
 31659: () => { return window.innerHeight; },  
 31686: () => { if (document.fullscreenElement) return 1; },  
 31732: () => { return Module.canvas.width; },  
 31764: () => { return parseInt(Module.canvas.style.width); },  
 31812: () => { if (document.fullscreenElement) return 1; },  
 31858: () => { return Module.canvas.width; },  
 31890: () => { return screen.width; },  
 31915: () => { return window.innerWidth; },  
 31941: () => { return window.innerHeight; },  
 31968: () => { if (document.fullscreenElement) return 1; },  
 32014: () => { return Module.canvas.width; },  
 32046: () => { return screen.width; },  
 32071: () => { document.exitFullscreen(); },  
 32098: () => { if (document.fullscreenElement) return 1; },  
 32144: () => { return Module.canvas.width; },  
 32176: () => { return parseInt(Module.canvas.style.width); },  
 32224: () => { document.exitFullscreen(); },  
 32251: ($0) => { Module.canvas.style.opacity = $0; },  
 32289: () => { return screen.width; },  
 32314: () => { return screen.height; },  
 32340: () => { return window.screenX; },  
 32367: () => { return window.screenY; },  
 32394: () => { return window.devicePixelRatio; },  
 32430: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32483: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32534: () => { Module.canvas.style.cursor = 'none'; },  
 32571: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32827: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32878: () => { if (document.fullscreenElement) return 1; },  
 32924: () => { return window.innerWidth; },  
 32950: () => { return window.innerHeight; },  
 32977: () => { if (document.pointerLockElement) return 1; }
};
