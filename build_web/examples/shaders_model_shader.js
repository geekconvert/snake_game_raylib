...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx737nfj2.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_model_shader.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_model_shader.data');

      };
      Module['addRunDependency']('datafile_shaders_model_shader.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx737nfj2.js
...
function findWasmBinary() {
    return locateFile('shaders_model_shader.wasm');
}
...
var ASM_CONSTS = {
  40904: () => { if (document.fullscreenElement) return 1; },  
 40950: () => { return Module.canvas.width; },  
 40982: () => { return parseInt(Module.canvas.style.width); },  
 41030: () => { document.exitFullscreen(); },  
 41057: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41130: () => { if (document.fullscreenElement) return 1; },  
 41176: () => { return Module.canvas.width; },  
 41208: () => { return screen.width; },  
 41233: () => { document.exitFullscreen(); },  
 41260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41393: () => { return window.innerWidth; },  
 41419: () => { return window.innerHeight; },  
 41446: () => { if (document.fullscreenElement) return 1; },  
 41492: () => { return Module.canvas.width; },  
 41524: () => { return parseInt(Module.canvas.style.width); },  
 41572: () => { if (document.fullscreenElement) return 1; },  
 41618: () => { return Module.canvas.width; },  
 41650: () => { return screen.width; },  
 41675: () => { return window.innerWidth; },  
 41701: () => { return window.innerHeight; },  
 41728: () => { if (document.fullscreenElement) return 1; },  
 41774: () => { return Module.canvas.width; },  
 41806: () => { return screen.width; },  
 41831: () => { document.exitFullscreen(); },  
 41858: () => { if (document.fullscreenElement) return 1; },  
 41904: () => { return Module.canvas.width; },  
 41936: () => { return parseInt(Module.canvas.style.width); },  
 41984: () => { document.exitFullscreen(); },  
 42011: ($0) => { Module.canvas.style.opacity = $0; },  
 42049: () => { return screen.width; },  
 42074: () => { return screen.height; },  
 42100: () => { return window.screenX; },  
 42127: () => { return window.screenY; },  
 42154: () => { return window.devicePixelRatio; },  
 42190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42243: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42294: () => { Module.canvas.style.cursor = 'none'; },  
 42331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42587: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42638: () => { if (document.fullscreenElement) return 1; },  
 42684: () => { return window.innerWidth; },  
 42710: () => { return window.innerHeight; },  
 42737: () => { if (document.pointerLockElement) return 1; }
};
