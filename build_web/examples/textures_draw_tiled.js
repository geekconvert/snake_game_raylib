...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpivl4yn_l.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_draw_tiled.data';
      var REMOTE_PACKAGE_BASE = 'textures_draw_tiled.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_draw_tiled.data');

      };
      Module['addRunDependency']('datafile_textures_draw_tiled.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpivl4yn_l.js
...
function findWasmBinary() {
    return locateFile('textures_draw_tiled.wasm');
}
...
var ASM_CONSTS = {
  30800: () => { if (document.fullscreenElement) return 1; },  
 30846: () => { return Module.canvas.width; },  
 30878: () => { return parseInt(Module.canvas.style.width); },  
 30926: () => { document.exitFullscreen(); },  
 30953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 31026: () => { if (document.fullscreenElement) return 1; },  
 31072: () => { return Module.canvas.width; },  
 31104: () => { return screen.width; },  
 31129: () => { document.exitFullscreen(); },  
 31156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31289: () => { return window.innerWidth; },  
 31315: () => { return window.innerHeight; },  
 31342: () => { if (document.fullscreenElement) return 1; },  
 31388: () => { return Module.canvas.width; },  
 31420: () => { return parseInt(Module.canvas.style.width); },  
 31468: () => { if (document.fullscreenElement) return 1; },  
 31514: () => { return Module.canvas.width; },  
 31546: () => { return screen.width; },  
 31571: () => { return window.innerWidth; },  
 31597: () => { return window.innerHeight; },  
 31624: () => { if (document.fullscreenElement) return 1; },  
 31670: () => { return Module.canvas.width; },  
 31702: () => { return screen.width; },  
 31727: () => { document.exitFullscreen(); },  
 31754: () => { if (document.fullscreenElement) return 1; },  
 31800: () => { return Module.canvas.width; },  
 31832: () => { return parseInt(Module.canvas.style.width); },  
 31880: () => { document.exitFullscreen(); },  
 31907: ($0) => { Module.canvas.style.opacity = $0; },  
 31945: () => { return screen.width; },  
 31970: () => { return screen.height; },  
 31996: () => { return window.screenX; },  
 32023: () => { return window.screenY; },  
 32050: () => { return window.devicePixelRatio; },  
 32086: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32139: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32190: () => { Module.canvas.style.cursor = 'none'; },  
 32227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32483: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32534: () => { if (document.fullscreenElement) return 1; },  
 32580: () => { return window.innerWidth; },  
 32606: () => { return window.innerHeight; },  
 32633: () => { if (document.pointerLockElement) return 1; }
};
