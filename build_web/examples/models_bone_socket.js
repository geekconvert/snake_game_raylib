...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpteb3n5fb.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_bone_socket.data';
      var REMOTE_PACKAGE_BASE = 'models_bone_socket.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_bone_socket.data');

      };
      Module['addRunDependency']('datafile_models_bone_socket.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpteb3n5fb.js
...
function findWasmBinary() {
    return locateFile('models_bone_socket.wasm');
}
