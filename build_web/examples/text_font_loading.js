...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp6knf1uqq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_font_loading.data';
      var REMOTE_PACKAGE_BASE = 'text_font_loading.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_font_loading.data');

      };
      Module['addRunDependency']('datafile_text_font_loading.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp6knf1uqq.js
...
function findWasmBinary() {
    return locateFile('text_font_loading.wasm');
}
...
var ASM_CONSTS = {
  46032: () => { if (document.fullscreenElement) return 1; },  
 46078: () => { return Module.canvas.width; },  
 46110: () => { return parseInt(Module.canvas.style.width); },  
 46158: () => { document.exitFullscreen(); },  
 46185: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 46258: () => { if (document.fullscreenElement) return 1; },  
 46304: () => { return Module.canvas.width; },  
 46336: () => { return screen.width; },  
 46361: () => { document.exitFullscreen(); },  
 46388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 46521: () => { return window.innerWidth; },  
 46547: () => { return window.innerHeight; },  
 46574: () => { if (document.fullscreenElement) return 1; },  
 46620: () => { return Module.canvas.width; },  
 46652: () => { return parseInt(Module.canvas.style.width); },  
 46700: () => { if (document.fullscreenElement) return 1; },  
 46746: () => { return Module.canvas.width; },  
 46778: () => { return screen.width; },  
 46803: () => { return window.innerWidth; },  
 46829: () => { return window.innerHeight; },  
 46856: () => { if (document.fullscreenElement) return 1; },  
 46902: () => { return Module.canvas.width; },  
 46934: () => { return screen.width; },  
 46959: () => { document.exitFullscreen(); },  
 46986: () => { if (document.fullscreenElement) return 1; },  
 47032: () => { return Module.canvas.width; },  
 47064: () => { return parseInt(Module.canvas.style.width); },  
 47112: () => { document.exitFullscreen(); },  
 47139: ($0) => { Module.canvas.style.opacity = $0; },  
 47177: () => { return screen.width; },  
 47202: () => { return screen.height; },  
 47228: () => { return window.screenX; },  
 47255: () => { return window.screenY; },  
 47282: () => { return window.devicePixelRatio; },  
 47318: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 47371: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47422: () => { Module.canvas.style.cursor = 'none'; },  
 47459: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 47715: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47766: () => { if (document.fullscreenElement) return 1; },  
 47812: () => { return window.innerWidth; },  
 47838: () => { return window.innerHeight; },  
 47865: () => { if (document.pointerLockElement) return 1; }
};
