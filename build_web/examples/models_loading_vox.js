...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpk_j06xia.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'models_loading_vox.data';
      var REMOTE_PACKAGE_BASE = 'models_loading_vox.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_models_loading_vox.data');

      };
      Module['addRunDependency']('datafile_models_loading_vox.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpk_j06xia.js
...
function findWasmBinary() {
    return locateFile('models_loading_vox.wasm');
}
...
var ASM_CONSTS = {
  41080: () => { if (document.fullscreenElement) return 1; },  
 41126: () => { return Module.canvas.width; },  
 41158: () => { return parseInt(Module.canvas.style.width); },  
 41206: () => { document.exitFullscreen(); },  
 41233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41306: () => { if (document.fullscreenElement) return 1; },  
 41352: () => { return Module.canvas.width; },  
 41384: () => { return screen.width; },  
 41409: () => { document.exitFullscreen(); },  
 41436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41569: () => { return window.innerWidth; },  
 41595: () => { return window.innerHeight; },  
 41622: () => { if (document.fullscreenElement) return 1; },  
 41668: () => { return Module.canvas.width; },  
 41700: () => { return parseInt(Module.canvas.style.width); },  
 41748: () => { if (document.fullscreenElement) return 1; },  
 41794: () => { return Module.canvas.width; },  
 41826: () => { return screen.width; },  
 41851: () => { return window.innerWidth; },  
 41877: () => { return window.innerHeight; },  
 41904: () => { if (document.fullscreenElement) return 1; },  
 41950: () => { return Module.canvas.width; },  
 41982: () => { return screen.width; },  
 42007: () => { document.exitFullscreen(); },  
 42034: () => { if (document.fullscreenElement) return 1; },  
 42080: () => { return Module.canvas.width; },  
 42112: () => { return parseInt(Module.canvas.style.width); },  
 42160: () => { document.exitFullscreen(); },  
 42187: ($0) => { Module.canvas.style.opacity = $0; },  
 42225: () => { return screen.width; },  
 42250: () => { return screen.height; },  
 42276: () => { return window.screenX; },  
 42303: () => { return window.screenY; },  
 42330: () => { return window.devicePixelRatio; },  
 42366: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42419: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42470: () => { Module.canvas.style.cursor = 'none'; },  
 42507: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42763: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 42814: () => { if (document.fullscreenElement) return 1; },  
 42860: () => { return window.innerWidth; },  
 42886: () => { return window.innerHeight; },  
 42913: () => { if (document.pointerLockElement) return 1; }
};
