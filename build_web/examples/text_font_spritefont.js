...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5jorcj2s.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'text_font_spritefont.data';
      var REMOTE_PACKAGE_BASE = 'text_font_spritefont.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_text_font_spritefont.data');

      };
      Module['addRunDependency']('datafile_text_font_spritefont.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5jorcj2s.js
...
function findWasmBinary() {
    return locateFile('text_font_spritefont.wasm');
}
...
var ASM_CONSTS = {
  45920: () => { if (document.fullscreenElement) return 1; },  
 45966: () => { return Module.canvas.width; },  
 45998: () => { return parseInt(Module.canvas.style.width); },  
 46046: () => { document.exitFullscreen(); },  
 46073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 46146: () => { if (document.fullscreenElement) return 1; },  
 46192: () => { return Module.canvas.width; },  
 46224: () => { return screen.width; },  
 46249: () => { document.exitFullscreen(); },  
 46276: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 46409: () => { return window.innerWidth; },  
 46435: () => { return window.innerHeight; },  
 46462: () => { if (document.fullscreenElement) return 1; },  
 46508: () => { return Module.canvas.width; },  
 46540: () => { return parseInt(Module.canvas.style.width); },  
 46588: () => { if (document.fullscreenElement) return 1; },  
 46634: () => { return Module.canvas.width; },  
 46666: () => { return screen.width; },  
 46691: () => { return window.innerWidth; },  
 46717: () => { return window.innerHeight; },  
 46744: () => { if (document.fullscreenElement) return 1; },  
 46790: () => { return Module.canvas.width; },  
 46822: () => { return screen.width; },  
 46847: () => { document.exitFullscreen(); },  
 46874: () => { if (document.fullscreenElement) return 1; },  
 46920: () => { return Module.canvas.width; },  
 46952: () => { return parseInt(Module.canvas.style.width); },  
 47000: () => { document.exitFullscreen(); },  
 47027: ($0) => { Module.canvas.style.opacity = $0; },  
 47065: () => { return screen.width; },  
 47090: () => { return screen.height; },  
 47116: () => { return window.screenX; },  
 47143: () => { return window.screenY; },  
 47170: () => { return window.devicePixelRatio; },  
 47206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 47259: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47310: () => { Module.canvas.style.cursor = 'none'; },  
 47347: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 47603: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47654: () => { if (document.fullscreenElement) return 1; },  
 47700: () => { return window.innerWidth; },  
 47726: () => { return window.innerHeight; },  
 47753: () => { if (document.pointerLockElement) return 1; }
};
