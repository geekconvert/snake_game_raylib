...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpi70bpw4j.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_srcrec_dstrec.data';
      var REMOTE_PACKAGE_BASE = 'textures_srcrec_dstrec.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_srcrec_dstrec.data');

      };
      Module['addRunDependency']('datafile_textures_srcrec_dstrec.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpi70bpw4j.js
...
function findWasmBinary() {
    return locateFile('textures_srcrec_dstrec.wasm');
}
...
var ASM_CONSTS = {
  30240: () => { if (document.fullscreenElement) return 1; },  
 30286: () => { return Module.canvas.width; },  
 30318: () => { return parseInt(Module.canvas.style.width); },  
 30366: () => { document.exitFullscreen(); },  
 30393: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30466: () => { if (document.fullscreenElement) return 1; },  
 30512: () => { return Module.canvas.width; },  
 30544: () => { return screen.width; },  
 30569: () => { document.exitFullscreen(); },  
 30596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30729: () => { return window.innerWidth; },  
 30755: () => { return window.innerHeight; },  
 30782: () => { if (document.fullscreenElement) return 1; },  
 30828: () => { return Module.canvas.width; },  
 30860: () => { return parseInt(Module.canvas.style.width); },  
 30908: () => { if (document.fullscreenElement) return 1; },  
 30954: () => { return Module.canvas.width; },  
 30986: () => { return screen.width; },  
 31011: () => { return window.innerWidth; },  
 31037: () => { return window.innerHeight; },  
 31064: () => { if (document.fullscreenElement) return 1; },  
 31110: () => { return Module.canvas.width; },  
 31142: () => { return screen.width; },  
 31167: () => { document.exitFullscreen(); },  
 31194: () => { if (document.fullscreenElement) return 1; },  
 31240: () => { return Module.canvas.width; },  
 31272: () => { return parseInt(Module.canvas.style.width); },  
 31320: () => { document.exitFullscreen(); },  
 31347: ($0) => { Module.canvas.style.opacity = $0; },  
 31385: () => { return screen.width; },  
 31410: () => { return screen.height; },  
 31436: () => { return window.screenX; },  
 31463: () => { return window.screenY; },  
 31490: () => { return window.devicePixelRatio; },  
 31526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31579: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31630: () => { Module.canvas.style.cursor = 'none'; },  
 31667: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31923: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 31974: () => { if (document.fullscreenElement) return 1; },  
 32020: () => { return window.innerWidth; },  
 32046: () => { return window.innerHeight; },  
 32073: () => { if (document.pointerLockElement) return 1; }
};
