...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpp5sp187h.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'audio_stream_effects.data';
      var REMOTE_PACKAGE_BASE = 'audio_stream_effects.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_audio_stream_effects.data');

      };
      Module['addRunDependency']('datafile_audio_stream_effects.data');
    ...
    loadPackage({"files": [{"filename": "/resources/LICENSE.md", "start": 0, "end": 1561}, {"filename": "/resources/coin.wav", "start": 1561, "end": 19675, "audio": 1}, {"filename": "/resources/country.mp3", "start": 19675, "end": 1517639, "audio": 1}, {"filename": "/resources/mini1111.xm", "start": 1517639, "end": 1543315}, {"filename": "/resources/sound.wav", "start": 1543315, "end": 1640827, "audio": 1}, {"filename": "/resources/spring.wav", "start": 1640827, "end": 1672089, "audio": 1}, {"filename": "/resources/target.flac", "start": 1672089, "end": 1729062}, {"filename": "/resources/target.ogg", "start": 1729062, "end": 1742446, "audio": 1}, {"filename": "/resources/target.qoa", "start": 1742446, "end": 1778094}, {"filename": "/resources/weird.wav", "start": 1778094, "end": 1802482, "audio": 1}], "remote_package_size": 1802482});

  })();

// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpp5sp187h.js
...
function findWasmBinary() {
    return locateFile('audio_stream_effects.wasm');
}
...
var ASM_CONSTS = {
  62504: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 64662: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 64826: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 64930: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 65101: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 67929: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 67995: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 68388: ($0) => { miniaudio.untrack_device_by_index($0); },  
 68431: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 68556: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 68682: () => { if (document.fullscreenElement) return 1; },  
 68728: () => { return Module.canvas.width; },  
 68760: () => { return parseInt(Module.canvas.style.width); },  
 68808: () => { document.exitFullscreen(); },  
 68835: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 68908: () => { if (document.fullscreenElement) return 1; },  
 68954: () => { return Module.canvas.width; },  
 68986: () => { return screen.width; },  
 69011: () => { document.exitFullscreen(); },  
 69038: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 69171: () => { return window.innerWidth; },  
 69197: () => { return window.innerHeight; },  
 69224: () => { if (document.fullscreenElement) return 1; },  
 69270: () => { return Module.canvas.width; },  
 69302: () => { return parseInt(Module.canvas.style.width); },  
 69350: () => { if (document.fullscreenElement) return 1; },  
 69396: () => { return Module.canvas.width; },  
 69428: () => { return screen.width; },  
 69453: () => { return window.innerWidth; },  
 69479: () => { return window.innerHeight; },  
 69506: () => { if (document.fullscreenElement) return 1; },  
 69552: () => { return Module.canvas.width; },  
 69584: () => { return screen.width; },  
 69609: () => { document.exitFullscreen(); },  
 69636: () => { if (document.fullscreenElement) return 1; },  
 69682: () => { return Module.canvas.width; },  
 69714: () => { return parseInt(Module.canvas.style.width); },  
 69762: () => { document.exitFullscreen(); },  
 69789: ($0) => { Module.canvas.style.opacity = $0; },  
 69827: () => { return screen.width; },  
 69852: () => { return screen.height; },  
 69878: () => { return window.screenX; },  
 69905: () => { return window.screenY; },  
 69932: () => { return window.devicePixelRatio; },  
 69968: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 70021: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 70072: () => { Module.canvas.style.cursor = 'none'; },  
 70109: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 70365: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 70416: () => { if (document.fullscreenElement) return 1; },  
 70462: () => { return window.innerWidth; },  
 70488: () => { return window.innerHeight; },  
 70515: () => { if (document.pointerLockElement) return 1; }
};
