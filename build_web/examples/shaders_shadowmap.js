...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5gfzfsu1.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_shadowmap.data';
      var REMOTE_PACKAGE_BASE = 'shaders_shadowmap.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_shadowmap.data');

      };
      Module['addRunDependency']('datafile_shaders_shadowmap.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp5gfzfsu1.js
...
function findWasmBinary() {
    return locateFile('shaders_shadowmap.wasm');
}
...
var ASM_CONSTS = {
  42600: () => { if (document.fullscreenElement) return 1; },  
 42646: () => { return Module.canvas.width; },  
 42678: () => { return parseInt(Module.canvas.style.width); },  
 42726: () => { document.exitFullscreen(); },  
 42753: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 42826: () => { if (document.fullscreenElement) return 1; },  
 42872: () => { return Module.canvas.width; },  
 42904: () => { return screen.width; },  
 42929: () => { document.exitFullscreen(); },  
 42956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 43089: () => { return window.innerWidth; },  
 43115: () => { return window.innerHeight; },  
 43142: () => { if (document.fullscreenElement) return 1; },  
 43188: () => { return Module.canvas.width; },  
 43220: () => { return parseInt(Module.canvas.style.width); },  
 43268: () => { if (document.fullscreenElement) return 1; },  
 43314: () => { return Module.canvas.width; },  
 43346: () => { return screen.width; },  
 43371: () => { return window.innerWidth; },  
 43397: () => { return window.innerHeight; },  
 43424: () => { if (document.fullscreenElement) return 1; },  
 43470: () => { return Module.canvas.width; },  
 43502: () => { return screen.width; },  
 43527: () => { document.exitFullscreen(); },  
 43554: () => { if (document.fullscreenElement) return 1; },  
 43600: () => { return Module.canvas.width; },  
 43632: () => { return parseInt(Module.canvas.style.width); },  
 43680: () => { document.exitFullscreen(); },  
 43707: ($0) => { Module.canvas.style.opacity = $0; },  
 43745: () => { return screen.width; },  
 43770: () => { return screen.height; },  
 43796: () => { return window.screenX; },  
 43823: () => { return window.screenY; },  
 43850: () => { return window.devicePixelRatio; },  
 43886: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 43939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 43990: () => { Module.canvas.style.cursor = 'none'; },  
 44027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 44283: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 44334: () => { if (document.fullscreenElement) return 1; },  
 44380: () => { return window.innerWidth; },  
 44406: () => { return window.innerHeight; },  
 44433: () => { if (document.pointerLockElement) return 1; }
};
