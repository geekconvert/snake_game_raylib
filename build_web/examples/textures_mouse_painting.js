...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdbcor640.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_mouse_painting.data';
      var REMOTE_PACKAGE_BASE = 'textures_mouse_painting.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_mouse_painting.data');

      };
      Module['addRunDependency']('datafile_textures_mouse_painting.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpdbcor640.js
...
function findWasmBinary() {
    return locateFile('textures_mouse_painting.wasm');
}
...
var ASM_CONSTS = {
  27136: () => { if (document.fullscreenElement) return 1; },  
 27182: () => { return Module.canvas.width; },  
 27214: () => { return parseInt(Module.canvas.style.width); },  
 27262: () => { document.exitFullscreen(); },  
 27289: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27362: () => { if (document.fullscreenElement) return 1; },  
 27408: () => { return Module.canvas.width; },  
 27440: () => { return screen.width; },  
 27465: () => { document.exitFullscreen(); },  
 27492: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27625: () => { return window.innerWidth; },  
 27651: () => { return window.innerHeight; },  
 27678: () => { if (document.fullscreenElement) return 1; },  
 27724: () => { return Module.canvas.width; },  
 27756: () => { return parseInt(Module.canvas.style.width); },  
 27804: () => { if (document.fullscreenElement) return 1; },  
 27850: () => { return Module.canvas.width; },  
 27882: () => { return screen.width; },  
 27907: () => { return window.innerWidth; },  
 27933: () => { return window.innerHeight; },  
 27960: () => { if (document.fullscreenElement) return 1; },  
 28006: () => { return Module.canvas.width; },  
 28038: () => { return screen.width; },  
 28063: () => { document.exitFullscreen(); },  
 28090: () => { if (document.fullscreenElement) return 1; },  
 28136: () => { return Module.canvas.width; },  
 28168: () => { return parseInt(Module.canvas.style.width); },  
 28216: () => { document.exitFullscreen(); },  
 28243: ($0) => { Module.canvas.style.opacity = $0; },  
 28281: () => { return screen.width; },  
 28306: () => { return screen.height; },  
 28332: () => { return window.screenX; },  
 28359: () => { return window.screenY; },  
 28386: () => { return window.devicePixelRatio; },  
 28422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28475: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28526: () => { Module.canvas.style.cursor = 'none'; },  
 28563: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28819: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28870: () => { if (document.fullscreenElement) return 1; },  
 28916: () => { return window.innerWidth; },  
 28942: () => { return window.innerHeight; },  
 28969: () => { if (document.pointerLockElement) return 1; }
};
