...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpw4_wdhl3.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'raymath_vector_angle.data';
      var REMOTE_PACKAGE_BASE = 'raymath_vector_angle.data';
...
Module['FS_createPath']("/resources/shaders", "glsl430", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_raymath_vector_angle.data');

      };
      Module['addRunDependency']('datafile_raymath_vector_angle.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpw4_wdhl3.js
...
function findWasmBinary() {
    return locateFile('raymath_vector_angle.wasm');
}
...
var ASM_CONSTS = {
  26416: () => { if (document.fullscreenElement) return 1; },  
 26462: () => { return Module.canvas.width; },  
 26494: () => { return parseInt(Module.canvas.style.width); },  
 26542: () => { document.exitFullscreen(); },  
 26569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26642: () => { if (document.fullscreenElement) return 1; },  
 26688: () => { return Module.canvas.width; },  
 26720: () => { return screen.width; },  
 26745: () => { document.exitFullscreen(); },  
 26772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26905: () => { return window.innerWidth; },  
 26931: () => { return window.innerHeight; },  
 26958: () => { if (document.fullscreenElement) return 1; },  
 27004: () => { return Module.canvas.width; },  
 27036: () => { return parseInt(Module.canvas.style.width); },  
 27084: () => { if (document.fullscreenElement) return 1; },  
 27130: () => { return Module.canvas.width; },  
 27162: () => { return screen.width; },  
 27187: () => { return window.innerWidth; },  
 27213: () => { return window.innerHeight; },  
 27240: () => { if (document.fullscreenElement) return 1; },  
 27286: () => { return Module.canvas.width; },  
 27318: () => { return screen.width; },  
 27343: () => { document.exitFullscreen(); },  
 27370: () => { if (document.fullscreenElement) return 1; },  
 27416: () => { return Module.canvas.width; },  
 27448: () => { return parseInt(Module.canvas.style.width); },  
 27496: () => { document.exitFullscreen(); },  
 27523: ($0) => { Module.canvas.style.opacity = $0; },  
 27561: () => { return screen.width; },  
 27586: () => { return screen.height; },  
 27612: () => { return window.screenX; },  
 27639: () => { return window.screenY; },  
 27666: () => { return window.devicePixelRatio; },  
 27702: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27755: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27806: () => { Module.canvas.style.cursor = 'none'; },  
 27843: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28099: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28150: () => { if (document.fullscreenElement) return 1; },  
 28196: () => { return window.innerWidth; },  
 28222: () => { return window.innerHeight; },  
 28249: () => { if (document.pointerLockElement) return 1; }
};
