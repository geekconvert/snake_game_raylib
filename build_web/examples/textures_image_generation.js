...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpwo81vzdy.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_generation.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_generation.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_generation.data');

      };
      Module['addRunDependency']('datafile_textures_image_generation.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpwo81vzdy.js
...
function findWasmBinary() {
    return locateFile('textures_image_generation.wasm');
}
...
var ASM_CONSTS = {
  27680: () => { if (document.fullscreenElement) return 1; },  
 27726: () => { return Module.canvas.width; },  
 27758: () => { return parseInt(Module.canvas.style.width); },  
 27806: () => { document.exitFullscreen(); },  
 27833: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27906: () => { if (document.fullscreenElement) return 1; },  
 27952: () => { return Module.canvas.width; },  
 27984: () => { return screen.width; },  
 28009: () => { document.exitFullscreen(); },  
 28036: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 28169: () => { return window.innerWidth; },  
 28195: () => { return window.innerHeight; },  
 28222: () => { if (document.fullscreenElement) return 1; },  
 28268: () => { return Module.canvas.width; },  
 28300: () => { return parseInt(Module.canvas.style.width); },  
 28348: () => { if (document.fullscreenElement) return 1; },  
 28394: () => { return Module.canvas.width; },  
 28426: () => { return screen.width; },  
 28451: () => { return window.innerWidth; },  
 28477: () => { return window.innerHeight; },  
 28504: () => { if (document.fullscreenElement) return 1; },  
 28550: () => { return Module.canvas.width; },  
 28582: () => { return screen.width; },  
 28607: () => { document.exitFullscreen(); },  
 28634: () => { if (document.fullscreenElement) return 1; },  
 28680: () => { return Module.canvas.width; },  
 28712: () => { return parseInt(Module.canvas.style.width); },  
 28760: () => { document.exitFullscreen(); },  
 28787: ($0) => { Module.canvas.style.opacity = $0; },  
 28825: () => { return screen.width; },  
 28850: () => { return screen.height; },  
 28876: () => { return window.screenX; },  
 28903: () => { return window.screenY; },  
 28930: () => { return window.devicePixelRatio; },  
 28966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 29019: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29070: () => { Module.canvas.style.cursor = 'none'; },  
 29107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29363: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29414: () => { if (document.fullscreenElement) return 1; },  
 29460: () => { return window.innerWidth; },  
 29486: () => { return window.innerHeight; },  
 29513: () => { if (document.pointerLockElement) return 1; }
};
