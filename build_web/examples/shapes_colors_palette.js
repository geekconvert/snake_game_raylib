...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfee_3gqd.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shapes_colors_palette.data';
      var REMOTE_PACKAGE_BASE = 'shapes_colors_palette.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes_colors_palette.data');

      };
      Module['addRunDependency']('datafile_shapes_colors_palette.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfee_3gqd.js
...
function findWasmBinary() {
    return locateFile('shapes_colors_palette.wasm');
}
...
var ASM_CONSTS = {
  26624: () => { if (document.fullscreenElement) return 1; },  
 26670: () => { return Module.canvas.width; },  
 26702: () => { return parseInt(Module.canvas.style.width); },  
 26750: () => { document.exitFullscreen(); },  
 26777: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26850: () => { if (document.fullscreenElement) return 1; },  
 26896: () => { return Module.canvas.width; },  
 26928: () => { return screen.width; },  
 26953: () => { document.exitFullscreen(); },  
 26980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27113: () => { return window.innerWidth; },  
 27139: () => { return window.innerHeight; },  
 27166: () => { if (document.fullscreenElement) return 1; },  
 27212: () => { return Module.canvas.width; },  
 27244: () => { return parseInt(Module.canvas.style.width); },  
 27292: () => { if (document.fullscreenElement) return 1; },  
 27338: () => { return Module.canvas.width; },  
 27370: () => { return screen.width; },  
 27395: () => { return window.innerWidth; },  
 27421: () => { return window.innerHeight; },  
 27448: () => { if (document.fullscreenElement) return 1; },  
 27494: () => { return Module.canvas.width; },  
 27526: () => { return screen.width; },  
 27551: () => { document.exitFullscreen(); },  
 27578: () => { if (document.fullscreenElement) return 1; },  
 27624: () => { return Module.canvas.width; },  
 27656: () => { return parseInt(Module.canvas.style.width); },  
 27704: () => { document.exitFullscreen(); },  
 27731: ($0) => { Module.canvas.style.opacity = $0; },  
 27769: () => { return screen.width; },  
 27794: () => { return screen.height; },  
 27820: () => { return window.screenX; },  
 27847: () => { return window.screenY; },  
 27874: () => { return window.devicePixelRatio; },  
 27910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27963: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28014: () => { Module.canvas.style.cursor = 'none'; },  
 28051: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28307: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28358: () => { if (document.fullscreenElement) return 1; },  
 28404: () => { return window.innerWidth; },  
 28430: () => { return window.innerHeight; },  
 28457: () => { if (document.pointerLockElement) return 1; }
};
