...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp8juw0icm.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_image_drawing.data';
      var REMOTE_PACKAGE_BASE = 'textures_image_drawing.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_image_drawing.data');

      };
      Module['addRunDependency']('datafile_textures_image_drawing.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmp8juw0icm.js
...
function findWasmBinary() {
    return locateFile('textures_image_drawing.wasm');
}
...
var ASM_CONSTS = {
  45952: () => { if (document.fullscreenElement) return 1; },  
 45998: () => { return Module.canvas.width; },  
 46030: () => { return parseInt(Module.canvas.style.width); },  
 46078: () => { document.exitFullscreen(); },  
 46105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 46178: () => { if (document.fullscreenElement) return 1; },  
 46224: () => { return Module.canvas.width; },  
 46256: () => { return screen.width; },  
 46281: () => { document.exitFullscreen(); },  
 46308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 46441: () => { return window.innerWidth; },  
 46467: () => { return window.innerHeight; },  
 46494: () => { if (document.fullscreenElement) return 1; },  
 46540: () => { return Module.canvas.width; },  
 46572: () => { return parseInt(Module.canvas.style.width); },  
 46620: () => { if (document.fullscreenElement) return 1; },  
 46666: () => { return Module.canvas.width; },  
 46698: () => { return screen.width; },  
 46723: () => { return window.innerWidth; },  
 46749: () => { return window.innerHeight; },  
 46776: () => { if (document.fullscreenElement) return 1; },  
 46822: () => { return Module.canvas.width; },  
 46854: () => { return screen.width; },  
 46879: () => { document.exitFullscreen(); },  
 46906: () => { if (document.fullscreenElement) return 1; },  
 46952: () => { return Module.canvas.width; },  
 46984: () => { return parseInt(Module.canvas.style.width); },  
 47032: () => { document.exitFullscreen(); },  
 47059: ($0) => { Module.canvas.style.opacity = $0; },  
 47097: () => { return screen.width; },  
 47122: () => { return screen.height; },  
 47148: () => { return window.screenX; },  
 47175: () => { return window.screenY; },  
 47202: () => { return window.devicePixelRatio; },  
 47238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 47291: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47342: () => { Module.canvas.style.cursor = 'none'; },  
 47379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 47635: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 47686: () => { if (document.fullscreenElement) return 1; },  
 47732: () => { return window.innerWidth; },  
 47758: () => { return window.innerHeight; },  
 47785: () => { if (document.pointerLockElement) return 1; }
};
