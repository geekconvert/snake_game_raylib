...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpt89hj61f.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_lightmap.data';
      var REMOTE_PACKAGE_BASE = 'shaders_lightmap.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_lightmap.data');

      };
      Module['addRunDependency']('datafile_shaders_lightmap.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpt89hj61f.js
...
function findWasmBinary() {
    return locateFile('shaders_lightmap.wasm');
}
...
var ASM_CONSTS = {
 ...
 36406: () => { return Module.canvas.width; },  
 36438: () => { return parseInt(Module.canvas.style.width); },  
 36486: () => { document.exitFullscreen(); },  
 36513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36586: () => { if (document.fullscreenElement) return 1; },  
 36632: () => { return Module.canvas.width; },  
 36664: () => { return screen.width; },  
 36689: () => { document.exitFullscreen(); },  
 36716: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36849: () => { return window.innerWidth; },  
 36875: () => { return window.innerHeight; },  
 36902: () => { if (document.fullscreenElement) return 1; },  
 36948: () => { return Module.canvas.width; },  
 36980: () => { return parseInt(Module.canvas.style.width); },  
 37028: () => { if (document.fullscreenElement) return 1; },  
 37074: () => { return Module.canvas.width; },  
 37106: () => { return screen.width; },  
 37131: () => { return window.innerWidth; },  
 37157: () => { return window.innerHeight; },  
 37184: () => { if (document.fullscreenElement) return 1; },  
 37230: () => { return Module.canvas.width; },  
 37262: () => { return screen.width; },  
 37287: () => { document.exitFullscreen(); },  
 37314: () => { if (document.fullscreenElement) return 1; },  
 37360: () => { return Module.canvas.width; },  
 37392: () => { return parseInt(Module.canvas.style.width); },  
 37440: () => { document.exitFullscreen(); },  
 37467: ($0) => { Module.canvas.style.opacity = $0; },  
 37505: () => { return screen.width; },  
 37530: () => { return screen.height; },  
 37556: () => { return window.screenX; },  
 37583: () => { return window.screenY; },  
 37610: () => { return window.devicePixelRatio; },  
 37646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37699: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 37750: () => { Module.canvas.style.cursor = 'none'; },  
 37787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38043: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
