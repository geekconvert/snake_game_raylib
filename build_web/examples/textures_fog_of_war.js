...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx424rqcq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_fog_of_war.data';
      var REMOTE_PACKAGE_BASE = 'textures_fog_of_war.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_fog_of_war.data');

      };
      Module['addRunDependency']('datafile_textures_fog_of_war.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpx424rqcq.js
...
function findWasmBinary() {
    return locateFile('textures_fog_of_war.wasm');
}
...
var ASM_CONSTS = {
  26976: () => { if (document.fullscreenElement) return 1; },  
 27022: () => { return Module.canvas.width; },  
 27054: () => { return parseInt(Module.canvas.style.width); },  
 27102: () => { document.exitFullscreen(); },  
 27129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27202: () => { if (document.fullscreenElement) return 1; },  
 27248: () => { return Module.canvas.width; },  
 27280: () => { return screen.width; },  
 27305: () => { document.exitFullscreen(); },  
 27332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27465: () => { return window.innerWidth; },  
 27491: () => { return window.innerHeight; },  
 27518: () => { if (document.fullscreenElement) return 1; },  
 27564: () => { return Module.canvas.width; },  
 27596: () => { return parseInt(Module.canvas.style.width); },  
 27644: () => { if (document.fullscreenElement) return 1; },  
 27690: () => { return Module.canvas.width; },  
 27722: () => { return screen.width; },  
 27747: () => { return window.innerWidth; },  
 27773: () => { return window.innerHeight; },  
 27800: () => { if (document.fullscreenElement) return 1; },  
 27846: () => { return Module.canvas.width; },  
 27878: () => { return screen.width; },  
 27903: () => { document.exitFullscreen(); },  
 27930: () => { if (document.fullscreenElement) return 1; },  
 27976: () => { return Module.canvas.width; },  
 28008: () => { return parseInt(Module.canvas.style.width); },  
 28056: () => { document.exitFullscreen(); },  
 28083: ($0) => { Module.canvas.style.opacity = $0; },  
 28121: () => { return screen.width; },  
 28146: () => { return screen.height; },  
 28172: () => { return window.screenX; },  
 28199: () => { return window.screenY; },  
 28226: () => { return window.devicePixelRatio; },  
 28262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28315: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28366: () => { Module.canvas.style.cursor = 'none'; },  
 28403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28710: () => { if (document.fullscreenElement) return 1; },  
 28756: () => { return window.innerWidth; },  
 28782: () => { return window.innerHeight; },  
 28809: () => { if (document.pointerLockElement) return 1; }
};
