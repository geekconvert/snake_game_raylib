...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfmkbs48t.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'shaders_write_depth.data';
      var REMOTE_PACKAGE_BASE = 'shaders_write_depth.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shaders_write_depth.data');

      };
      Module['addRunDependency']('datafile_shaders_write_depth.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpfmkbs48t.js
...
function findWasmBinary() {
    return locateFile('shaders_write_depth.wasm');
}
...
var ASM_CONSTS = {
  27336: () => { if (document.fullscreenElement) return 1; },  
 27382: () => { return Module.canvas.width; },  
 27414: () => { return parseInt(Module.canvas.style.width); },  
 27462: () => { document.exitFullscreen(); },  
 27489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 27562: () => { if (document.fullscreenElement) return 1; },  
 27608: () => { return Module.canvas.width; },  
 27640: () => { return screen.width; },  
 27665: () => { document.exitFullscreen(); },  
 27692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27825: () => { return window.innerWidth; },  
 27851: () => { return window.innerHeight; },  
 27878: () => { if (document.fullscreenElement) return 1; },  
 27924: () => { return Module.canvas.width; },  
 27956: () => { return parseInt(Module.canvas.style.width); },  
 28004: () => { if (document.fullscreenElement) return 1; },  
 28050: () => { return Module.canvas.width; },  
 28082: () => { return screen.width; },  
 28107: () => { return window.innerWidth; },  
 28133: () => { return window.innerHeight; },  
 28160: () => { if (document.fullscreenElement) return 1; },  
 28206: () => { return Module.canvas.width; },  
 28238: () => { return screen.width; },  
 28263: () => { document.exitFullscreen(); },  
 28290: () => { if (document.fullscreenElement) return 1; },  
 28336: () => { return Module.canvas.width; },  
 28368: () => { return parseInt(Module.canvas.style.width); },  
 28416: () => { document.exitFullscreen(); },  
 28443: ($0) => { Module.canvas.style.opacity = $0; },  
 28481: () => { return screen.width; },  
 28506: () => { return screen.height; },  
 28532: () => { return window.screenX; },  
 28559: () => { return window.screenY; },  
 28586: () => { return window.devicePixelRatio; },  
 28622: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 28675: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28726: () => { Module.canvas.style.cursor = 'none'; },  
 28763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 29019: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 29070: () => { if (document.fullscreenElement) return 1; },  
 29116: () => { return window.innerWidth; },  
 29142: () => { return window.innerHeight; },  
 29169: () => { if (document.pointerLockElement) return 1; }
};
