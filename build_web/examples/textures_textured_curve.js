...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsu_mdqgu.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'textures_textured_curve.data';
      var REMOTE_PACKAGE_BASE = 'textures_textured_curve.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_textures_textured_curve.data');

      };
      Module['addRunDependency']('datafile_textures_textured_curve.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpsu_mdqgu.js
...
function findWasmBinary() {
    return locateFile('textures_textured_curve.wasm');
}
...
var ASM_CONSTS = {
  30656: () => { if (document.fullscreenElement) return 1; },  
 30702: () => { return Module.canvas.width; },  
 30734: () => { return parseInt(Module.canvas.style.width); },  
 30782: () => { document.exitFullscreen(); },  
 30809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30882: () => { if (document.fullscreenElement) return 1; },  
 30928: () => { return Module.canvas.width; },  
 30960: () => { return screen.width; },  
 30985: () => { document.exitFullscreen(); },  
 31012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31145: () => { return window.innerWidth; },  
 31171: () => { return window.innerHeight; },  
 31198: () => { if (document.fullscreenElement) return 1; },  
 31244: () => { return Module.canvas.width; },  
 31276: () => { return parseInt(Module.canvas.style.width); },  
 31324: () => { if (document.fullscreenElement) return 1; },  
 31370: () => { return Module.canvas.width; },  
 31402: () => { return screen.width; },  
 31427: () => { return window.innerWidth; },  
 31453: () => { return window.innerHeight; },  
 31480: () => { if (document.fullscreenElement) return 1; },  
 31526: () => { return Module.canvas.width; },  
 31558: () => { return screen.width; },  
 31583: () => { document.exitFullscreen(); },  
 31610: () => { if (document.fullscreenElement) return 1; },  
 31656: () => { return Module.canvas.width; },  
 31688: () => { return parseInt(Module.canvas.style.width); },  
 31736: () => { document.exitFullscreen(); },  
 31763: ($0) => { Module.canvas.style.opacity = $0; },  
 31801: () => { return screen.width; },  
 31826: () => { return screen.height; },  
 31852: () => { return window.screenX; },  
 31879: () => { return window.screenY; },  
 31906: () => { return window.devicePixelRatio; },  
 31942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31995: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32046: () => { Module.canvas.style.cursor = 'none'; },  
 32083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32339: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 32390: () => { if (document.fullscreenElement) return 1; },  
 32436: () => { return window.innerWidth; },  
 32462: () => { return window.innerHeight; },  
 32489: () => { if (document.pointerLockElement) return 1; }
};
