...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpve8ddy2w.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_random_sequence.data';
      var REMOTE_PACKAGE_BASE = 'core_random_sequence.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_random_sequence.data');

      };
      Module['addRunDependency']('datafile_core_random_sequence.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpve8ddy2w.js
...
function findWasmBinary() {
    return locateFile('core_random_sequence.wasm');
}
...
var ASM_CONSTS = {
  26448: () => { if (document.fullscreenElement) return 1; },  
 26494: () => { return Module.canvas.width; },  
 26526: () => { return parseInt(Module.canvas.style.width); },  
 26574: () => { document.exitFullscreen(); },  
 26601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26674: () => { if (document.fullscreenElement) return 1; },  
 26720: () => { return Module.canvas.width; },  
 26752: () => { return screen.width; },  
 26777: () => { document.exitFullscreen(); },  
 26804: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26937: () => { return window.innerWidth; },  
 26963: () => { return window.innerHeight; },  
 26990: () => { if (document.fullscreenElement) return 1; },  
 27036: () => { return Module.canvas.width; },  
 27068: () => { return parseInt(Module.canvas.style.width); },  
 27116: () => { if (document.fullscreenElement) return 1; },  
 27162: () => { return Module.canvas.width; },  
 27194: () => { return screen.width; },  
 27219: () => { return window.innerWidth; },  
 27245: () => { return window.innerHeight; },  
 27272: () => { if (document.fullscreenElement) return 1; },  
 27318: () => { return Module.canvas.width; },  
 27350: () => { return screen.width; },  
 27375: () => { document.exitFullscreen(); },  
 27402: () => { if (document.fullscreenElement) return 1; },  
 27448: () => { return Module.canvas.width; },  
 27480: () => { return parseInt(Module.canvas.style.width); },  
 27528: () => { document.exitFullscreen(); },  
 27555: ($0) => { Module.canvas.style.opacity = $0; },  
 27593: () => { return screen.width; },  
 27618: () => { return screen.height; },  
 27644: () => { return window.screenX; },  
 27671: () => { return window.screenY; },  
 27698: () => { return window.devicePixelRatio; },  
 27734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27787: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27838: () => { Module.canvas.style.cursor = 'none'; },  
 27875: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28131: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28182: () => { if (document.fullscreenElement) return 1; },  
 28228: () => { return window.innerWidth; },  
 28254: () => { return window.innerHeight; },  
 28281: () => { if (document.pointerLockElement) return 1; }
};
