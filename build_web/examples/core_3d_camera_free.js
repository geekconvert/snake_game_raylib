...
// include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpst9chmcl.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'core_3d_camera_free.data';
      var REMOTE_PACKAGE_BASE = 'core_3d_camera_free.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_core_3d_camera_free.data');

      };
      Module['addRunDependency']('datafile_core_3d_camera_free.data');
...
// end include: /var/folders/q7/65nlg0zd5hjgcqv94sy5d8740000gn/T/tmpst9chmcl.js
...
function findWasmBinary() {
    return locateFile('core_3d_camera_free.wasm');
}
...
var ASM_CONSTS = {
  26600: () => { if (document.fullscreenElement) return 1; },  
 26646: () => { return Module.canvas.width; },  
 26678: () => { return parseInt(Module.canvas.style.width); },  
 26726: () => { document.exitFullscreen(); },  
 26753: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26826: () => { if (document.fullscreenElement) return 1; },  
 26872: () => { return Module.canvas.width; },  
 26904: () => { return screen.width; },  
 26929: () => { document.exitFullscreen(); },  
 26956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 27089: () => { return window.innerWidth; },  
 27115: () => { return window.innerHeight; },  
 27142: () => { if (document.fullscreenElement) return 1; },  
 27188: () => { return Module.canvas.width; },  
 27220: () => { return parseInt(Module.canvas.style.width); },  
 27268: () => { if (document.fullscreenElement) return 1; },  
 27314: () => { return Module.canvas.width; },  
 27346: () => { return screen.width; },  
 27371: () => { return window.innerWidth; },  
 27397: () => { return window.innerHeight; },  
 27424: () => { if (document.fullscreenElement) return 1; },  
 27470: () => { return Module.canvas.width; },  
 27502: () => { return screen.width; },  
 27527: () => { document.exitFullscreen(); },  
 27554: () => { if (document.fullscreenElement) return 1; },  
 27600: () => { return Module.canvas.width; },  
 27632: () => { return parseInt(Module.canvas.style.width); },  
 27680: () => { document.exitFullscreen(); },  
 27707: ($0) => { Module.canvas.style.opacity = $0; },  
 27745: () => { return screen.width; },  
 27770: () => { return screen.height; },  
 27796: () => { return window.screenX; },  
 27823: () => { return window.screenY; },  
 27850: () => { return window.devicePixelRatio; },  
 27886: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 27990: () => { Module.canvas.style.cursor = 'none'; },  
 28027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28283: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 28334: () => { if (document.fullscreenElement) return 1; },  
 28380: () => { return window.innerWidth; },  
 28406: () => { return window.innerHeight; },  
 28433: () => { if (document.pointerLockElement) return 1; }
};
